...
Route::group(['prefix' => 'hotelier', 'middleware' => 'auth:crm'], function()
{
	...
	Route::post('/getchart', ['as' => $a . 'getchart', 'uses' => 'HotelierController@getcharts']);
	Route::post('/exportcharts1/{type}', ['as' => $a . 'exportcharts1', 'uses' => 'HotelierController@exportcharts1']);
	...
	Route::post('/hotel/update-rate', ['as' => $a . 'update-rate', 'uses' => 'HotelierController@updateRate']);
	...
	Route::post('/hotels/portadded', ['as' => $a . 'portadded', 'uses' => 'HotelierController@portadded']);
  ...
  Route::post('/getuserdetail', ['as' => $a . 'getuserdetail', 'uses' => 'HotelierController@getuserdetail']);
	...
	Route::post('/added-hotel-portal-contact', ['as' => $a . 'added-hotel-portal-contact', 'uses' => 'HotelierController@addedHotelPortalContact']);
	Route::post('/updated-hotel-portal-contact', ['as' => $a . 'updated-hotel-portal-contact', 'uses' => 'HotelierController@updatedHotelPortalContact']);

	Route::post('/UserPasswordSend', ['as' => $a . 'UserPasswordSend', 'uses' => 'HotelierController@UserPasswordSend']);

	Route::post('/UserWelcomeLetterSend', ['as' => $a . 'UserWelcomeLetterSend', 'uses' => 'HotelierController@UserWelcomeLetterSend']);

	
	Route::post('/UserActive', ['as' => $a . 'UserActive', 'uses' => 'HotelierController@UserActive']);
	Route::post('/CrmUserAssignPortal', ['as' => $a . 'CrmUserAssignPortal', 'uses' => 'HotelierController@CrmUserAssignPortal']);
...
Route::get('/redirect', function () {
    $query = http_build_query([
        'client_id' => 'd9f2f75b-1649-43b3-bf85-e119f1463102',
        'redirect_uri' => 'http://localhost/hotels-crm/crm/callback',
        'response_type' => 'code',
        'scope' => ''
    ]);
    return redirect('http://localhost/hotels-crm/crm/outlook-auth?'.$query);
});

Route::get('/callback', function (Illuminate\Http\Request $request) {
    $http = new \GuzzleHttp\Client;

    $response = $http->post('http://localhost/hotels-crm/crm/oauth/token', [
        'form_params' => [
            'grant_type' => 'authorization_code',
            'client_id' => 'd9f2f75b-1649-43b3-bf85-e119f1463102',
            'client_secret' => 'IK-exv3g303xdGuyKpiPeDnjAmkhl:=:',
             'redirect_uri' => 'http://localhost/hotels-crm/crm/callback',
            'code' => $request->code,
        ],
    ]);
...
Route::group(['prefix' => 'crm', 'middleware' => 'auth:crm'], function()
{
	...
	Route::post('/ajaxuseremailsettingadd', ['as' => $a . 'ajaxuseremailsettingadd', 'uses' => 'CrmController@ajaxuseremailsettingadd']);
	Route::post('/ajaxuseradd', ['as' => $a . 'ajaxuseradd', 'uses' => 'CrmController@ajaxuseradd']);
	
	Route::post('/fetchuserdetail', ['as' => $a . 'fetchuserdetail', 'uses' => 'CrmController@fetchuserdetail']);
	Route::post('/deleteuserdetail', ['as' => $a . 'deleteuserdetail', 'uses' => 'CrmController@deleteuserdetail']);
	Route::post('/ajaxtempadd', ['as' => $a . 'ajaxtempadd', 'uses' => 'ProposalController@ajaxtempadd']);
	Route::post('/fetchtempdetail', ['as' => $a . 'fetchtempdetail', 'uses' => 'ProposalController@fetchtempdetail']);
	Route::post('/deletetempdetail', ['as' => $a . 'deletetempdetail', 'uses' => 'ProposalController@deletetempdetail']);
	Route::post('/get_template', ['as' => $a . 'get_template', 'uses' => 'ProposalController@get_template']);
	...
	Route::post('/add-proposal', ['as' => $a . 'add-proposal', 'uses' => 'ProposalController@addProposal']);
	Route::get('/edit-proposal/{id}', ['as' => $a . 'edit-proposal', 'uses' => 'ProposalController@editProposal']);
	Route::post('/update-proposal', ['as' => $a . 'update-proposal', 'uses' => 'ProposalController@updateProposal']);
	Route::post('/remove_business', ['as' => $a . 'remove_business', 'uses' => 'ProposalController@remove_business']);
	Route::get('/preview-proposal', ['as' => $a . 'preview-proposal', 'uses' => 'ProposalController@previewproposal']);
	Route::get('/view-proposal/{id}', ['as' => $a . 'view-proposal', 'uses' => 'ProposalController@viewproposal']);
	Route::post('/preview-text', ['as' => $a . 'preview-text', 'uses' => 'ProposalController@previewText']);
	Route::post('/send-proposal', ['as' => $a . 'send-proposal', 'uses' => 'ProposalController@sendProposal']);
	Route::get('/pdf-proposal/{id}', ['as' => $a . 'pdf-proposal', 'uses' => 'ProposalController@pdfproposal']);
	...
	Route::get('/notification', ['as' => $a . 'notification', 'uses' => 'CrmController@getNotification']);
	...
	Route::post('/hotels/salesUpdated', ['as' => $a . 'salesUpdated', 'uses' => 'CrmController@salesUpdated']);
	...
	Route::post('/import-agent-regional-office-location', ['as' => $a . 'import-synxis', 'uses' => 'CrmController@importAgentLocation']);
	Route::post('/getAgBusiname', ['as' => $a . 'getAgBusiname', 'uses' => 'CrmController@getAgBusiname']);
	Route::post('/getCorpBusiname', ['as' => $a . 'getCorpBusiname', 'uses' => 'CrmController@getCorpBusiname']);
	...
	Route::post('/deleteAgents', ['as' => $a . 'deleteAgents', 'uses' => 'CrmController@deleteAgents']);
	Route::post('/deleteSubAgents', ['as' => $a . 'deleteSubAgents', 'uses' => 'CrmController@deleteSubAgents']);
  Route::post('/getImplant', ['as' => $a . 'getImplant', 'uses' => 'CrmController@getImplant']);
	...
	Route::post('/view-events/update-notify', ['uses' => 'CrmController@updateNotify', 'as' => $a .'update-notify']);
	Route::post('/getcharts', ['as' => $a . 'getcharts', 'uses' => 'CrmController@getcharts']);
	Route::post('/gethotels', ['as' => $a . 'gethotels', 'uses' => 'CrmController@gethotels']);
	...
	Route::post('/deleteevent', ['uses' => 'CrmController@deleteevent', 'as' => $a .'deleteevent']);
	...
	Route::post('postGroupName_ajax', ['uses' => 'CrmController@postGroupName_ajax', 'as' => $a .'postGroupName_ajax']);
	Route::post('postupdateGroupName_ajax', ['uses' => 'CrmController@postupdateGroupName_ajax', 'as' => $a .'postupdateGroupName_ajax']);
	Route::post('postdeleteGroupName_ajax', ['uses' => 'CrmController@postdeleteGroupName_ajax', 'as' => $a .'postdeleteGroupName_ajax']);
	...
	Route::post('/remove_agContact', ['as' => $a . 'remove_agContact', 'uses' => 'CrmController@remove_agContact']);
	...
	Route::post('/getuser', ['as' => $a . 'getuser', 'uses' => 'CrmController@getuser']);
