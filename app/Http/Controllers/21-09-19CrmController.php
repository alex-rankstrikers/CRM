...
$user_id = (auth()->check()) ? auth()->user()->id : null;
	...
	//	dd($Hotellccontact);
      ...
      return view('panels.crm.add_corporate',compact('country'),['CorporateContact'=>$CorporateContact,'Hotelagentcontactbasic'=>$Hotelagentcontactbasic,'Hotellccontact'=>$Hotellccontact,'regionalLocationsSubsidy'=>$regionalLocationsSubsidy,'regionalLocationsDirectAdd'=>$regionalLocationsDirectAdd,'regionalLocations'=>$regionalLocations,'master_lead_type'=>$master_lead_type,'users' => $users,'editusers' => $users,'editstates' => $editstates,'editcities' => $editcities,'master_business' => $master_business,'cities' => $cities,'travel_desk' => $travel_desk,'hdcorporatecont' => $hdcorporatecont,'hdcontact_type' => $hdcontact_type]);
	...
	public function viewagent()
    {
		...
		$regionalLocations = DB::table('hl_regional_locations')
				...
				->where('created_by',$user_id)
				->get(); 
		return view('panels.crm.edit_agent',compact('master_business','master_lead_type','Hotelagentcontactbasic','regionalLocations'),['hotels'=>$hotels,'cor_view'=>$cor_view,'country' => $country,'editcountry' => $country,'editstates' => $editstates,'editcities' => $editcities]);
