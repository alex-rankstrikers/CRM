...
class MerchantController extends Controller
{
	 ...
	 public function addVenue()
    {
	   ...
	   $Category= Category::all();
		...
		$editcities = DB::table('cities')			 
			 ->get();
      return view('panels.merchant.add_venue',['Category'=>$Category,'VenueContact'=>$VenueContact,'VenueCapacity'=>$VenueCapacity,'VenueFeatures'=>$VenueFeatures,'VenueFoodDrink'=>$VenueFoodDrink,'VenueLicensing'=>$VenueLicensing,'VenueRestrictions'=>$VenueRestrictions,'Edit_VenueCapacity'=>$VenueCapacity,'Edit_VenueFeatures'=>$VenueFeatures,'Edit_VenueFoodDrink'=>$VenueFoodDrink,'Edit_VenueLicensing'=>$VenueLicensing,'Edit_VenueRestrictions'=>$VenueRestrictions,'users' => $users,'country' => $country,'editusers' => $users,'editcountry' => $country,'editstates' => $editstates,'editcities' => $editcities]);
...
$venue = DB::table('venue')
	   ...
	   $Category= Category::all();
		...
		$editcities = DB::table('cities')			 
			 ->get();
      return view('panels.merchant.edit',['Category'=>$Category,'venue'=>$venue,'VenueContact'=>$VenueContact,'VenueCapacity'=>$VenueCapacity,'VenueFeatures'=>$VenueFeatures,'VenueFoodDrink'=>$VenueFoodDrink,'VenueLicensing'=>$VenueLicensing,'VenueRestrictions'=>$VenueRestrictions,'Edit_VenueCapacity'=>$VenueCapacity,'Edit_VenueFeatures'=>$VenueFeatures,'Edit_VenueFoodDrink'=>$VenueFoodDrink,'Edit_VenueLicensing'=>$VenueLicensing,'Edit_VenueRestrictions'=>$VenueRestrictions,'users' => $users,'country' => $country,'editusers' => $users,'editcountry' => $country,'editstates' => $editstates,'editcities' => $editcities]);
    }
...
return redirect('merchant/edit-venue-contact')->with('message','Venue contact updated successfully');
	...
	public function added(Request $request)
	{
		...
		'description'	=> 'required',		
			...
			'contact.required'			=> 'Venue contact is required',			
			...
			'description.required'	=> 'required',
				...
				$Venue->venue_c_id=$request->contact;
			...
			return redirect('merchant/add-venue')->with('message','Venue added successfully');
	}
