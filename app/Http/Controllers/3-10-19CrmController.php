...
// 			    }
	...
	public function viewagent()
    {
	    ...
	    $country= Country::all()->where('status',1);
			...
			->select('*','hl_agent_regional_locations.hl_email as remail','hl_agents_contacts.hl_email as cemail','countries.name as countries','states.name as states','cities.name as cities')
