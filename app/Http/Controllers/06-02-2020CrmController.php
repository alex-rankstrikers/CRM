...
if($basic_id_val){
   $upr= DB::table('hotel_leads_events')
        ...
        ->update([ 'hle_start_date' => $crt_st_date, 'hle_end_date' => $crt_end_date, 'hle_title' => $title, 
        'outlook_id' =>$outlook_id,'outlook_status' =>2,'hle_description'=>$description       
        ]);

}else{
// DB::enableQueryLog();
//  $out= DB::table('hotel_leads_events')->where(['hle_start_date' => $crt_st_date, 'hle_end_date' => $crt_end_date, 'hle_title' => $title])->where('outlook_id','=','')->first();
//  dd(DB::getQueryLog());
//  if($out)
//  {
//    $upr= DB::table('hotel_leads_events')
...
//         ->update([      
//         'outlook_id' =>$outlook_id,'outlook_status' =>2,'hle_description'=>$event->getBodyPreview()                
//         ]);
