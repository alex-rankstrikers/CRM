...
if (isset($_GET["asset_path"]))
{
	 $asset_path = $_GET["asset_path"];
	 $_SESSION['asset_path'] = $asset_path;
	 
} else if(isset($_SESSION['asset_path'])) {
	
	$asset_path = $_SESSION['asset_path'];
}
...
|    |   |   |   |   |- plugin.min.js
*/
//$url='http://localhost/mobizee_premium/file_manager/source/'.$uid;
$base_path = dirname(dirname(__DIR__));
$customer_path = $base_path . DIRECTORY_SEPARATOR . 'source';
if(!file_exists($customer_path))
{
mkdir($customer_path, 0777, true);
}
$thumbs_path = $base_path . DIRECTORY_SEPARATOR . 'thumbs';
...
if($_SERVER['HTTP_HOST'] == 'localhost')
	$base_url = 'http://localhost/ni-web/public';
...
$config = array(
	...
	*/	
	...
	'upload_dir' => $asset_path . "/file_manager/source/",
