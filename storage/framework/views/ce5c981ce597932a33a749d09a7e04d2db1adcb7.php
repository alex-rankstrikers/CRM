...
<section class="contact-page" style="height: 100%">
	...
	<img class="img-responsive " style="width:50%;display:initial;" src="<?php echo e('aplbc/Insigthslogo-02.svg'); ?>"></img></div>
                    <?php echo Form::open(['url' => url('login'), 'class' => 'contact-form', 'data-parsley-validate' ] ); ?>   
            ...
            'data-parsley-maxlength'        => '20'
                        ...
                        <div class="form_direct_log">
                            ...
                            <div class="pull-right"><a class="log_sign" href="<?php echo e(url('register')); ?>">Sign Up</a></div>
                        </div> -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main-login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>