...
<link rel="stylesheet" href="<?php echo e(asset('assets/vendors/select2-bootstrap-theme/select2-bootstrap.min.css')); ?>">
 <form id="commentForm" action="<?php echo e(url('crm/hotel/added')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
...
<div class="col-lg-8">
<div class="alert alert-success" role="alert">Dear <?php echo e(Auth::user()->first_name); ?>, hotel lead details has been successfully added.</div>
</div>
<div class="col-lg-2"></div>
...
<?php endif; ?> 							
    ...
    top: -2px;"></span>
                                     ...
                                     <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Address </label><input type="text" name="address1" id="address1" value="<?php echo e(old('address1')); ?>" class="form-control required" data-error="#err_address1" ><span id="err_address1" style="position:relative;top: -2px;"></span>
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       <label>Postcode </label><input type="text" class="form-control required" name="postcode" id="postcode" value="<?php echo e(old('postcode')); ?>" data-error="#err_postcode">
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       <label>Website </label><input type="text" class="form-control required" name="website" id="website" value="<?php echo e(old('postcode')); ?>" data-error="#website">
										...
										<input type="tel" class="form-control required" name="contact_no" id="contact_no" value="<?php echo e(old('contact_no')); ?>" data-error="#err_contact_no">
    ...
    top: -2px;"></span>
									 ...
									 <option value="">Choose Lead Type</option>									
										...
										<option value="<?php echo e($hdproperty_type->hl_pro_id); ?>"><?php echo e($hdproperty_type->hl_property_description); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>
										<span id="err_type" style="position: relative;top: -2px;"></span>
