...
<form accept-charset="UTF-8" action="<?php echo e(route('crm.store')); ?>"  method="post" id="create_task">
...
<div class="col-lg-8">
<div class="alert alert-success" role="alert">Dear <?php echo e(Auth::user()->first_name); ?>, task details has been successfully added.</div>
</div>
<div class="col-lg-2"></div>
...
<?php endif; ?> 							
          ...
          <div class="card-body">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				  ...
				  <input type="hidden" name="outlook_id" id="outlook_id">
				 ...
				 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				  ...
				  <span><input name="task_for[]" id="task_for_<?php echo $i;?>" type="checkbox" value="<?php echo e($task_for->hl_ms_id); ?>" onclick="aplbc_contact('<?php echo e($task_for->hl_ms_id); ?>','<?php echo e($task_for->hl_type); ?>')" class="task_for"><?php echo e($task_for->hl_service_name); ?></input></span>		
				  <?php $i++; ?>
				  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				  </div>


				  <div class="form-group col-sm-12 col-md-12 col-lg-12 aligncheck" style="margin-bottom: 10px;">
				...
				<div class="form-group col-sm-6 col-md-6 col-lg-6" style="display:none;"></div>

					<div class="form-group col-sm-6 col-md-6 col-lg-6" id="select_all_hotels" style="display:none;float: left;" >
					...
					<div class="form-group col-sm-6 col-md-6 col-lg-6" id="select_contact" style="display:none;float: left;">
...
<!-- 					<div class="form-group col-sm-6 col-md-6 col-lg-6" style="float: left;margin-top: 10px;" >
				...
				<div class="col-sm-5 col-md-5 col-lg-5 guest-width" style="float: left;margin-top: 10px;">
					<label>Guests:</label>
				...
				<div class="form-group col-sm-12 col-md-12 col-lg-12">
				  ...
				  <select class="form-control" style="width:40%;padding:0px;" name="hle_start_hour" id="hle_start_hour">
					 ...
					 <option value="<?php echo e($hm->time); ?>">&nbsp;&nbsp;&nbsp;<?php echo e($hm->time); ?></option>
					 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				 </select>
				  ...
				  <input class="form-control" type="text" style="width:60%" autocomplete = "off" name="hle_end_date" id="hle_end_date" class="date" />
				   <select class="form-control"  style="width:40%;padding:0px;" name="hle_end_hour" id="hle_end_hour"  >
					 ...
					 <option value="<?php echo e($h_m->time); ?>">&nbsp;&nbsp;&nbsp;<?php echo e($h_m->time); ?></option>
					 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				 </select>
				  </div>
				  </div>
				  ...
				  <div style="width:75%; margin-top: 35px;" >
				   ...
				   <select  style="margin-right: 15px;margin-top: 26px;" aria-label="Repeat frequency" name="hle_recurr_duration" class="form-control required">
				  		<option value="">Select</option>
				   ...
				   <input type="hidden" name="hle_timezone_hid" id="hle_timezone_hid" value="<?php echo e($users->timezone); ?>">
...
<!--end-->
							...
							<!-- <div class="col-sm-12 col-md-12 col-lg-12"> -->
							  ...
							  <div id="outcome_section" class="row">
							 	<div id="removelink" class="form-group col-sm-12 col-md-12 col-lg-12">
								  ...
								  <div class="form-group col-sm-6 col-md-12 col-lg-6 appto" style="">
								  ...
								  <div class="form-group col-sm-6 col-md-6 col-lg-6">
									...
									<option value="">Select</option>
									<?php $__currentLoopData = $task_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<input type="checkbox" name="oc_recurr_status_0" id="oc_recurr_status_0" value="1">&nbsp;&nbsp;&nbsp;Repeat Task
	...
	<!-- 	<input class="btn btn-primary btn-lg btn-heigh" style="width:auto;margin-right: -16px;" type="submit" id="con_ol" value="Save" /> -->
		<input class="btn btn-primary btn-lg btn-heigh" style="width:auto;margin-right: -16px;" type="button" id="con_ol" value="Save" />
		&nbsp;&nbsp;&nbsp;<a href="" style = "margin-top: 5px;margin-left: 5px;display: none" id="clone" class="btn btn-outline-inverse-info btn-lg btn-heigh pull-right">Add</a></div> 
...
$("#con_ol").click(function () {
	...
	var hle_recurr_status=$('input[name="hle_recurr_status"]:checked').val();
	...
	if(hle_recurr_status!=1)
	{
	 ...
	 //alert('aaa');
		...
		var date2= $("#hle_end_date").val().trim();
		...
		var cnt_hle_contacts=$("input[name='hle_contacts[]']").length;

		
		sel_cont = [];  
	    $("#hle_contacts :selected").each(function(){
	    	var hle_contacts=$(this).val();
	    	sel_cont.push(hle_contacts);	    	
	    });

			var userhost="<?php echo e(url('crm/getuser/')); ?>"; 
			var jsonObj = [];
			$.each(sel_cont, function(key,value) {
			$.ajax({
				type: 'POST',
				...
				success:function(res){	
					jsonObj.push({
					"emailAddress": {
					"address":res.view_details.email,
					"name": res.view_details.first_name,
					},
					"type": "required"
					});
				}
