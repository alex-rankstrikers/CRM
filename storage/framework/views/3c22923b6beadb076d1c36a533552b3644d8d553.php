...
<div class="col-lg-8">
<div class="alert alert-success" role="alert">Dear <?php echo e(Auth::user()->first_name); ?>, task details has been successfully updated.</div>
</div>
<div class="col-lg-2"></div>
...
<?php endif; ?> 							
          ...
          <div class="card-body">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				            ...
				            <input type="hidden" name="hle_id" id="hle_id" value="<?php echo e($tasksE->hle_id); ?>" />
				            <input type="hidden" name="outlook_id" id="outlook_id" value="<?php echo e($tasksE->outlook_id); ?>" />
				  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
				  <div class="row">
				  <div class="form-group col-sm-6 col-md-6 col-lg-6">
				  <label> Task Title:</label>
				  
				  <input type="text" name="hle_title" id="hle_title" class="form-control" value="<?php echo e($tasksE->hle_title); ?>"/>
				  </div>
				 ...
				 <label>Task Type:</label>
				  ...
				  <option value="<?php echo e($task_types->hl_mt_id); ?>"<?php echo e(( $tasksE->hle_task_type == $task_types->hl_mt_id) ? 'selected' : ''); ?> ><?php echo e($task_types->task_name); ?></option>
				 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				  ...
				  <span><input name="task_for[]" id="task_for_<?php echo $i;?>" type="checkbox" value="<?php echo e($task_for->hl_ms_id); ?>" class="task_for" onclick="aplbc_contact('<?php echo e($task_for->hl_ms_id); ?>','<?php echo e($task_for->hl_type); ?>')" onchange="load_task()"><?php echo e($task_for->hl_service_name); ?></input></span>		
				  <?php $i++; ?>
				  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				  </div>
				  <input type="hidden" name="taskfor" id="taskfor" value="<?php echo e($tasksE->hle_task_for); ?>">
				 ...
				 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				  ...
				  <input type="hidden" name="activity_hid" id="activity_hid" value="<?php echo e($tasksE->hle_activity); ?>">
				  
				  <div class="form-group col-sm-2 col-md-2 col-lg-2">
				<!--  <a class="btn btn-lg btn-primary" href="<?php echo e(url('crm/signin')); ?>" role="button" id="connect-button">Connect to Outlook</a> -->
  
				  </div>
<input type="hidden" name="repeat_task_id_hid" id="repeat_task_id_hid" value="<?php echo e($tasksE->repeat_task_id); ?>">
				...
				<select class="form-control js-example-basic-multiple w-100 " multiple="multiple"  name="hle_contacts[]" id="hle_contacts" > 
					<?php $__currentLoopData = $usersSet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option value="<?php echo e($user->id); ?>"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>  
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12"></div>
				<input type="hidden" name="hle_activity_hid" id="hle_activity_hid" value="<?php echo e($tasksE->hle_contacts); ?>">
					...
					<input type="hidden" name="hotels_name_hid" id="hotels_name_hid" value="<?php echo e($tasksE->hle_applicable_All_Hotels); ?>">
					...
					<input type="hidden" name="hotel_contacts_hid" id="hotel_contacts_hid" value="<?php echo e($tasksE->hle_applicable_contacts); ?>">
				...
				<div id="invitenew_section" class="col-sm-12 col-md-12 col-lg-12 cform ">
					...
					<input type="hidden" name="hle_guest_id_hid" id="hle_guest_id_hid" 
					 value="<?php for($i=0;$i<count($guestE);$i++): ?><?php echo e($guestE[$i]['hle_guest_id']); ?>,<?php endfor; ?>" >
					<input type="hidden" name="searchbar_agents_hid" id="searchbar_agents_hid" 
					 value="<?php for($i=0;$i<count($guestE);$i++): ?><?php echo e($guestE[$i]['searchbar_agents']); ?>,<?php endfor; ?>" >
					 <input type="hidden" name="hle_guests_hid" id="hle_guests_hid" 
					 value="<?php for($i=0;$i<count($guestE);$i++): ?><?php echo e($guestE[$i]['hle_guests']); ?>,<?php endfor; ?>" >
					...
					<input type="hidden" name="searchbar_agents_hid" id="searchbar_agents_hid" value="<?php echo e($tasksE->hle_guest_id); ?>">
				...
				<input type="hidden" name="hle_guests_hid" id="hle_guests_hid" value="<?php echo e($tasksE->hle_guest_id); ?>">
				...
				<div class="form-group col-sm-12 col-md-12 col-lg-12">
				  ...
				  <input class="form-control" type="text" style="width:60%" autocomplete = "off" name="hle_start_date" id="hle_start_date" class="date" value="   <?php echo e(date('d/m/Y',strtotime($tasksE->hle_start_date))); ?>"/>
				  <select class="form-control" style="width:40%;padding:0px;" name="hle_start_hour" id="hle_start_hour">
					 <?php $__currentLoopData = $time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					 <?php $hour=date('H:i',strtotime($tasksE->hle_start_date)); ?>
					 <option value="<?php echo e($hm->time); ?>" <?php if($hm->time==$hour): ?> selected <?php endif; ?>>&nbsp;&nbsp;&nbsp;<?php echo e($hm->time); ?></option>
					 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				 </select>
				  </div>
				  </div>
				  ...
				  <div class="flex-items">
				  <input class="form-control" type="text" style="width:60%" autocomplete = "off" name="hle_end_date" id="hle_end_date" class="date"  value="   <?php echo e(date('d/m/Y',strtotime($tasksE->hle_end_date))); ?>"/>
					<select class="form-control"  style="width:40%;padding:0px;" name="hle_end_hour" id="hle_end_hour"  >
				     <?php $__currentLoopData = $time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h_m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					 <?php $endhour=date('H:i',strtotime($tasksE->hle_end_date)); ?>
					 <option value="<?php echo e($h_m->time); ?>"<?php if($h_m->time==$endhour): ?> selected <?php endif; ?>>&nbsp;&nbsp;&nbsp;<?php echo e($h_m->time); ?></option>
					 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				 </select> </div>
				  </div>
				  </div>
				  ...
				  <div style="width:75%;margin-top: 35px;" >
										...
										<input type="hidden" name="hle_recurr_status_hid" id="hle_recurr_status_hid" value="<?php echo e($tasksE->hle_recurr_status); ?>">
										<input type="hidden" name="hle_recurr_dur_hid" id="hle_recurr_dur_hid" value="<?php echo e($tasksE->hle_recurr_duration); ?>">
										<input type="hidden" name="hle_recurr_cnt_hid" id="hle_recurr_cnt_hid" value="<?php echo e($tasksE->hle_recurr_cnt); ?>">
						</div>
					</div>
				  ...
				  $cntv = count($tzlist);
				  ?>
				  <input type="hidden" name="hle_timezone_hid" id="hle_timezone_hid" value="<?php echo e($tasksE->hle_timezone); ?>">
					<div class="form-group">
				  ...
				  <input type="hidden" name="show_location_hid" id="show_location_hid" value="<?php echo e($tasksE->show_location); ?>">
				  <input type="hidden" name="hle_location_hid" id="hle_location_hid" value="<?php echo e($tasksE->hle_location); ?>">
...
<!--end-->
				   ...
				   <textarea name="hle_description" class="myTextEditor" id="hle_description"><?php echo e($tasksE->hle_description); ?> </textarea>
				   </div>
			...
			<div class="container">	  
							...
							<!-- <div class="col-sm-12 col-md-12 col-lg-12"> -->
							  ...
							  <div id="outcome_section" class="row" >
								  ...
								  <div class="form-group col-sm-6 col-md-6 col-lg-6">
									...
									<option value="">Select</option>
									<?php $__currentLoopData = $task_types1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($task_type->hl_mt_id); ?>" ><?php echo e($task_type->task_name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
							  		</div>
							  		<div class="form-group col-sm-6 col-md-6 col-lg-6">
									...
									<option value="">Select</option>
									<?php $__currentLoopData = $outcomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outcomes2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($outcomes2->hl_out_id); ?>" ><?php echo e($outcomes2->hl_out_title); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>					
									</div>
									<div class="form-group col-sm-3 col-md-3 col-lg-3">
									  ...
									  <select class="form-control" style="width:40%;padding:0px;" name="start_hour[]" id="start_hour_0">
										 <?php $__currentLoopData = $time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hm1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										 <option value="<?php echo e($hm1->time); ?>">&nbsp;&nbsp;&nbsp;<?php echo e($hm1->time); ?></option>
										 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									 </select>
									  ...
									  <input class="form-control end_date" type="text" style="width:60%" autocomplete = "off" name="end_date[]" id="end_date_0" class="date" />
									   <select class="form-control"  style="width:40%;padding:0px;" name="end_hour[]" id="end_hour_0"  >
									     <?php $__currentLoopData = $time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h_m1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										 <option value="<?php echo e($h_m1->time); ?>">&nbsp;&nbsp;&nbsp;<?php echo e($h_m1->time); ?></option>
										 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									 </select>
									  </div>
									  </div>
							  ...
							  <?php if($outcomeE): ?>							 
							  <?php $i=1;?>
							  <?php $__currentLoopData = $outcomeE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outcomeV): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							  <?php 
			  ...
			  <div id="outcome_section<?php echo e($i); ?>" class="row" >		
			  			<div id="removelink<?php echo e($i); ?>" class="form-group col-sm-12 col-md-12 col-lg-12">
						 	<div align="right" class="pull-right"><span id=rem<?php echo e($i); ?> onclick="removediv('<?php echo e($i); ?>')" class="mdi mdi-window-close" style="border: 1px solid red;border-radius: 50%;padding: 3px 5px;background-color: #ffbfbf;"></span>
						 	</div>
						</div>			
				  <div class="form-group col-sm-6 col-md-12 col-lg-6 appto">
					  <label style="vertical-align:text-top;"> Applicable To:</label>
						<select class="form-control js-example-basic-multiple w-100 applicable_to" multiple="multiple"  name="applicable_to_<?php echo e($i); ?>[]" id="applicable_to_<?php echo e($i); ?>" style="width:90%;"> 
									
						<optgroup label="Europe">
							<?php if($sleadsA): ?>
							<?php $__currentLoopData = $sleadsA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads1->hl_name)) && ($sleads1->hl_regional_name=='Europe')): ?>
							<option value="h<?php echo e($sleads1->hl_id); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='h'.$sleads1->hl_id;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads1->hl_name); ?></option>
							<?php endif; ?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>

							<?php if($sleadsB): ?>
							<?php $__currentLoopData = $sleadsB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads2->hotel_name)) && ($sleads2->hl_regional_name=='Europe')): ?>
							<option value="p<?php echo e($sleads2->hlid); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='p'.$sleads2->hlid;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads2->hotel_name); ?></option>
							<?php endif; ?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						</optgroup>
						<optgroup label="Middle East & Africa">
							<?php if($sleadsA): ?>
							<?php $__currentLoopData = $sleadsA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads1->hl_name)) && ($sleads1->hl_regional_name=='Middle East & Africa')): ?>
							<option value="h<?php echo e($sleads1->hl_id); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='h'.$sleads1->hl_id;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads1->hl_name); ?></option>
							<?php endif; ?>
							...
							<?php if($sleadsB): ?>
							<?php $__currentLoopData = $sleadsB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads2->hotel_name)) && ($sleads2->hl_regional_name=='Middle East & Africa')): ?>
							<option value="p<?php echo e($sleads2->hlid); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='p'.$sleads2->hlid;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads2->hotel_name); ?></option>
							<?php endif; ?>
						...
						<optgroup label="APAC">
							<?php if($sleadsA): ?>
							<?php $__currentLoopData = $sleadsA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads1->hl_name)) && ($sleads1->hl_regional_name=='APAC')): ?>
							<option value="h<?php echo e($sleads1->hl_id); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='h'.$sleads1->hl_id;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads1->hl_name); ?></option>
							<?php endif; ?>
							...
							<?php if($sleadsB): ?>
							<?php $__currentLoopData = $sleadsB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads2->hotel_name)) && ($sleads2->hl_regional_name=='APAC')): ?>
							<option value="p<?php echo e($sleads2->hlid); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='p'.$sleads2->hlid;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads2->hotel_name); ?></option>
							<?php endif; ?>
						...
						<optgroup label="South America">
							<?php if($sleadsA): ?>
							<?php $__currentLoopData = $sleadsA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads1->hl_name)) && ($sleads1->hl_regional_name=='South America')): ?>
							<option value="h<?php echo e($sleads1->hl_id); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='h'.$sleads1->hl_id;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads1->hl_name); ?></option>
							<?php endif; ?>
							...
							<?php if($sleadsB): ?>
							<?php $__currentLoopData = $sleadsB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads2->hotel_name)) && ($sleads2->hl_regional_name=='South America')): ?>
							<option value="p<?php echo e($sleads2->hlid); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='p'.$sleads2->hlid;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads2->hotel_name); ?></option>
							<?php endif; ?>
						...
						<optgroup label="North America">
							<?php if($sleadsA): ?>
							<?php $__currentLoopData = $sleadsA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads1->hl_name)) && ($sleads1->hl_regional_name=='North America')): ?>
							<option value="h<?php echo e($sleads1->hl_id); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='h'.$sleads1->hl_id;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads1->hl_name); ?></option>
							<?php endif; ?>
							...
							<?php if($sleadsB): ?>
							<?php $__currentLoopData = $sleadsB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleads2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((!empty($sleads2->hotel_name)) && ($sleads2->hl_regional_name=='North America')): ?>
							<option value="p<?php echo e($sleads2->hlid); ?>" <?php $__currentLoopData = $appli_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $chek='p'.$sleads2->hlid;?>
							<?php if($chek == $value): ?> selected="selected" <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($sleads2->hotel_name); ?></option>
							<?php endif; ?>
							...
							<?php endif; ?>
								  ...
								  <div class="form-group col-sm-6 col-md-6 col-lg-6">
									<label style="padding: 0px 10px 0px 0px;">Nextstep:</label>
									<select class="form-control std_nextsteps"  id="std_nextsteps_<?php echo e($i); ?>" name="std_nextsteps[]" data-show-icon="true">
									<option value="0">Select</option>

									<?php $__currentLoopData = $task_types1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($task_type->hl_mt_id); ?>" <?php echo e(( $outcomeV['std_nextsteps']==$task_type->hl_mt_id) ? 'selected' : ''); ?>><?php echo e($task_type->task_name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
							  		</div>
							  		<div class="form-group col-sm-6 col-md-6 col-lg-6">
									<label style="padding: 0px 10px 0px 0px;">Outcome:</label>
									<select class="form-control std_outcomes" style="margin-right: 5px;" id="std_outcomes_<?php echo e($i); ?>" name="std_outcomes[]" data-show-icon="true">
									<option value="0">Select</option>
									<?php $__currentLoopData = $outcomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outcomes1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($outcomes1->hl_out_id); ?>" <?php echo e(( $outcomeV['std_outcomes']==$outcomes1->hl_out_id) ? 'selected' : ''); ?>><?php echo e($outcomes1->hl_out_title); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
									</select>					
									</div>
									<div class="form-group col-sm-3 col-md-3 col-lg-3">
									  ...
									  <input class="form-control start_date" type="text" style="width:60%" autocomplete = "off" name="start_date[]" id="start_date_<?php echo e($i); ?>" value="   <?php echo e(date('d/m/Y',strtotime($outcomeV['start_date']))); ?>" class="date" />

									  
										<!-- <i class="fa fa-clock-o" aria-hidden="true"></i> -->
									  <select class="form-control" style="width:40%;padding:0px;" name="start_hour[]" id="start_hour_<?php echo e($i); ?>">
										 <?php $__currentLoopData = $time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hm1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										  <?php $starthourr=$outcomeV['start_hour']; ?>
										 <option value="<?php echo e($hm1->time); ?>"<?php if($hm1->time==$starthourr): ?> selected <?php endif; ?>>&nbsp;&nbsp;&nbsp;<?php echo e($hm1->time); ?></option>
										 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									 </select>
									  ...
									  <label>End Date & Time:</label><br>
									  <div class="flex-items">
									  <input class="form-control end_date" type="text" style="width:60%" autocomplete = "off" name="end_date[]" id="end_date_<?php echo e($i); ?>" value="   <?php echo e(date('d/m/Y',strtotime($outcomeV['end_date']))); ?>" class="date" />
									   <select class="form-control"  style="width:40%;padding:0px;" name="end_hour[]" id="end_hour_<?php echo e($i); ?>"  >
									     <?php $__currentLoopData = $time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h_m1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php $endhourr=$outcomeV['end_hour']; ?>
										 <option value="<?php echo e($h_m1->time); ?>"<?php if($h_m1->time==$endhourr): ?> selected <?php endif; ?>>&nbsp;&nbsp;&nbsp;<?php echo e($h_m1->time); ?></option>
										 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									 </select>
									  </div>
									  </div>
								  ...
								  <!-- <label>Outcome:</label> -->
								 <!--  <input type="text"  name="hle_outcome[]" id="hle_outcome_0" class="tinymce" value="" /> -->
								  <textarea name="hle_outcome[]" id="hle_outcome_<?php echo e($i); ?>" class="myTextEditor"><?php echo e($outcomeV['hl_outcome']); ?></textarea>
								...
								<div style=""><input type="checkbox" name="oc_recurr_status_<?php echo e($i); ?>" id="oc_recurr_status_<?php echo e($i); ?>" value="1" <?php if($outcomeV['oc_recurr_status']==1): ?> checked <?php endif; ?> onClick="openwin(this.checked);" >&nbsp;&nbsp;&nbsp;Repeat Task
								...
								<select  style="margin-right: 15px;margin-top: 26px;" aria-label="Repeat frequency" name="oc_recurr_duration[]" id="oc_recurr_duration_<?php echo e($i); ?>" class="form-control required">
								<?php $frequency=$outcomeV['oc_recurr_duration'];?>
								<option value="">Select</option>
								<option value="WEEKLY" <?php if($frequency=='WEEKLY'): ?> selected <?php endif; ?> id="ember228" class="native-single-select-option ember-view">Week(s)</option>
								<option value="MONTHLY"<?php if($frequency=='MONTHLY'): ?> selected <?php endif; ?> id="ember229" class="native-single-select-option ember-view">Month(s)</option>
								<option value="YEARLY"<?php if($frequency=='YEARLY'): ?> selected <?php endif; ?> id="ember230" class="native-single-select-option ember-view">Year(s)</option>
								...
								<div class="form-group" style="margin-right: -15px;">
								<label>Timezone:</label>
								<select class="form-control js-example-basic-single w-100 oc_timezone" name="oc_timezone[]" id="oc_timezone_<?php echo e($i); ?>" >
								<?php for($ff=0;$ff<$cntv;$ff++): ?>
								<?php $time_zone1=$outcomeV['oc_timezone'];?>
								<option value="<?php echo e($tzlist[$ff]); ?>" <?php if($tzlist[$ff]==$time_zone1): ?> selected <?php endif; ?>><?php echo e($tzlist[$ff]); ?></option>
								<?php endfor; ?>
								</select>
								...
								<div class="form-group col-sm-12 col-md-12 col-lg-12" style="margin-left: -15px;">
								<!-- <label>Next Step:</label> -->
								<textarea name="hle_next_step[]" id="hle_nextstep_<?php echo e($i); ?>" class="myeditable" ><?php echo e($outcomeV['hl_nextstep']); ?></textarea>

								  <!-- <input type="textarea"  name="hle_next_step[]" id="hle_nextstep_<?php echo e($i); ?>" class="form-control"  value="<?php echo e($outcomeV['hl_nextstep']); ?>" style="height: 320px;" /> -->
								  </div>	
								</div>


								   
							 		<input type="hidden" name="hl_ocns_id[]" id="hl_ocns_id_<?php echo e($i); ?>" value="<?php echo e($outcomeV['hl_ocns_id']); ?>" />
				...
				<div class="row">
					...
					<input type="hidden" name="event_id_hid" id="event_id_hid" value="<?php echo e($tasksE->hle_id); ?>">
					<a id="deletebut" onclick="del_event('<?php echo e($tasksE->hle_id); ?>')" href="javascript::void(0);" class="btn btn-outline-inverse-info btn-lg btn-crm" >Delete</a>&nbsp;&nbsp;&nbsp;
					<a id="completebut"  class="btn btn-outline-inverse-info btn-lg btn-crm" href="<?php echo e(url('crm/completevent')); ?>/<?php echo e($tasksE->hle_id); ?>">Complete Task</a>
					</div>
					
					
					<div class="col-sm-6 col-md-6 col-lg-6 pull-right">
						<a href="<?php echo e(url('crm/events')); ?>" class="btn btn-outline-inverse-info btn-lg" >Cancel</a>
...
function del_event(val){
	...
	var host="<?php echo e(url('crm/deleteevent')); ?>";	
	var rhost="<?php echo e(url('')); ?>";	
...
function load_task(){
			...
			var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
			var host="<?php echo e(url('crm/gethotels/')); ?>";	
			$.ajax({
			type: 'POST',
...
//1st
	...
	var urlval_del = "<?php echo e(url('crm/deleteevent')); ?>";
	urlval_del += "/"+event_id;
	//console.log(urlval);
