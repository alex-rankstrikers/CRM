...
<body>
  ...
  <form id="" action="<?php echo e(url('crm/exportcharts')); ?>/xlsx" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
...
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
  ...
  <script type="text/javascript">
    ...
    $("#from_date,#to_date,#task_type,#user_id,#region_id").change(function () {
        ...
        var host="<?php echo e(url('crm/getcharts/')); ?>"; 
        //var host1="<?php echo e(url('crm/getcolors/')); ?>"; 
//alert(to_date);
        $.ajaxSetup({
          headers: {
...
var urlData = "<?php echo e(url('crm/hotels/salesUpdated')); ?>";
