...
<div class="col-lg-8">
<div class="alert alert-success" role="alert">Dear <?php echo e(Auth::user()->first_name); ?>, Agent contacts details has been successfully added.</div>
</div>
<div class="col-lg-2"></div>
			...
			<div class="row mt-30 "></div>  
					...
					<div class="tab-content" id="tab-contents" style="margin-top:0px;">
					    <div class="tab-pane active" id="tab1">
						 <form id="addAgentForm" action="<?php echo e(url('crm/agentadded')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
					    	<?php echo e(csrf_field()); ?>
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Office Address </label><input type="text" name="address1" id="address1" value="<?php echo e(old('address1')); ?>" class="form-control required" data-error="#err_address1" ><span id="err_address1" style="position:relative;top: -2px;"></span>
								...
								<div class="form-group col-sm-12 col-md-6 col-lg-6">
                                        <label>Postcode </label><input type="text" class="form-control " name="postcode" id="postcode" value="<?php echo e(old('postcode')); ?>" >										
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Website </label><input type="text" class="form-control required" name="website" id="website" value="<?php echo e(old('website')); ?>" data-error="#err_website">
						 ...
						 <div class="col-lg-12 cform row" id="contact_add_form0">						
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                     ...
                                     <span id="err_cities1" style="position:relative;top: -2px;"></span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Postcode </label><input type="text" class="form-control required" name="postcode1" id="postcode1" value="<?php echo e(old('postcode1')); ?>" data-error="#err_postcode1">
...
function chk_businame(){
   ...
   var b_id= ""; 
	var host="<?php echo e(url('crm/getAgBusiname/')); ?>";	
	$.ajax({
		type: 'POST',
