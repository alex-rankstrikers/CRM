...
<div class="steps" id="rootwizard">
			...
			<h4 class="card-title">EDIT HOTEL LEADS</h4>
				...
				<div class="tab-content" id="tab-contents" style="margin-top:0px;">
				    <div class="tab-pane active" id="tab1">
    					<form id="commentForm" action="<?php echo e(url('crm/update-hotel')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
    						<?php echo e(csrf_field()); ?>


                            <div class="row">
                            	<input type="hidden" name="id" value="<?php echo e($hl_leads[0]['hl_id']); ?>">
									 <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       ...
                                       <select name="hotel_type" id="hotel_type" class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_type" >
										...
										<span class="error"><?php echo e(($errors->has('hotel_type')) ? $errors->first('hotel_type') : ''); ?></span>
										

										</div>

										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
										<div  id="grp_sec"><label>Group Name </label><input name="grp_name" id="grp_name" type="text" class="form-control " data-error="#err_title1"  value="<?php echo e($hl_leads[0]['hl_grp_name']); ?>">
    ...
    top: -2px;"></span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
										<label>Hotel Name </label><input name="title" id="title" type="text" class="form-control required" data-error="#err_title" value="<?php echo e($hl_leads[0]['hl_name']); ?>">
    ...
    top: -2px;"></span>
                                     ...
                                     <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Address </label><input type="text" name="address1" id="address1" value="<?php echo e($hl_leads[0]['hl_address']); ?>" class="form-control required" data-error="#err_address1" ><span id="err_address1" style="position:relative;top: -2px;"></span>
									...
									<option value="">Choose Country</option>									
										 ...
										 <option value="<?php echo e($country->id); ?>" <?= ($hl_leads[0]['hl_country'] == $country->id)?'selected':'' ?> >
                ...
                <label>State </label><select name="states" id="states"  class="form-control states js-example-basic-multiple w-100" style="width: 100%" data-error="#err_states">
                    <option value="">
                         ---Choose---
                                ...
                                <?php if($hl_leads[0]['hl_country']==$states->country_id): ?>
                                <option value="<?php echo e($states->id); ?>" <?php if($hl_leads[0]['hl_state']==$states->id): ?> selected="selected" <?php endif; ?> ><?php echo e($states->name); ?></option>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <input type="hidden" name="" id="state_id" value="<?php echo e($hl_leads[0]['hl_state']); ?>">
                         <input type="hidden" name="" id="city_id" value="<?php echo e($hl_leads[0]['hl_city']); ?>">

                         
                 </select>                                                                         
             <span id="err_states" style="position:relative;top: -2px;"></span>
                                                        <span class="error"><?php echo e(($errors->has('states')) ? $errors->first('states') : ''); ?></span>                                    
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                <label>City </label><select name="cities" id="cities"  class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_cities">                
                        <option value="">
                         ...
                         <?php $__currentLoopData = $editcities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cities): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($hl_leads[0]['hl_state']==$cities->state_id): ?>
                                <option value="<?php echo e($cities->id); ?>" <?php if($hl_leads[0]['hl_city']==$cities->id): ?> selected="selected" <?php endif; ?> ><?php echo e($cities->name); ?></option>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <input type="hidden" name="" id="city_id" value="<?php echo e($hl_leads[0]['hl_city']); ?>">
                 </select>                                                                         
             <span id="err_cities" style="position:relative;top: -2px;"></span>
                ...
                <!-- <div class="col-sm-6"><label>Buffet</label><input type="text" class="form-control"></div> -->
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       <label>Postcode </label><input type="text" class="form-control required" name="postcode" id="postcode" value="<?php echo e($hl_leads[0]['hl_postcode']); ?>" data-error="#err_postcode">
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       <label>Website </label><input type="text" class="form-control required" name="website" id="website" value="<?php echo e($hl_leads[0]['hl_website']); ?>"	 data-error="#err_website">
										...
										<input type="tel" class="form-control required" name="contact_no" id="contact_no" value="<?php echo e($hl_leads[0]['hl_contact_no']); ?>" data-error="#err_contact_no">
									<span class="error" id="err_contact_no" style="position:relative;top: -10px;"><?php echo e(($errors->has('err_contact_no')) ? $errors->first('err_contact_no') : ''); ?></span>
																			
                                    </div>
                                	<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>No of Room </label><input name="no_of_room" id="no_of_room" type="text" value="<?php echo e($hl_leads[0]['hl_no_room']); ?>" class="form-control required"  onkeypress="return isNumber(event)" data-error="#err_no_of_room" >
										<span id="err_no_of_room" style="position: relative;
    top: -2px;"></span>
										<span class="error"><?php echo e(($errors->has('no_of_room')) ? $errors->first('no_of_room') : ''); ?></span>
																			
                                      
                                    </div>
									
									<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       <label>No of Meeting Room </label><input name="no_of_m_room" id="no_of_m_room" value="<?php echo e($hl_leads[0]['hl_no_m_room']); ?>" type="text" class="form-control required"  onkeypress="return isNumber(event)" data-error="#err_price" >
										<span id="err_price" style="position: relative;
    top: -2px;"></span>
										<span class="error"><?php echo e(($errors->has('no_of_m_room')) ? $errors->first('no_of_m_room') : ''); ?></span>
									 ...
									 <option value="">Choose Lead Type</option>									
										 <?php $__currentLoopData = $hdlead_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hdlead_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										 <option value="<?php echo e($hdlead_type->hl_mt_lt_id); ?>" 
										 	<?= ($hl_leads[0]['hl_lead_type'] == $hdlead_type->hl_mt_lt_id )?'selected':'' ?>
										 	>
										 <?php echo e($hdlead_type->hl_lead_type_name); ?>
...
?>
										...
										<?php $__currentLoopData = $hdproperty_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hdproperty_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($hdproperty_type->hl_pro_id); ?>"
											<?= (in_array($hdproperty_type->hl_pro_id, $prop_type))?'selected':'' ?>
											><?php echo e($hdproperty_type->hl_property_description); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>
...
<!-- 
									...
									<span class="error"><?php echo e(($errors->has('solution_type')) ? $errors->first('solution_type') : ''); ?></span>
									</div>
    ...
    top: -2px;"></span>
										<span class="error"><?php echo e(($errors->has('star_rate')) ? $errors->first('star_rate') : ''); ?></span>
										</div>	   
                               
								  <div class="col-sm-12 col-md-12 col-lg-12">
								  <label><b>Notes</b> </label>
								  <input name="hotel_description" class="tinymce" id="hotel_description" value="<?php echo e($hl_leads[0]['notes']); ?>"> </input>
									</div>
...
<?php $__currentLoopData = $hl_leads_contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div id="contact_section" class="">
	 <div id="contact_add_form<?php echo e($key); ?>" class="row">
	<input type="hidden" name="hl_c_id[]" value="<?php echo e($value['hl_c_id']); ?>">
		<div class="col-sm-12 col-md-6 col-lg-6 form-group ">
		...
		<span class="error"><?php echo e(($errors->has('contact_person')) ? $errors->first('contact_person') : ''); ?></span>
		...
		<span class="error"><?php echo e(($errors->has('contact_status')) ? $errors->first('contact_status') : ''); ?></span>
		</div>
		</div>
		...
		<input name="firstname[]" id="firstname" type="text" class="form-control required" data-error="#err_firstname" value="<?php echo e($value['hl_c_firstname']); ?>">
		...
		<input name="lastname[]" id="lastname" type="text" class="form-control required" data-error="#err_lastname" value="<?php echo e($value['hl_c_lastname']); ?>">
		...
		<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation </label>
			<input type="text" id="contact_designation" name="contact_designation[]" class="form-control" value="<?php echo e($value['hl_c_designation']); ?>">
...
top: -2px;"></span>
		...
		<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Number </label>
			<input name="contact_number[]" id="contact_number" type="tel" class="form-control required" data-error="#err_contact_number" value="<?php echo e($value['hl_c_no']); ?>">
		...
		<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email</label>
			<input name="contact_email[]" id="contact_email" type="text" class="form-control required" data-error="#err_contact_email" value="<?php echo e($value['hl_c_email']); ?>">
		<span id="err_contact_email" style="position: relative;
		top: -2px;"></span>
		<span class="error"><?php echo e(($errors->has('linked_in')) ? $errors->first('linked_in') : ''); ?></span>
		</div>
		
		<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>LinkedIn Contact </label>
			<input name="linked_in[]" id="linked_in" type="text" class="form-control " data-error="#err_linked_in" value="<?php echo e($value['hl_c_linked_contact']); ?>">
		...
		top: -2px;"></span>
		<span class="error"><?php echo e(($errors->has('skype_con')) ? $errors->first('skype_con') : ''); ?></span>
		</div>
		

		<div class="col-sm-12 col-md-12 col-lg-12">
		  <label><b>Notes</b> </label>
		  <input name="contact_hotel_description[]" class="tinymce" id="contact_hotel_description" value="<?php echo e($value['hl_c_notes']); ?>"> </input>
		</div>
...
<div class="col-sm-12 col-md-12 col-lg-12 mtb-15">
 ...
 <div class="tab-pane" id="tab02">
				    	<form id="commentForm" action="<?php echo e(url('crm/added-user')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
						<div id="contact_section" class="">
						...
						<div class="col-lg-6 col-md-7 offset-3" style="margin-top: 5%;" > 
						 ...
						 <div class="form-group row">
                          ...
                          <div class="col-sm-6 col-md-8">
                           <input class="form-control" type="text" value="" name="firstname" id="edit_firstname" value="<?php echo e(old('firstname')); ?>" autocomplete="off"/>
										<span class="error"><?php echo e(($errors->has('firstname')) ? $errors->first('firstname') : ''); ?></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6 col-md-8">
                            <input class="form-control" type="text" value="" name="lastname" id="edit_lastname" value="<?php echo e(old('lastname')); ?>" autocomplete="off"/>
										<span class="error"><?php echo e(($errors->has('lastname')) ? $errors->first('lastname') : ''); ?></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6 col-md-8">
                            <input class="form-control" type="text" value="" name="email" id="edit_email" value="<?php echo e(old('email')); ?>" autocomplete="off"/>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6 col-md-8">
                            <input class="form-control" type="password" autocomplete="off" value="" name="password" id="edit_password" />
										<span class="error"><?php echo e(($errors->has('password')) ? $errors->first('password') : ''); ?></span>
                          </div>
                        </div>

                      					
						<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
						<input type="hidden" id="hotel_id" name="hotel_id" value="<?php echo e(request()->route('id')); ?>">
								<div class="row mt-30 "></div>
						...
						<!-- view end-->
						<!-- modal open-->
						<form  id="edit_user" action="<?php echo e(url('crm/userpw-updated')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
...
function load_model(val){
	...
	var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
  	...
  	//alert(edit_id);
	var host="<?php echo e(url('crm/getuserdetail/')); ?>";	
	$.ajax({
		type: 'POST',
