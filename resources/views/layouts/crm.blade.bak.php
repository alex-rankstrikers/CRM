...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="{{URL::to('/crm')}}"><i class="fas fa-eye"></i>

Insight</a>&nbsp;&nbsp;&nbsp;&nbsp;

    <button class="btn btn-link btn-sm text-white order-1 order-sm-0 pull-right" id="sidebarToggle" href="#">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="{{ url('crm/edit-profile') }}">Edit Profile</a>
          <a class="dropdown-item" href="{{ url('crm/update-password') }}">Update Password</a>
          <div class="dropdown-divider"></div>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{ url('crm/add-hotel') }}">Add Hotel Leads</a>
          <a class="dropdown-item" href="{{ url('crm') }}">View Hotel Leads</a>
          <!-- <div class="dropdown-divider"></div>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © <a href="https://ap-lbc.com">aplbc.com</a> 2019</span>
          </div>
        </div>
      </footer>
    </div>
