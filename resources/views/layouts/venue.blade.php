...
<html lang="en">
  <head>
    ...
    <title>Search Venue Admin!  </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="javascript:void(0);" class="site_title"><i class="fa fa-paw"></i> <span>Search Venue !</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                 ...
                 <?php  /*<li><a href="{{ url('admin/multilanguage') }}"><i class="fa fa-table"></i> MultiLanguage   <!--<span class="fa fa-chevron-right"></span>--></a>                  
				  ...
				  <li><a><i class="fa fa-th-large"></i>Subscription  <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-building-o"></i>Venue Management  <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('admin/venue/capacity') }}">Capacity</a></li>
                      <li><a href="{{ url('admin/venue/features') }}">Features</a></li>
                      <li><a href="{{ url('admin/venue/food-drink') }}">Food & Drink</a></li>
                      <li><a href="{{ url('admin/venue/licensing') }}">Licensing</a></li>
                      <li><a href="{{ url('admin/venue/restrictions') }}">Restrictions</a></li>
                    
                      <?php /*<li><a href="{{ url('admin/merchants/listing') }}">Listing</a></li>*/?>
                    			 
                    </ul>
                  </li>
				  <li><a><i class="fa fa-building-o"></i>Merchants  <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('admin/merchants/users') }}">Users</a></li>
                      <?php /*<li><a href="{{ url('admin/merchants/listing') }}">Listing</a></li>*/?>
                      <li><a href="{{ url('admin/merchants/venue') }}">Venue Overview</a></li>
					  <li><a href="{{ url('admin/merchants/campaigns') }}">Campaigns</a></li>					 
                    </ul>
                  </li>
 ...
 <li><a href="{{ url('clear-cache') }}"><i class="fa fa-frown-o"></i> Clear Cache <span class="fa fa-chevron-down"></span></a>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="{{ asset('admin-assets/images/img.jpg') }}" alt="Profile Image" /></span>
                        <span>
        ...
        <footer>
          <div class="pull-right">
            <a href="https://needifo.com">SearchVenue.co.uk</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
