        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="javascript:void(0);" class="site_title"><i class="fa fa-paw"></i> <span>TBBC Hotelier</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ url('merchant') }}"><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-down"></span></a></li>
				              
				 
			
                   <li> <a  href="{{ url('merchant/add-hotel') }}"><i class="fa fa-building-o"></i> Add Hotel </a></li>
                   <li> <a  href="{{ url('merchant') }}"><i class="fa fa-building-o"></i> View Hotel </a></li>
