...
<div class="navbar-pills " id="bs-example-navbar-collapse-2">
        ...
        <li class="nav-item"><a class="nav-link" href="#tab09" data-toggle="tab">Add/View User</a></li>  
        </ul>
</div>
<!-- /.navbar-collapse -->
{{ csrf_field() }}
...
<div class="col-lg-4 col-sm-4"> 
    <div class="col-sm-12 col-md-12 col-lg-12">
    <div class="form-group">
    <label>Active</label><input type="checkbox" name="add_active" id="add_active" data-error="#err_active" class="form-control">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
    <div class="form-group">
    <label>Rolling Inventry</label><input type="number" name="add_rolling_invetry" id="add_rolling_invetry" data-error="#err_add_rolling_invetry" min="1">
...
<div class="form-group">
<label><input type="checkbox" name="add_total_guest_per_room_un" id="add_total_guest_per_room_un" data-error="#err_add_total_guest_per_room_un" class="form-control" onclick="if($(this).prop('checked') == true){$('#add_total_guest_per_room').css('display','none');}else{$('#add_total_guest_per_room').css('display','block');}">
</label>Unlimited
</div>
...
<div class="form-group">
<label><input type="checkbox" name="add_adult_occupancy_un" id="add_adult_occupancy_un" data-error="#err_add_adult_occupancy_un" class="form-control" onclick="if($(this).prop('checked') == true){$('#add_adult_occupancy').css('display','none');}else{$('#add_adult_occupancy').css('display','block');}">
</label>Unlimited</div>
...
<div class="form-group">
<label><input type="checkbox" name="add_child_occupancy_un" id="add_child_occupancy_un" data-error="#err_add_child_occupancy_un" class="form-control" onclick="if($(this).prop('checked') == true){$('#add_child_occupancy').css('display','none');}else{$('#add_child_occupancy').css('display','block');}">
</label>Unlimited</div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <input type="checkbox" name="edit_no_end_date" id="edit_no_end_date_{{$HotelTax->id}}" value="Yes" data-error="err_no_end_date" @if($HotelTax) @if($HotelTax->no_end_date=='Yes') checked="checked" @endif @endif class="form-control" >No End Date
                    </div>
                </div>
            </div>
...
<div class="col-sm-12 col-md-12 col-lg-12 panel" >SALES ACTIVITY</div>
