...
.label-info{ background:none !important}
 ...
 <form id="commentForm" action="{{url('merchant/rooms')}}/{{$hid}}/updated" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
                 ...
                 <div class="steps" id="rootwizard">
					...
					<div class="row mb-10 mt-30  rm{{ $Room->id }}" >
							...
							?>
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-left mt-15">
