    ...
    <div class="row">
        <div class="col-md-12  col-xs-12">
            <div class="panel panel-default">
				...
				<?php /*
				<div class="panel-heading">Leads Details</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{{url('')}}/merchant/stripe" >
                        ...
                        <div class="form-group{{ $errors->has('card_no') ? ' has-error' : '' }}">
                            <label for="card_no" class="col-md-4 control-label">Name</label>
                            <div class="col-md-6">
							{{$leads->name}}
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('ccExpiryMonth') ? ' has-error' : '' }}">
                            <label for="ccExpiryMonth" class="col-md-4 control-label">Phone</label>
                            <div class="col-md-6">
                                {{$leads->phone}} 
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('ccExpiryYear') ? ' has-error' : '' }}">
                            <label for="ccExpiryYear" class="col-md-4 control-label">Email</label>
                            <div class="col-md-6">
                               	{{$leads->email}}
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('cvvNumber') ? ' has-error' : '' }}">
                            <label for="cvvNumber" class="col-md-4 control-label">	Event date</label>
                            <div class="col-md-6">
                              {{$leads->event_date}}
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            <label for="amount" class="col-md-4 control-label">	Event time</label>
                            <div class="col-md-6">
                                	{{$leads->event_time}}
                            </div>
                        </div>
						 ...
						 <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            <label for="amount" class="col-md-4 control-label">	Number of Guest </label>
                            <div class="col-md-6">
                                	{{$leads->no_of_guest}}
                            </div>
                        </div>
						 ...
						 <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            <label for="amount" class="col-md-4 control-label">	Budget per head *</label>
                            <div class="col-md-6">
                                	{{$leads->bph}}
                            </div>
                        </div>
						 ...
						 <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            <label for="amount" class="col-md-4 control-label">	Additional details</label>
                            <div class="col-md-6">
                                	{{$leads->specific_req}}
                            </div>
                        </div>
