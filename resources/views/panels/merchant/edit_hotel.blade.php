                 ...
                 <div class="steps" id="rootwizard">
					...
					<div class="row mb-10 mt-30  rm{{ $hotel->id }}" >
							...
							?>
										...
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-left mt-30">
										...
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
											<div class="row mt-30">
										<?php /*	{{ url('venue-details') }}/{{ $hotel->id }} */ ?>
				                            ...
				                            <a href="{{ url('merchant') }}/add-room/{{ $hotel->id }}" class="btn-primary btn-xs border-radius-none custom-btn-inner" > Add Room</a>
				                            
				                             <a href="{{ url('merchant') }}/view-rooms/{{ $hotel->id }}" class="btn-info btn-xs border-radius-none custom-btn-inner" > View Rooms</a>
