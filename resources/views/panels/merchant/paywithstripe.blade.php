    ...
    <div class="row">
        <div class="col-md-12  col-xs-12">
            <div class="panel panel-default">
				...
				<!-- <form action="{{url('merchant/success')}}" method="POST">
  <script
    src="https://checkout.stripe.com/checkout.js" class="stripe-button"
    data-key="pk_test_dOtpeGe1er6iC7ycnMs5Ai4S"
    data-amount="90.00"
    data-name="searchvenue.co.uk"
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{{url('')}}/merchant/stripe" >
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
							<label for="amount" class="col-md-4  text-left">£39</label>
							
                                <input id="amount" type="hidden" class="form-control" name="amount" value="39" autofocus>
                                @if ($errors->has('amount'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('amount') }}</strong>
                                    </span>
                                @endif
								<?php /*<input type="hidden"name="lead_id" value="{{$lead_id}}">*/?>
                            </div>
                        </div>
