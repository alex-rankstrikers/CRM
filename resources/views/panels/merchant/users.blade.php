    ...
    <div class="page-title">
            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								...
								<form name="actionForm" action="{{url('admin/merchants/users/destroy')}}" method="post" onsubmit="return deleteConfirm();"/> 
									<h2>All Merchants Users <span class="pull-right"><a href="#" class="btn btn-success btn-xs add_blog"><i class="fa fa-plus"></i> Add </a>  
					...
					<div class="x_panel" id="add_div" style="">
						<h2>Add Merchants User </h2>
						<div class="x_title">
						</div>
						@if(Session::get('message')) <div class="alert alert-success" role="alert">{{Session::get('message')}} </div>@endif 
						<div class="alert alert-success hidden"></div>
								  <!-- Add Form Start-->
						 <form method="POST" action="{{url('admin/merchants/users/added')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
