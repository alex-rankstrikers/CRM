                 ...
                 <div class="steps" id="rootwizard">
                    <div class="row">
                        <div class="col-lg-12" id="content_desc">
							...
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"><a href="{{ url('merchant/add-hotel') }}" class="btn btn-primary btn-center enqiry-button">Add Hotel</a></div>
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12"></div>
						<div class="row mt-30 "></div>							
                        </div>
                    </div>
					...
					<div class="row mt-30 "></div>	
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border">
							...
							<a href="{{ url('merchant/edit-space') }}" class="btn btn-primary btn-center enqiry-button">Edit Venue Space Details</a>
