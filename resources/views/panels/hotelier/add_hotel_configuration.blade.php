...
<div class="form-group">
    ...
    <label>Hotel Group Name </label>
        ...
        <option value="{{$Hotel_Group->id}}" @if($Hotels) @if($Hotel_Group->id==$Hotels->grp_name) selected="selected" @endif @endif>{{$Hotel_Group->title}}
        </option>
        @endforeach
        </select>
...
<?php $i=1;?>
@foreach($HotelAdditionalContact as $HotelAdditionalContacts)

<div class="col-sm-12 col-md-12 col-lg-12 mtb-15 accordion">Edit @if($HotelAdditionalContacts){{$HotelAdditionalContacts->f_name}}@endif</div>
<div class="col-sm-12 col-md-12 col-lg-12 panel">
<div class=" row">
<div class="alert alert-success hidden alert-update-user-{{$i}} col-md-12 col-lg-12 mtb-15"></div>
<input type="hidden" name="cont_id" id="cont_id_{{$i}}" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->id}}@endif">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="form-group">
    <label>Title</label>
    <select name="c_title_{{$i}}" id="c_title_{{$i}}" class="form-control" data-error="#err_c_title">
...
<div class="form-group">
    <label>First Name</label>
    <input type="text" name="f_name_{{$i}}" id="f_name_{{$i}}" class="form-control" data-error="err_f_name" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->f_name}}@endif">
    <span id="err_f_name" style="position: relative;
top: -2px;"></span>
    <span class="error">{{ ($errors->has('f_name')) ? $errors->first('f_name') : ''}}</span>
</div>
...
<div class="form-group">
    <label>Last Name</label>
    <input type="text" name="l_name_{{$i}}" id="l_name_{{$i}}" class="form-control" data-error="err_l_name" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->l_name}}@endif">
    <span id="err_l_name" style="position: relative;
top: -2px;"></span>
    <span class="error">{{ ($errors->has('l_name')) ? $errors->first('l_name') : ''}}</span>
</div>
...
<div class="form-group">
    <label>Job Title</label>
    <input type="text" id="job_title_{{$i}}" name="job_title_{{$i}}" class="form-control" data-error="err_job_title" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->job_title}}@endif">
    <span id="err_job_title" style="position: relative;
top: -2px;"></span>
    <span class="error">{{ ($errors->has('job_title')) ? $errors->first('job_title') : ''}}</span>
</div>
...
<div class="form-group">
    <label>Email address</label>
    <input type="email" name="email_add_{{$i}}" class="form-control" id="email_add_{{$i}}" data-error="email_add" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->email_add}}@endif">
    <span id="err_email_add" style="position: relative;
top: -2px;"></span>
    <span class="error">{{ ($errors->has('email_add')) ? $errors->first('email_add') : ''}}</span>
</div>
...
<div class="form-group">
    <label>Contact Number</label>
    <input type="number" id="c_number_{{$i}}" name="c_number_{{$i}}" class="form-control" data-error="err_c_number" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->c_number}}@endif" min="1">
    <span id="err_c_number" style="position: relative;
top: -2px;"></span>
    <span class="error">{{ ($errors->has('c_number')) ? $errors->first('c_number') : ''}}</span>
</div>
...
<div class="form-group">
    <label>Mobile Number</label>
    <input type="number" name="m_number_{{$i}}" class="form-control" id="m_number_{{$i}}" data-error="err_m_number" value="@if($HotelAdditionalContacts){{$HotelAdditionalContacts->m_number}}@endif" min="1">
...
<div class="form-group">
    <label>Contact Purpose</label>
    <select class="form-control" data-error="err_cotact_purpose" name="cotact_purpose_{{$i}}" id="cotact_purpose_{{$i}}">
...
<div class="form-group">
    <label>Request for Portal Login Credentials</label>
    <input type="checkbox" name="login_req_{{$i}}" class="form-control" value="Yes" id="login_req_{{$i}}" data-error="err_login_req" @if($HotelAdditionalContacts) @if($HotelAdditionalContacts->login_req == 'Yes' ) checked="checked" @endif @endif>
    <span id="err_login_req" style="position: relative;
top: -2px;"></span>
    <span class="error">{{ ($errors->has('login_req')) ? $errors->first('login_req') : ''}}</span>
</div>
            ...
            <div class="col-md-2 col-sm-12 col-xs-2 offset-10">                      
            <input class="btn btn-primary btn-center portal-button portalupdateuser" type="button" name="submit" id="portalupdateuser_{{$i}}" value="Submit" data-id="{{$i}}"/>
...
<table class="table borderless">
    ...
    <tbody id="airportinfo-form-list">
        <?php $i=0;$total= count($HotelAirportInfo);?>
            @foreach($HotelAirportInfo as $HotelAirportInfos)

             @if($i<$total) 
            <input type="hidden" value="{{$HotelAirportInfos->id}}" name="airport_id[]">
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control" name="location_type" id="location_type" data-error="err_location_type">
                ...
                <option  value="AIR" @if($HotelPropertyAttributes) @if($HotelPropertyAttributes->location_type=="AIR") selected @endif @endif>Airport</option>
                    <option value="DWT" @if($HotelPropertyAttributes) @if($HotelPropertyAttributes->location_type=="DWT") selected @endif @endif>Downtown</option>
                    <option value="HWY" @if($HotelPropertyAttributes) @if($HotelPropertyAttributes->location_type=="HWY") selected @endif @endif>Highway</option>
                    <option value="RST" @if($HotelPropertyAttributes) @if($HotelPropertyAttributes->location_type=="RST") selected @endif @endif>Resort</option>
                    <option value="SUB" @if($HotelPropertyAttributes) @if($HotelPropertyAttributes->location_type=="SUB") selected @endif @endif>Suburban</option>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="pprice" id="price" type="checkbox" class="form-control" value="true" @if($HotelPropertyAttributes) @if($HotelPropertyAttributes->price=='true') selected @endif @endif">
  ...
  top: -2px;"></span>
    ...
    <div class="col-sm-12 col-md-5 col-lg-5">
        ...
        <div class="form-group">
            ...
            <label style="margin-top: 4px;">
            <input type="checkbox" value="true" name="child_friendly" @if($HotelDEBar->child_friendly=='true') checked="checked" @endif></label> &nbsp;Tick if the bar child friendly
        </div>
        <div class="form-group">
            <label>Description</label>
...
<div class="col-lg-4 col-sm-4"> 
   <div class="col-sm-12 col-md-12 col-lg-12 mtb-15"> 
    ...
    <span class="error">{{ ($errors->has('active')) ? $errors->first('active') : ''}}</span></div></div>
 <h4 style="padding: 3px;">&nbsp;</h4>
    ...
    <span class="error">{{ ($errors->has('add_room_code')) ? $errors->first('add_room_code') : ''}}</span></div></div>
    <div class="col-sm-12 col-md-12 col-lg-12">
    <div class="form-group">
    ...
    <span class="error">{{ ($errors->has('add_room_name')) ? $errors->first('add_room_name') : ''}}</span></div></div>
    ...
    <span class="error">{{ ($errors->has('add_total_room')) ? $errors->first('add_total_room') : ''}}</span></div></div>
    ...
    <span class="error">{{ ($errors->has('add_rolling_invetry')) ? $errors->first('add_rolling_invetry') : ''}}</span></div></div>
    ...
    <span class="error">{{ ($errors->has('add_room_category')) ? $errors->first('add_room_category') : ''}}</span></div></div>
    ...
    <span class="error">{{ ($errors->has('add_room_short_desc')) ? $errors->first('add_room_short_desc') : ''}}</span></div></div>
...
<span class="error" id="err_add_room_size"></span><span class="error">{{ ($errors->has('add_room_size')) ? $errors->first('add_room_size') : ''}}</span>
</div></div>
...
<span class="error" id="err_add_ada_compliant"></span><span class="error">{{ ($errors->has('add_ada_compliant')) ? $errors->first('add_ada_compliant') : ''}}</span>
</div></div>
...
<span class="error" id="err_add_room_min_size"></span><span class="error">{{ ($errors->has('add_room_min_size')) ? $errors->first('add_room_min_size') : ''}}</span>
</div></div>
...
<span class="error" id="err_add_room_max_size"></span><span class="error">{{ ($errors->has('add_room_max_size')) ? $errors->first('add_room_max_size') : ''}}</span>
</div></div>
...
<span class="error" id="err_add_room_size_units"></span><span class="error">{{ ($errors->has('add_room_size_units')) ? $errors->first('add_room_size_units') : ''}}</span>
</div></div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_bed_type')) ? $errors->first('add_bed_type') : ''}}</span>
</div></td>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_total_guest_per_room')) ? $errors->first('add_total_guest_per_room') : ''}}</span>
</div>
</div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_adult_occupancy')) ? $errors->first('add_adult_occupancy') : ''}}</span>
</div></div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_child_occupancy')) ? $errors->first('add_child_occupancy') : ''}}</span>
</div>
</div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_child_age_limit')) ? $errors->first('add_child_age_limit') : ''}}</span>
</div></div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_allow_extra_bed')) ? $errors->first('add_allow_extra_bed') : ''}}</span>
</div></div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_price_adjustment_type')) ? $errors->first('add_price_adjustment_type') : ''}}</span>
</div></div>
...
top: -2px;"></span><span class="error">{{ ($errors->has('add_default_adjustment')) ? $errors->first('add_default_adjustment') : ''}}</span>
</div></div>
</div>
</div>
...
<select class="form-control js-example-basic-multiple" multiple="multiple" style="width: 100%" name="add_key_features" id="add_key_features" data-error="#err_add_key_features">
    @if($CategoryRoomsFeatures)
    @foreach($CategoryRoomsFeatures as $CRoomsFeatures)
    <option value="{{$CRoomsFeatures->ota_code}}">{{$CRoomsFeatures->ota_desc}}</option>
    @endforeach
    @endif
</select>
<span class="error" id="err_add_key_features" style="position: relative;
top: -2px;"></span><span class="error">{{ ($errors->has('add_key_features')) ? $errors->first('add_key_features') : ''}}</span>
</div></div>
...
<select class="form-control js-example-basic-multiple" multiple="multiple" style="width: 100%" name="add_room_view" id="add_room_view" data-error="#err_add_room_view">
    @if($CategoryRoomsView)
    @foreach($CategoryRoomsView as $CRoomsView)
    <option value="{{$CRoomsView->ota_code}}">{{$CRoomsView->ota_desc}}</option>
    @endforeach
    @endif
</select>
<span class="error" id="err_add_room_view" style="position: relative;
top: -2px;"></span><span class="error">{{ ($errors->has('add_room_view')) ? $errors->first('add_room_view') : ''}}</span>
</div></div>
...
<div class="col-sm-12 col-md-12 col-lg-12">
    <div class="form-group">
        ...
        <input type="number" name="add_rolling_invetry{{$Room->rid}}" id="add_rolling_invetry{{$Room->rid}}" min="1" class="form-control" value="{{$Room->rolling_invetry}}">
...
<tbody id="bedtype_listUpdate{{$Room->rid}}">
...
?>
    ...
    @foreach($bedDataArray as $key=>$RBedType)
    <tr id="bedtypeUpdate{{$Room->rid}}">
    ...
    <option selected="selected" value="">-Select-</option>
    @foreach($RoomBedType as $RBType)
    <option value="{{$RBType->id}}" <?=( $RBType->id == $bedDataArray[$key])?'selected':''; ?> >{{$RBType->title}}
    </option>
    @endforeach
    </select>
    ...
    <td>
    <div class="form-group">
    <input type="number" name="add_bed_quantity{{$Room->rid}}[]" id="add_bed_quantity{{$Room->rid}}" class="form-control" value="{{$bedQuantityArray[$key]}}" min="1">
    ...
    <td>
    <div class="form-group">
    <input type="radio" name="add_bed_primary{{$Room->rid}}[]" id="add_bed_primary{{$Room->rid}}" data-error="#err_add_bed_primary" class="form-control add_bed_primaryUpdate"
    ...
    <td><td>
    <button id="clonebedUpdate" onclick="clonebedUpdate1({{$Room->rid}})" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
    </td></td>
...
<input type="number" name="add_default_adjustment{{$Room->rid}}" id="add_default_adjustment{{$Room->rid}}" class="form-control" min="0" value="{{$Room->default_adjustment}}">
...
<select class="form-control js-example-basic-multiple" multiple="multiple" style="width: 100%" name="add_key_features{{$Room->rid}}" id="add_key_features{{$Room->rid}}" data-error="#err_add_key_features{{$Room->rid}}">
    ...
    <?php $rdata='';?>
            @foreach($Features as $val)
                @if($CRoomsFeatures->ota_code==$val->kf_id)
                    <?php $rdata='Yes';?>
                @endif
            @endforeach            
<option value="{{$CRoomsFeatures->ota_code}}" @if($rdata=='Yes') selected="selected" @endif>{{$CRoomsFeatures->ota_desc}}</option>            
    
    @endforeach
    @endif
</select>
<span class="error" id="err_add_key_features{{$Room->rid}}" style="position: relative;
top: -2px;"></span><span class="error">{{ ($errors->has('add_key_features')) ? $errors->first('add_key_features') : ''}}</span>
</div></div>

<div class="col-sm-12 col-md-6 col-lg-6">
<div class="form-group"><label>Room Views</label>
<select class="form-control js-example-basic-multiple" multiple="multiple" style="width: 100%" name="add_room_view{{$Room->rid}}" id="add_room_view{{$Room->rid}}" data-error="#err_add_room_view{{$Room->rid}}">
    @if($CategoryRoomsView)
    @foreach($CategoryRoomsView as $CRoomsView)
<?php $data='';?>
            @foreach($RoomView as $val)
                @if($CRoomsView->ota_code==$val->rv_id)
                    <?php $data='Yes';?>
                @endif
            @endforeach
            <option value="{{$CRoomsView->ota_code}}" @if($data=='Yes') selected="selected" @endif>{{$CRoomsView->ota_desc}}</option>
...
<div class="form-group">
<label>Room Main Image</label>
<input type="file" name="uploadFile{{$Room->rid}}" id="uploadFile{{$Room->rid}}" class="filestyle" onchange="roomImgUpdate('uploadFile{{$Room->rid}}','image_preview{{$Room->rid}}')">
<!-- <div class="input-group col-xs-12">
<input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
<span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
@if($Room->image_1)<img src="{{ asset('uploads/rooms/'.$Room->image_1) }}">@endif
</div></div>

<div class="col-sm-3 col-md-3 col-lg-3">
<div class="form-group">
<label>&nbsp;</label>
<input type="file" name="uploadFile1{{$Room->rid}}" id="uploadFile1{{$Room->rid}}" class="filestyle" onchange="roomImgUpdate('uploadFile1{{$Room->rid}}','image_preview1{{$Room->rid}}')">
<!-- <div class="input-group col-xs-12">
<input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
<span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
@if($Room->image_2)<img src="{{ asset('uploads/rooms/'.$Room->image_2) }}">@endif
</div></div>

<div class="col-sm-12 col-md-3 col-lg-3">
<div class="form-group">
<label>&nbsp;</label>
<input type="file" name="uploadFile2{{$Room->rid}}" id="uploadFile2{{$Room->rid}}" class="filestyle" onchange="roomImgUpdate('uploadFile2{{$Room->rid}}','image_preview2{{$Room->rid}}')">
<!-- <div class="input-group col-xs-12">
<input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
<span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
@if($Room->image_3)
<img src="{{ asset('uploads/rooms/'.$Room->image_3) }}">@endif
</div></div>
...
<div class="form-group">
<label>&nbsp;</label>
<input type="file" name="uploadFile3{{$Room->rid}}" id="uploadFile3{{$Room->rid}}" class="filestyle" onchange="roomImgUpdate('uploadFile3{{$Room->rid}}','image_preview3{{$Room->rid}}')">
<!-- <div class="input-group col-xs-12">
<input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
<span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
@if($Room->image_4)<img src="{{ asset('uploads/rooms/'.$Room->image_4) }}">@endif
</div>
</div>
...
@foreach($HotelTaxConfigur as $HotelTax)

<input type="hidden" name="tax_mid" value="{{$HotelTax->id}}">
<div class="col-sm-12 col-md-12 col-lg-12 mtb-15 accordion ">Edit Tax {{$HotelTax->tax_name}}</div>
<div class="col-sm-12 col-md-12 col-lg-12 panel " style="display: ;">
<div class="alert alert-success tax-success hidden" id="taxSuccess{{$HotelTax->id}}"></div>
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Level</label>
            <select class="form-control" name="edit_tax_level" id="edit_tax_level_{{$HotelTax->id}}" data-error="#err_tax_level{{$HotelTax->id}}">
                <option value="">Select Level</option>
                <option value="Hotel"  @if($HotelTax->tax_level == 'Hotel') selected="selected" @endif >Hotel Taxes</option>
                <option value="Package" @if($HotelTax->tax_level == 'Package') selected="selected" @endif >Package Taxes</option>
                <option value="Rate"  @if($HotelTax->tax_level == 'Rate') selected="selected" @endif >Rate Taxes</option>
                <option value="Room"  @if($HotelTax->tax_level == 'Room') selected="selected" @endif >Room Taxes</option>
            </select>
            </select>
            <span id="err_tax_level{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_level')) ? $errors->first('tax_level') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Tax Frequency</label>
            <select class="form-control" name="edit_tax_frequency" id="edit_tax_frequency_{{$HotelTax->id}}" data-error="#err_tax_frequency{{$HotelTax->id}}">
                <option value="">Select Tax Frequency</option>
                <option value="Per Night" @if($HotelTax->tax_frequency == 'Per Night') selected="selected" @endif >Per Night</option>
                <option value="Per Stay"  @if($HotelTax->tax_frequency == 'Per Stay') selected="selected" @endif >Per Stay</option>
            </select>
            <span id="err_tax_frequency{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_frequency')) ? $errors->first('tax_frequency') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Tax Type</label>
            <select class="form-control" name="edit_tax_type" id="edit_tax_type_{{$HotelTax->id}}" data-error="#err_tax_type{{$HotelTax->id}}">
                <option value="">Select Tax Type</option>
                @foreach($CategoryTaxType as $CategoryTaxTypes)
                <option value="{{$CategoryTaxTypes->id}}" @if($HotelTax) @if($HotelTax->tax_type == $CategoryTaxTypes->id) selected="selected" @endif @endif>{{$CategoryTaxTypes->title}}</option>
                @endforeach
            </select>
            <span id="err_tax_type{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_type')) ? $errors->first('tax_type') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Code</label>
            <input type="text" name="edit_tax_code" id="edit_tax_code_{{$HotelTax->id}}" data-error="#err_tax_code{{$HotelTax->id}}" class="form-control" value="@if($HotelTax){{$HotelTax->tax_code}}@endif">
            <span id="err_tax_code{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_code')) ? $errors->first('tax_code') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Name</label>
            <input type="text" name="edit_tax_name" id="edit_tax_name_{{$HotelTax->id}}" data-error="#err_tax_name{{$HotelTax->id}}" class="form-control" value="@if($HotelTax){{$HotelTax->tax_name}}@endif">
            <span id="err_tax_name{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_name')) ? $errors->first('tax_name') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Default Description</label>
            <textarea class="form-control" name="edit_tax_desc" id="edit_tax_desc_{{$HotelTax->id}}" data-error="#err_tax_desc{{$HotelTax->id}}">@if($HotelTax) {{$HotelTax->tax_desc}} @endif</textarea>
            <span id="err_tax_desc{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_desc')) ? $errors->first('tax_desc') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Start Date</label>
            <input type="text" name="edit_start_date" id="edit_start_date_{{$HotelTax->id}}" data-error="#err_start_date{{$HotelTax->id}}" class="form-control datepicker start_date" value="@if($HotelTax) {{ (date('d-m-Y',strtotime($HotelTax->start_date))) }} @endif">
            <span id="err_start_date{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('start_date')) ? $errors->first('start_date') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <input type="text" name="edit_end_date" id="edit_end_date_{{$HotelTax->id}}" data-error="#err_end_date{{$HotelTax->id}}" class="form-control datepicker end_date" value="@if($HotelTax) {{ (date('d-m-Y',strtotime($HotelTax->end_date))) }} @endif">
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <label style="margin-top: 4px;"><input type="checkbox" name="edit_no_end_date" id="edit_no_end_date_{{$HotelTax->id}}" value="Yes" data-error="err_no_end_date" @if($HotelTax) @if($HotelTax->no_end_date=='Yes') checked="checked" @endif @endif class="form-control" >
                        </label> &nbsp;No End Date
                    </div>
                </div>
            </div>
            <span id="err_end_date{{$HotelTax->id}}" style="position: relative;top: -2px;"></span>
            <span class="error">{{ ($errors->has('end_date')) ? $errors->first('end_date') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <input type="text" name="edit_tax" id="edit_tax_{{$HotelTax->id}}" data-error="#err_tax{{$HotelTax->id}}" class="form-control" value="@if($HotelTax) {{$HotelTax->tax}} @endif">
                        <span id="err_tax{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
                        <span class="error">{{ ($errors->has('tax')) ? $errors->first('tax') : ''}}</span>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <select class="form-control" name="edit_tax_type_price" id="edit_tax_type_price_{{$HotelTax->id}}" data-error="err_tax_type_price{{$HotelTax->id}}">
                            <option value="">Select Tax Type</option>
                            <option selected="selected" value="Amount" @if($HotelTax) @if($HotelTax->tax_type_price =='Amount') selected="selected" @endif @endif >Amount</option>
                            <option value="Percentage" @if($HotelTax) @if($HotelTax->tax_type_price == 'Percentage') selected="selected" @endif @endif>Percentage</option>
                        </select>
                    </div>
                </div>
            </div>
            <span id="err_tax_type_price{{$HotelTax->id}}" style="position: relative;top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_type_price')) ? $errors->first('tax_type_price') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Charge Per</label>
            <select class="form-control" name="edit_charge_per" id="edit_charge_per_{{$HotelTax->id}}" data-error="#err_charge_per{{$HotelTax->id}}">
                <option value="">Select Charge Per</option>
                <option selected="selected" value="FlatCharge" @if($HotelTax) @if($HotelTax->charge_per == 'FlatCharge') selected="selected" @endif @endif>Flat Charge</option>
                <option value="PerAdult" @if($HotelTax) @if($HotelTax->charge_per == 'PerAdult') selected="selected" @endif @endif>Per Adult</option>
                <option value="PerChild" @if($HotelTax) @if($HotelTax->charge_per == 'PerChild') selected="selected" @endif @endif>Per Child</option>
                <option value="PerPerson" @if($HotelTax) @if($HotelTax->charge_per == 'PerPerson') selected="selected" @endif @endif>Per Person</option>
            </select>
            <span id="err_charge_per{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('charge_per')) ? $errors->first('charge_per') : ''}}</span>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Calculate from External Rate</label>
            <input type="checkbox" name="edit_cal_ext_rate" id="edit_cal_ext_rate_{{$HotelTax->id}}" data-error="#err_cal_ext_rate{{$HotelTax->id}}" class="form-control" value="True" @if($HotelTax) @if($HotelTax->cal_ext_rate=='True') checked="checked" @endif @endif>
            <span id="err_cal_ext_rate{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('cal_ext_rate')) ? $errors->first('cal_ext_rate') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Is Inclusive</label>
            <input type="checkbox" name="edit_tax_inclusive" id="edit_tax_inclusive_{{$HotelTax->id}}" data-error="#err_tax_inclusive{{$HotelTax->id}}" class="form-control" value="True" data-error="err_no_end_date" @if($HotelTax) @if($HotelTax->tax_inclusive=='True') checked="checked" @endif @endif>
            <span id="err_tax_inclusive{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_inclusive')) ? $errors->first('tax_inclusive') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Calculate from Room Price</label>
            <input type="checkbox" name="edit_cal_room_price" id="edit_cal_room_price_{{$HotelTax->id}}" data-error="#err_cal_room_price{{$HotelTax->id}}" class="form-control" value="True" @if($HotelTax) @if($HotelTax->cal_room_price=='True') checked="checked" @endif @endif>
            <span id="err_cal_room_price{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('cal_room_price')) ? $errors->first('cal_room_price') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Calculate from Package Price</label>
            <input type="checkbox" name="edit_cal_package_price" id="edit_cal_package_price_{{$HotelTax->id}}" data-error="#err_cal_package_price{{$HotelTax->id}}" class="form-control" value="True" data-error="err_cal_package_price" @if($HotelTax) @if($HotelTax->cal_package_price=='True') checked="checked" @endif @endif>
            <span id="err_cal_package_price{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('cal_package_price')) ? $errors->first('cal_package_price') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Apply to Free Nights</label>
            <input type="checkbox" name="edit_apply_free_night" id="edit_apply_free_night_{{$HotelTax->id}}" data-error="#err_apply_free_night{{$HotelTax->id}}" class="form-control" value="True" data-error="err_no_end_date" @if($HotelTax) @if($HotelTax->apply_free_night=='True') checked="checked" @endif @endif>
            <span id="err_apply_free_night{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('apply_free_night')) ? $errors->first('apply_free_night') : ''}}</span>
        </div>
    </div>
...
<div class="" id="grp_sec">
<label>Tax By Price Range</label>
<input type="checkbox" name="edit_tax_by_price_range" id="edit_tax_by_price_range" data-error="#err_tax_by_price_range"  class="form-control" value="Yes" data-error="err_no_end_date" @if($HotelTax) 
@if($HotelTax->tax_by_price_range=='Yes') checked="checked" @endif @endif>
<span id="err_tax_by_price_range" style="position: relative;
top: -2px;"></span>
<span class="error">{{ ($errors->has('tax_by_price_range')) ? $errors->first('tax_by_price_range') : ''}}</span>
</div>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Tax By LOS:</label>
            <input type="checkbox" name="edit_tax_by_los" id="edit_tax_by_los_{{$HotelTax->id}}" data-error="#err_tax_by_los{{$HotelTax->id}}" class="form-control" value="True" data-error="err_no_end_date" @if($HotelTax) @if($HotelTax->tax_by_los=='True') checked="checked" @endif @endif>
            <span id="err_tax_by_los{{$HotelTax->id}}" style="position: relative;
top: -2px;"></span>
            <span class="error">{{ ($errors->has('tax_by_los')) ? $errors->first('tax_by_los') : ''}}</span>
        </div>
    </div>
<div class="col-md-2 offset-10 mtb-15 ">
                <input type="button" name="EditTax" id="{{$HotelTax->id}}" class="btn btn-primary btn-lg updateTax" value="Update Tax">
            </div>
...
<div id="h_image_preview1" class="image_preview">
    @if($Hotels->image_1)
    <img src="{{url('')}}/uploads/hotels/{{$Hotels->image_1}}"> @endif
</div>
...
<div id="h_image_preview2" class="image_preview">
    @if($Hotels->image_2)
    <img src="{{url('')}}/uploads/hotels/{{$Hotels->image_2}}"> @endif
</div>
...
<div id="h_image_preview3" class="image_preview">
    @if($Hotels->image_3)
    <img src="{{url('')}}/uploads/hotels/{{$Hotels->image_3}}"> @endif
</div>
...
<div id="h_image_preview4" class="image_preview">
    @if($Hotels->image_4)
    <img src="{{url('')}}/uploads/hotels/{{$Hotels->image_4}}"> @endif
</div>
...
<div id="h_image_preview5" class="image_preview">
    @if($Hotels->image_5)
    <img src="{{url('')}}/uploads/hotels/{{$Hotels->image_5}}"> @endif
</div>
...
<div id="h_image_preview6" class="image_preview">
    @if($Hotels->image_6)
    <img src="{{url('')}}/uploads/hotels/{{$Hotels->image_6}}"> @endif
</div>
...
<div class="table-responsive">
    ...
    <table class="table table-bordered" id="" width="100%" cellspacing="0">
        ...
        <tbody>
            @if($portalUsers)
            @foreach ($portalUsers as $view_user)
            <tr>
                <td>{{$view_user->f_name}}</td>
                <td>{{$view_user->l_name}}</td>
                <td>{{$view_user->job_title}}</td>                
                 <td>{{$view_user->email_add}}</td>
                 <td>{{ date("d-m-Y", strtotime($view_user->login_created))  }}</td>
                <td>
               <!--  <a href="#edit_model" class="" data-toggle="modal" data-target="#edit_model" onclick="load_model('{{$view_user->ptid}}')"><i class="fa fa-key" aria-hidden="true"></i></a>
                    &nbsp; --> 

@if($view_user->hotelier_cont_id)
                     <a href="javascript:void(0);" class="send_welcome_letter" id='{{$view_user->uid}}' data-toggle="tooltip" data-placement="top" title="Welcome Letter to Partner" ><i class="fa fa-handshake-o" style="font-size: 20px;"></i></a>
                    &nbsp;
 @else
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
@endif

                <a href="javascript:void(0);" class="send_password" id='{{$view_user->ptid}}' data-toggle="tooltip" data-placement="top" title="Send Password to Partner" ><i class="fa fa-envelope" style="font-size: 20px;"></i></a>
                    &nbsp;
               
                    @if($view_user->activated==1)   
                    <a href="javascript:void(0);" class="send_active" data-id="1"  id="{{$view_user->uid}}" data-toggle="tooltip" data-placement="top" title="Inactive"><i class="fa fa-user" style="font-size: 20px;"></i> </a>
                    @elseif($view_user->activated==2) 
                    <a href="javascript:void(0);" class="send_active" data-id="2" id="{{$view_user->uid}}" alt="Active" data-toggle="tooltip" data-placement="top" title="Active"><i class="fa fa-user" style="font-size: 20px;"></i> </a>
                    @else
                    <a href="javascript:void(0);" class="send_active" data-id="1"  id="{{$view_user->uid}}" data-toggle="tooltip" data-placement="top" title="Inactive"><i class="fa fa-user" style="font-size: 20px;"></i> </a>
                    @endif
                
<!-- <a href="#edit_model" class="" data-toggle="modal" data-target="#edit_model" onclick="load_model('{{$view_user->ptid}}')"><i class="fa fa-edit fa-lg"></i></a> --></td>
                </tr>
            @endforeach
            @endif
        </tbody>
...
foreach ($variable as $value) {
    if($value==$Hotels->id){ 
        $ass='Yes';
            ...
            ?>
            <tr>
                <td>{{$crm_user->first_name}}</td>
                <td>{{$crm_user->last_name}}</td>                
                 <td>{{$crm_user->email}}</td>
                 <td>{{$ass}}</td>
                 <td>{{ date("d-m-Y", strtotime($crm_user->login_created))  }}</td>
                <td>              
                <a href="javascript:void(0);" class="assign_portal" data-toggle="tooltip" data-placement="top" title="Assign Portal" alt="Assign Portal" id='{{$crm_user->uid}}' data-id=''><i class="fa fa-user" style="font-size:20px"></i></a>
                    
<!-- <a href="#edit_model" class="" data-toggle="modal" data-target="#edit_model" onclick="load_model('{{$crm_user->uid}}')"><i class="fa fa-edit fa-lg"></i></a> --></td>
                </tr>
            @endforeach
            @endif
        </tbody>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6 col-md-8">
        <input class="form-control" type="text" value="" name="emailId" id="emailId" value="" onkeyup="emailExist(this.value)" autocomplete="off"/>
                    <span id="email_error" class="error">{{ ($errors->has('email')) ? $errors->first('email') : ''}}</span>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6 col-md-8">
        <input class="form-control" type="password" autocomplete="off" value="" name="cpassword" id="cpassword" />
                    <span id="cpassword_error" class="error">{{ ($errors->has('password')) ? $errors->first('password') : ''}}</span>
      </div>
    </div>

                    
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <input type="hidden" id="hotel_bid" name="hotel_bid" value="{{request()->route('id')}}">
            <div class="row mt-30 "></div>
            <div class="form-group">
...
<div class=" row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control airport_list15 required" name="syn_default_lang" id="syn_default_lang" data-error="#err_syn_default_lang">                
                ...
                <option value="{{$Lang->id}}" @if($Hotelsynxiscrs) @if($Lang->id==$Hotelsynxiscrs->syn_default_lang) selected="selected" @endif @endif>{{$Lang->name}}
                </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            <label>Option 2 </label>
               <select class="form-control airport_list16 required" name="syn_op2_lang" id="syn_op2_lang" >                
                @foreach($Languages as $Lang)
                <option value="{{$Lang->id}}" @if($Hotelsynxiscrs) @if($Lang->id==$Hotelsynxiscrs->syn_op2_lang) selected="selected" @endif @endif>{{$Lang->name}}
                </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            <label>Option 3</label>         
             <select class="form-control airport_list16 required" name="syn_op3_lang" id="syn_op3_lang" >                
                @foreach($Languages as $Lang)
                <option value="{{$Lang->id}}" @if($Hotelsynxiscrs) @if($Lang->id==$Hotelsynxiscrs->syn_op3_lang) selected="selected" @endif @endif>{{$Lang->name}}
                </option>
                @endforeach
            </select>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Currency</label>  
                ...
                <option value="">Choose</option>
                @foreach($Currencylist as $Currency)
                <option value="{{$Currency->code}}" @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_currency == $Currency->code ) selected="selected" @endif @endif>{{ $Currency->name }}</option>
                @endforeach
                </select>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <option value="">Choose</option>
            @foreach($Zone as $Timez)
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_time_zone == $Timez->zone_id ) selected="selected" @endif @endif value="{{$Timez->zone_id}}">{{ $Timez->zone_name }}</option>
            @endforeach
        </select>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select id="syn_airport" name="syn_airport" class="airport_list airport_list_btn form-control" data-error="#err_syn_airport">
                            <option value="">Choose any one</option>
                            @foreach($Airports as $Airport)
                            <option value="{{$Airport->id}}" @if($Hotelsynxiscrs->syn_airport == $Airport->id) selected="selected" @endif >{{$Airport->name}}</option>
                            @endforeach
                        </select>            
...
<div class=" row">
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            ...
            <br><br>
            <input type="radio" name="syn_via_email" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_via_email=='Yes') checked="checked" @endif @endif> Yes &nbsp;&nbsp;
            <input type="radio" name="syn_via_email" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_via_email=='No') checked="checked" @endif @else checked="checked @endif"> No
    ...
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            <label>Via Fax? </label>
            <br><br>
            <input type="radio" name="syn_via_fax" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_via_fax=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_via_fax" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_via_fax=='No') checked="checked" @endif @endif> No
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <input type="radio" name="syn_channel_1" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_1=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_channel_1" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_1=='No') checked="checked" @endif @endif> No
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <input type="radio" name="syn_channel_2" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_2=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_channel_2" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_2=='No') checked="checked" @endif @endif> No
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <input type="radio" name="syn_channel_3" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_3=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_channel_3" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_3=='No') checked="checked" @endif @endif> No
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <input type="radio" name="syn_channel_4" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_4=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_channel_4" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_4=='No') checked="checked" @endif @endif> No
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <input type="radio" name="syn_channel_5" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_5=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_channel_5" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_5=='No') checked="checked" @endif @endif> No
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <input type="radio" name="syn_channel_6" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_6=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_channel_6" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_channel_6=='No') checked="checked" @endif @endif> No
...
<div class=" row">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            ...
            <option value="Mr" @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_pri_title=='Mr') selected='selected' @endif @endif">Mr</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_pri_title=='Mrs') selected='selected' @endif @endif" >Mrs</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_pri_title=='Ms') selected='selected' @endif @endif" >Ms</option>
            </select>           
            <span id="err_syn_pri_title"></span>
            <span class="error">{{ ($errors->has('syn_pri_title')) ? $errors->first('syn_pri_title') : ''}}</span>
        </div>
    </div>
   <!--  @if($Hotelsynxiscrs){{$Hotelsynxiscrs->syn_pri_name}}@endif -->
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
    ...
    </div><!-- @if($Hotelsynxiscrs){{$Hotelsynxiscrs->syn_pri_email}}@endif -->
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            <label>Email </label>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 mtb-15"><strong>Additional Billing Contact</strong></div>
     <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            ...
            <option value="Mr" @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_add1_title=='Mr') selected='selected' @endif @endif">Mr</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_add1_title=='Mrs') selected='selected' @endif @endif" >Mrs</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_add1_title=='Ms') selected='selected' @endif @endif" >Ms</option>
            </select>            
    ...
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            ...
            <option value="Mr" @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_add2_title=='Mr') selected='selected' @endif @endif">Mr</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_add2_title=='Mrs') selected='selected' @endif @endif" >Mrs</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_add2_title=='Ms') selected='selected' @endif @endif" >Ms</option>
            </select>
    ...
    <div class="col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            ...
            <option value="Mr" @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_tec_title=='Mr') selected='selected' @endif @endif">Mr</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_tec_title=='Mrs') selected='selected' @endif @endif" >Mrs</option>
            <option @if($Hotelsynxiscrs) @if($Hotelsynxiscrs->syn_tec_title=='Ms') selected='selected' @endif @endif" >Ms</option>
            </select>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <br><br>
            <input type="radio" name="syn_already_rep" value="Yes" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_already_rep=='Yes') checked="checked" @endif @endif > Yes &nbsp;&nbsp;
            <input type="radio" name="syn_already_rep" value="No" @if($Hotelsynxiscrs)@if($Hotelsynxiscrs->syn_already_rep=='No') checked="checked" @endif @endif> No
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="pms_type" value="@if($Hotelsynxiscrs) {{$Hotelsynxiscrs->pms_type}} @endif ">
...
<div class="col-sm-12 col-md-12 col-lg-12 panel" >
  ...
  <form id="" action="{{ url('hotelier/exportcharts1') }}/xlsx" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
     ...
     <div class="col-lg-12 col-sm-12 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="row">
                                <div class="form-group">
                                    <label>Room starting rate from <input type="text" name="starting_price" id="starting_price" value="{{$Hotels->price}}" class="form-control" placeholder="$ 00.00"></label>
                                </div>
                            </div>
                        </div>
...
var host="{{ url('hotelier/emailExist') }}";  
    $.ajax({
        type: 'POST',
...
function portaluser(){
    ...
    var host="{{ url('hotelier/added-hotel-portal-contact') }}";   
    $.ajax({
        type: 'POST',
...
function portalupdateuser(){
    ...
    var host="{{ url('hotelier/updated-hotel-portal-contact') }}";   
    $.ajax({
        type: 'POST',
...
function send_password(){
    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
    var id=$(this).attr('id');
    var host="{{ url('hotelier/UserPasswordSend') }}";  
    $.ajax({
        type: 'POST',
...
function send_welcome_letter(){
    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
    var id=$(this).attr('id');
    var host="{{ url('hotelier/UserWelcomeLetterSend') }}";  
    $.ajax({
        type: 'POST',
        data:{'id':id, '_token':CSRF_TOKEN},
        url: host,
...
function send_active(){
    ...
    var host="{{ url('hotelier/UserActive') }}";  
    $.ajax({
        type: 'POST',
...
function send_active(){
    ...
    var id=$(this).attr('id');
    var hotel_id=$("#hotel_mid").val();
    var host="{{ url('hotelier/CrmUserAssignPortal') }}";  
    $.ajax({
        type: 'POST',
...
var host = "{{ url('hotelier/hotel/update-tax') }}";
...
var rhost = "{{ url('hotelier/hotel/update-rate') }}";
  ...
  <script type="text/javascript">
    ...
    $("#from_date,#to_date,#task_type,#user_id,#region_id").change(function () {
       ...
       var to_date = to_date2[2] + '-' + to_date2[1] + '-' + to_date2[0];
        ...
        var host="{{ url('hotelier/getchart/') }}"; 
...
var urlData = "{{url('hotelier/salesUpdated')}}";
