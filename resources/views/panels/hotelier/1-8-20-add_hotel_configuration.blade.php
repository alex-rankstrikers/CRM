...
<div class="tab-pane" id="tab08">
    ...
    <div class="col-lg-6 col-md-7 offset-3" style="margin-top: 5%;" > 
     ...
     <div class="form-group row">
      ...
      <div class="col-sm-6 col-md-8">
       <input class="form-control" type="text" value="" name="ufirstname" id="firstname" value="" autocomplete="off"/>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6 col-md-8">
        <input class="form-control" type="text" value="" name="ulastname" id="lastname" value="" autocomplete="off"/>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6 col-md-8">
        <input class="form-control" type="text" value="" name="uemail" id="email" value="" autocomplete="off"/>
                    <span class="error">{{ ($errors->has('email')) ? $errors->first('email') : ''}}</span>
      </div>
    </div>
...
// if(uploadFile.files[0]!='' && uploadFile.files[0]!='undefined' ){
// var uploadFile=uploadFile.files[0];
// }else{
// var uploadFile='';
// }
// if(uploadFile1.files[0]!='' && uploadFile1.files[0]!='undefined' ){
// var uploadFile1=uploadFile1.files[0];
// }else{
// var uploadFile1='';
// }

// if(uploadFile2.files[0]!='' && uploadFile2.files[0]!='undefined' ){
// var uploadFile2=uploadFile2.files[0];
// }else{
// var uploadFile2='';
// }

// if(uploadFile3.files[0]!='' && uploadFile3.files[0]!='undefined' ){
// var uploadFile3=uploadFile3.files[0];
// }else{
// var uploadFile3='';
// }
var uploadFile=uploadFile.files[0];
...
var myFormData = new FormData();
myFormData.append('uploadFile', uploadFile);
myFormData.append('uploadFile1', uploadFile1);
myFormData.append('uploadFile2', uploadFile2);
myFormData.append('uploadFile3', uploadFile3);
myFormData.append('_token', CSRF_TOKEN);
myFormData.append('id', id);
myFormData.append('active', add_active);
myFormData.append('room_code', add_room_code);
