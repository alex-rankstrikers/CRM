...
<form id="commentForm" action="{{url('hotelier/hotels/portadded')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
...
<div class="card-body">
<h4 class="card-title">Add Partner Hotels</h4>
<div class="row mt-30 "></div>
...
<input type="hidden" name="hotel_mid" id="hotel_mid" value="">
...
<a href="{{ url('hotelier/export-hotel-info') }}/xlsx/" class="btn btn-outline-inverse-info btn-lg">Export Hotel Information</a>
</div> -->
...
<div class="form-group">
    ...
    <select class="form-control js-example-basic-multiple w-100" name="grp_name" id="grp_name" data-error="#err_grp_name" style="width: 100%">
        ...
        @foreach($HotelGroup as $Hotel_Group)
        <option value="{{$Hotel_Group->id}}" >{{$Hotel_Group->title}}
        </option>
        @endforeach
        </select>
...
<div class="form-group">
    ...
    <input name="hotel_name" id="hotel_name" type="text" class="form-control" data-error="#err_hotel_name" value="">
...
<div class="form-group">
    ...
    <input name="hotel_id" id="hotel_id" type="text" class="form-control" data-error="#err_hotel_id" value="">
...
<div class="form-group">
    ...
    <input name="hotel_code" id="hotel_code" type="text" class="form-control" data-error="#err_hotel_code" value="">
...
<div class="form-group">
    ...
    <input name="pms_code" id="pms_code" type="text" class="form-control" data-error="#err_pms_code" value="">
...
<div class="form-group">
    ...
    <input name="hotel_short_name" id="hotel_short_name" type="text" class="form-control" data-error="#err_hotel_short_name" value="">
...
<div class="form-group">
    <label>
        Address 1 </label>
    <input name="address_1" id="address_1" type="text" class="form-control" data-error="#err_address_1" value="">
...
<div class="form-group">
    ...
    <input name="address_2" id="address_2" type="text" class="form-control" data-error="#err_address_2" value="">
...
<div class="form-group">
    ...
    <input name="address_3" id="address_3" type="text" class="form-control" data-error="#err_address_3" value="">
...
<div class="form-group">
    ...
    <select class="form-control airport_list10 required" name="country" id="country" data-error="#err_country">
        ...
        <option value="{{$cntry->id}}">{{$cntry->name}}
        </option>
        @endforeach
    </select>
    <!-- <input name="country" id="country" type="text" class="form-control" data-error="#err_country" value=""> -->
...
<div class="form-group">
    ...
    <input name="zip_code" id="zip_code" type="text" class="form-control" data-error="#err_zip_code" value="">
...
<div class="form-group">
    ...
    <input name="latitude" id="latitude" type="text" class="form-control" data-error="#err_latitude" value="">
...
<div class="form-group">
    ...
    <input name="longitude" id="longitude" type="text" class="form-control" data-error="#err_longitude" value="">
    <span id=""></span>
...
<div class="form-group">
    ...
    <input name="main_phone" id="main_phone" type="text" class="form-control" data-error="#err_main_phone" value="">
...
<div class="form-group">
    ...
    <input name="second_phone" id="second_phone" type="text" class="form-control" data-error="#err_second_phone" value="">
...
<div class="form-group">
    <label>Fax </label>
    <input name="fax" id="fax" type="text" class="form-control" data-error="#err_fax" value="">
...
<div class="form-group">
    <label>Email </label>
    <input name="email_hl" id="email_hl" type="text" class="form-control" data-error="#err_email" value="">
...
<div class="form-group">
    ...
    <input name="url" id="url" type="text" class="form-control" data-error="#err_url" value="">
...
<div class="form-group">
    ...
    <input name="r_d_email" id="r_d_email" type="text" class="form-control" data-error="#err_r_d_email" value="">
...
<div class="form-group">
    ...
    <input name="reservation_email" id="reservation_email" type="text" class="form-control" data-error="#err_reservation_email" value="">
...
<div class="form-group">
    ...
    <textarea name="cc_retrieval" id="cc_retrieval" type="text" class="form-control" data-error="#err_cc_retrieval"></textarea>
...
<div class="form-group">
    ...
    <textarea name="inventory_notification" class="form-control" data-error="#err_inventory_notification"></textarea>
...
<div class="form-group">
    ...
    <input type="text" name="f_name" class="form-control" data-error="err_f_name" value="">
...
<div class="form-group">
    ...
    <input type="text" name="l_name" id="l_name" class="form-control" data-error="err_l_name" value="">
...
<div class="form-group">
    ...
    <input type="text" id="job_title" name="job_title" class="form-control" data-error="err_job_title" value="">
...
<div class="form-group">
    ...
    <input type="email" name="email_add" class="form-control" id="email_add" data-error="email_add" value="">
...
<div class="form-group">
    ...
    <input type="number" id="c_number" name="c_number" class="form-control" data-error="err_c_number" value="" min="1">
...
<div class="form-group">
    ...
    <input type="number" name="m_number" class="form-control" id="m_number" data-error="err_m_number" value="" min="1">
...
<div class="form-group">
    ...
    <select class="form-control" data-error="err_cotact_purpose" name="cotact_purpose" id="cotact_purpose">
        ...
        <option value="All Sales Contact">All Sales Contact</option>
        <option value="MICE Contacts">MICE Contacts</option>
        <option value="Corporate Contact">Corporate Contact</option>
        <option value="Leisure Contact">Leisure Contact</option>
        <option></option>
    </select>
    ...
    <tbody id="airportinfo-form-list">
                        ...
                        <td>
                            <table class="table">
                                <tr>
                                    <td>
                                        <input type="text" id="airport_km{{$total}}" name="airport_km[]" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" id="airport_miles{{$total}}" name="airport_miles[]" class="form-control">
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<div class="form-group">
    ...
    <select class="form-control airport_list6" name="t_zone_country" id="t_zone_country" data-error="#err_t_zone_country">
        <option value="">Choose</option>
        @foreach($country as $cntry)
        <option value="{{$cntry->sortname}}">{{$cntry->name}}
        </option>
        @endforeach
    </select>
...
<div class="form-group">
    ...
    <?php /*<input name="t_zone_location" id="t_zone_location" type="text" class="form-control" data-error="#err_t_zone_location" value="">*/?>
        <br/>
        <select class="form-control airport_list7" name="t_zone_location" id="t_zone_location" data-error="#err_t_zone_location">
            ...
            <option value="{{$Timez->zone_id}}">{{ $Timez->zone_name }}</option>
            @endforeach
        </select>
...
<!-- <div class="col-sm-12 col-md-12 col-lg-12 mtb-15 text-right">
<a href="{{ url('hotelier/export-property-info') }}/xlsx/" class="btn-outline-inverse-info btn btn-lg">Export Property Info</a>
</div> -->
...
<div class="row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control" name="property_type" id="property_type" data-error="#err_property_type">
                ...
                <option value="{{$CategoryPropertyTypes->short_name}}">{{$CategoryPropertyTypes->title}}</option>
                @endforeach
            </select>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control" name="location_type" id="location_type" data-error="err_location_type">
                ...
                <option value="DWT">Downtown</option>
                <option value="HWY">Highway</option>
                <option value="RST">Resort</option>
                <option value="SUB">Suburban</option>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="alert_email" id="alert_email" type="text" class="form-control" data-error="#err_alert_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="property_email" id="property_email" type="text" class="form-control" data-error="#err_property_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="guest_email" id="guest_email" type="text" class="form-control" data-error="#err_guest_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="res_del_email" id="res_del_email" type="text" class="form-control" data-error="#err_res_del_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="res_del_fax" id="res_del_fax" type="text" class="form-control" data-error="#err_res_del_fax" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="price" id="price" type="checkbox" class="form-control" value="true" >
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="area_attractions" id="area_attractions" data-error="#err_area_attractions" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="corporate_locations" id="corporate_locations" data-error="#err_corporate_locations" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="h_loc_desc" id="h_loc_desc" class="form-control" data-error="#err_h_loc_desc"></textarea>
...
<li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"><span>Dinner</span></a></li> 
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="tuesdayhourlist">
                                        <tr id="tuesdayhour0">
                                            <td>
                                                <input type="text" name="res_open_tuesday[]" class="form-control timepicker" value="">
                                                <span id="" style="position: relative;
  top: -2px;"></span>
                                                <span class="error">{{ ($errors->has('res_open_monday')) ? $errors->first('res_open_monday') : ''}}</span>
                                            </td>
  ...
  top: -2px;"></span>
    ...
    <div class="col-sm-12 col-md-5 col-lg-5">
        <div class="form-group">
            <label>Name</label>
            <input type="text" name="dinning" id="dinning" data-error="#err_dinning" class="form-control" value="">
            <span id="err_dinning" class="error"></span>
            <span class="error">{{ ($errors->has('dinning')) ? $errors->first('dinning') : ''}}</span>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label>
                <input type="checkbox" value="true" name="res_breakfast" id="res_breakfast"></label> Breakfast
            <label>
                <input type="checkbox" value="true" name="res_lunch" id="res_lunch"></label> Lunch
            <label>
                <input type="checkbox" value="true" name="res_dinner" id="res_dinner" ></label> Dinner
        </div>
    </div>
    <div class="col-sm-12 col-md-7 col-lg-7">
        <div class="card">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublicmonhourlist">
                                            ...
                                            <tr id="editpublicmonhour">
                                                <td>
                                                    <input type="text" name="public_open_monday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_monday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublictuesdayhourlist">
                                            ...
                                            <tr id="editpublictuesdayhour">
                                                <td>
                                                    <input type="text" name="break_open_tuesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="break_close_tuesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublicwednesdayhourlist">
                                            ...
                                            <tr id="editpublicwednesdayhour">
                                                <td>
                                                    <input type="text" name="break_open_wednesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="break_close_wednesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublicthursdayhourlist">
                                            ...
                                            <tr id="ediypublicthursdayhour">
                                                <td>
                                                    <input type="text" name="break_open_thursday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="break_close_thursday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="publicfridayhourlist">
                                            ...
                                            <tr id="editpublicfridayhour">
                                                <td>
                                                    <input type="text" name="break_open_friday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="break_close_friday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="publicsaturdayhourlist">
                                            ...
                                            <tr id="editpublicsaturdayhour">
                                                <td>
                                                    <input type="text" name="break_open_saturday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="break_close_saturday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="publicsundayhourlist">
                                            ...
                                            <tr id="editpublicsundayhour">
                                                <td>
                                                    <input type="text" name="break_open_sunday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="break_close_sunday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
  ...
  top: -2px;"></span>
    ...
    <div class="col-md-2 offset-10 ">
       ...
       <input type="button" name="updateRestaurant" id="" class="btn btn-primary btn-lg updateRestaurant" value="Update Restaurant" placeholder="Update Restaurant">
    </div>
...
<li role="presentation"><a href="#guest" aria-controls="guest" role="tab" data-toggle="tab"><span>In House Guest</span></a></li>
  ...
  top: -2px;"></span>
    ...
    <div class="col-sm-12 col-md-5 col-lg-5">
        <div class="form-group">
            <label>Name</label>
            <input name="bar_name" id="bar_name" data-error="#err_bar_name" class="form-control " value="">
        </div>
        <div class="form-group">
            <label>Tick if the bar child friendly</label>
            <input type="checkbox" value="true" name="child_friendly" >
        ...
        <div class="form-group">
            <label>
                <input type="checkbox" name="bar_public" value="true"></label>Public
            <label>
                <input type="checkbox" name="bar_guest" value="true"></label>In House Guest
        </div>
    </div>
    <div class="col-sm-12 col-md-7 col-lg-7">
        <div class="card">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublictuesdayhourlist">
                                            ...
                                            <tr id="editpublictuesdayhour">
                                                <td>
                                                    <input type="text" name="public_open_tuesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_tuesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <button id="cloneeditpublictuesdayhour" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
                                                </td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublicwednesdayhourlist">
                                            ...
                                            <tr id="editpublicwednesdayhour">
                                                <td>
                                                    <input type="text" name="public_open_wednesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_wednesday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <button id="clonepublicwednesdayhour" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
                                                </td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="editpublicthursdayhourlist">
                                            ...
                                            <tr id="ediypublicthursdayhour">
                                                <td>
                                                    <input type="text" name="public_open_thursday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_thursday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <button id="clonethursdaypublicthursdayhour" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
                                                </td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="publicfridayhourlist">
                                            ...
                                            <tr id="editpublicfridayhour">
                                                <td>
                                                    <input type="text" name="public_open_friday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_friday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <button id="clonethursdaypublicfridayhour" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
                                                </td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="publicsaturdayhourlist">
                                            ...
                                            <tr id="editpublicsaturdayhour">
                                                <td>
                                                    <input type="text" name="public_open_saturday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_saturday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <button id="clonethursdaypublicsaturdayhour" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
                                                </td>
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-8">
                                <div class="form-group">
                                    <table class="table borderless" id="publicsundayhourlist">
                                            ...
                                            <tr id="editpublicsundayhour">
                                                <td>
                                                    <input type="text" name="public_open_sunday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="public_close_sunday[]" class="form-control timepicker" value="">
                                                </td>
                                                <td>
                                                    <button id="clonethursdaypublicsundayhour" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="fa fa-plus"></i></button>
                                                </td>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="off_site_entertainment" id="off_site_entertainment" data-error="#err_off_site_entertainment" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="off_site_restaurants" id="off_site_restaurants" data-error="#err_off_site_restaurants" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="on_site_entertainment" id="on_site_entertainment" data-error="#err_on_site_entertainment" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="special_events" id="special_events" data-error="#err_special_events" class="form-control"></textarea>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="weddings" id="weddings" data-error="#err_weddings" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="alternate_hotels" id="alternate_hotels" data-error="#err_alternate_hotels" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>AWARDS</label>
            <textarea name="awards" id="awards" data-error="#awards" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="frequent_guest_information" id="frequent_guest_information" data-error="#err_special_events" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="gds_data" id="gds_data" data-error="#err_gds_data" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="handicap_facilities" id="handicap_facilities" data-error="#err_handicap_facilities" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="key_selling_points" id="key_selling_points" data-error="#err_key_selling_points" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="miscellaneous" id="miscellaneous" data-error="#err_miscellaneous" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Safety</label>
            <textarea name="safety" id="safety" data-error="#err_safety" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="tour_operators" id="tour_operators" data-error="#err_tour_operators" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="travel_agent_commission" id="travel_agent_commission" data-error="#err_travel_agent_commission" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Chef</label>
            <textarea name="chef" id="chef" data-error="#err_chef" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="director_of_sales_and_management" id="director_of_sales_and_management" data-error="#err_director_of_sales_and_management" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="fb_director" id="fb_director" data-error="#err_fb_director" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="general_manager" id="general_manager" data-error="#err_general_manager" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="managing_director" id="managing_director" data-error="#err_managing_director" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="reservations_manager" id="reservations_manager" data-error="#err_reservations_manager" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="rooms_division" id="rooms_division" data-error="#err_rooms_division" class="form-control"></textarea>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="cancellation_policy" id="cancellation_policy" data-error="#err_cancellation_policy" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="extended_stay_policy" id="extended_stay_policy" data-error="#err_extended_stay_policy" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="extra_charge_policy" id="extra_charge_policy" data-error="#err_extra_charge_policy" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="family_plan_policy" id="family_plan_policy" class="form-control" data-error="#err_family_plan_policy"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="general_policy" id="general_policy" data-error="#err_general_policy" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="group_policy" id="group_policy" data-error="err_group_policy" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="guarantee_policy" id="guarantee_policy" class="form-control" data-error="#err_guarantee_policy"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="pet_policy" id="pet_policy" class="form-control" data-error="#err_pet_policy"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Taxes</label>
            <textarea name="taxs_policy" id="taxs_policy" class="form-control" data-error="#err_taxs_policy"></textarea>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="check_in_hour" id="check_in_hour" value="" class="form-control">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="check_in_minute" id="check_in_minute" value="" class="form-control" data-error="#err_check_in_minute">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="check_out_hour" id="check_out_hour" value="" class="form-control" data-error="#err_check_out_hour">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="check_out_minute" id="check_out_minute" value="" class="form-control" data-error="#err_check_out_minute">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="extra_person_fee" id="extra_person_fee" value="" class="form-control" data-error="#err_extra_person_fee">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="extra_child_fee" id="extra_child_fee" value="" class="form-control" data-error="#err_extra_child_fee">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="crib_charge" id="crib_charge" value="" class="form-control" data-error="#err_crib_charge">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="checkbox" value="true" name="adults_only_hotel_no_kids_allowed" class="form-control">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="checkbox" value="true" name="kids_stay_free" class="form-control">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="early_checkout" id="early_checkout" data-error="err_early_checkout" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="late_checkout" id="late_checkout" data-error="err_late_checkout" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Pet Policy</label>
            <textarea name="pet_policy" id="pet_policy" data-error="err_pet_policy" class="form-control"></textarea>
            <span id="err_pet_policy"></span>
            <span class="error">{{ ($errors->has('pet_policy')) ? $errors->first('pet_policy') : ''}}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="checkbox" value="TRUE" name="pets_allowed" class="form-control">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="checkbox" value="TRUE" name="Pets_free" class="form-control">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="family_policy" id="family_policy" data-error="err_family_policy" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="commission_policy" id="commission_policy" class="form-control" data-error="#err_commission_policy"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="commission_percentage" id="commission_percentage" value="" class="form-control" data-error="#err_commission_percentage">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="deposit_policy" id="deposit_policy" class="form-control" data-error="#err_deposit_policy"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="cancellation_policy" id="cancellation_policy" class="form-control" data-error="#err_cancellation_policy"></textarea>
            <span id="err_taxs_policy"></span>
            <span class="error">{{ ($errors->has('cancellation_policy')) ? $errors->first('cancellation_policy') : ''}}</span>
        </div>
    </div>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="property_check_in_out_desc" id="property_check_in_out_desc" class="form-control" data-error="#err_property_check_in_out_desc"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="property_description" id="property_description" data-error="err_property_description" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="property_description_typical" id="property_description_typical" data-error="err_property_description_typical" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="property_detail" id="property_detail" class="form-control" data-error="#err_property_detail"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="seasonal_closure" id="seasonal_closure" class="form-control" data-error="#err_seasonal_closure"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="selling_feature_1" id="selling_feature_1" data-error="#err_selling_feature_1" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="selling_feature_2" id="selling_feature_2" data-error="#err_selling_feature_2" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="selling_feature_3" id="selling_feature_3" data-error="#err_selling_feature_3" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="arrival_room_service" id="arrival_room_service" data-error="#err_arrival_room_service" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="business_service" id="business_service" data-error="#err_business_service" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="facilities" id="facilities" data-error="#err_facilities" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="health_club_or_fitness" id="health_club_or_fitness" data-error="#err_health_club_or_fitness" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="local_information" id="local_information" data-error="#err_local_information" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="meeting_facilities" id="meeting_facilities" data-error="#err_meeting_facilities" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="recreation" id="recreation" data-error="#err_recreation" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="room_amenities" id="room_amenities" data-error="#err_room_amenities" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="services" id="services" data-error="#err_services" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="shopping_local_attraction" id="shopping_local_attraction" data-error="#err_shopping_local_attraction" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Spa</label>
            <textarea name="spa" id="spa" data-error="#err_spa" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="directions" id="directions" data-error="#err_directions" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Parking</label>
            <textarea name="parking" id="parking" data-error="#err_parking" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="tourist_information" id="tourist_information" data-error="#err_tourist_information" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="transfer_information" id="transfer_information" data-error="#err_transfer_information" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="transportation" id="transportation" data-error="#err_transportation" class="form-control"></textarea>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="weather_information" id="weather_information" data-error="#err_weather_information" class="form-control"></textarea>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Amadues</label>
            <input type="text" name="amadues" id="amadues" class="form-control" data-error="#err_amadues" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="galileo" id="galileo" data-error="#err_galileo" class="form-control" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Sabre</label>
            <input type="text" name="sabre" id="sabre" data-error="#err_sabre" class="form-control" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="worldspan" id="worldspan" data-error="#err_worldspan" class="form-control" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Lanyon</label>
            <input type="text" name="lanyon" id="lanyon" data-error="#err_lanyon" class="form-control" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Pegasus</label>
            <input type="text" name="pegasus" id="pegasus" data-error="#err_pegasus" class="form-control" value="">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="row" id="gdscodelist">
            ...
            <input type="hidden" name="gds_code_id[]" value="">
            <div class="col-sm-10 col-md-4 col-lg-4" id="gds_code0">
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-lg-8">
                        <div class="form-group">
                            <label>Others</label>
                            <input type="text" name="gdsother[]" id="gdsother" data-error="#err_gdsother" class="form-control" value="">
                        </div>
                    </div>
...
<!-- <div class="col-sm-12 col-md-12 col-lg-12 mtb-15 text-right">
<a href="{{ url('hotelier/export-room-configuration') }}/xlsx/" class="btn-outline-inverse-info btn btn-lg">Export Room Configuration</a>
</div> -->
...
<input type="file" name="uploadFile3" id="uploadFile3" class="form-control">
<!-- <div class="input-group col-xs-12">
<input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
<span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
<!-- <div class="col-sm-12 col-md-12 col-lg-12 mtb-15 text-right">
<a href="{{ url('hotelier/export-tax-config') }}/csv/" class="btn-outline-inverse-info btn btn-lg">Export TAX Configuration</a>
</div> -->
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control" name="tax_type" id="tax_type" data-error="#err_tax_type">
                ...
                <option value="{{$CategoryTaxTypes->id}}">{{$CategoryTaxTypes->title}}</option>
                @endforeach
            </select>
...
top: -2px;"></span>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="start_date" id="start_date" data-error="#err_start_date" class="form-control datepicker" >
            ...
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <input type="text" name="end_date" id="end_date" data-error="#err_end_date" class="form-control datepicker" >
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <input type="checkbox" name="no_end_date" id="no_end_date" value="Yes" data-error="err_no_end_date"class="form-control" >No End Date
                    </div>
                </div>
            </div>
            <span id="" style="position: relative;
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control" name="charge_per" id="charge_per" data-error="#err_charge_per">
                <option selected="selected" value="FlatCharge" >Flat Charge</option>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Short Description</label>
            <textarea name="meet_event_desc" id="meet_event_desc" data-error="#err_meet_event_desc" class="form-control"></textarea>
...
top: -2px;"></span>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="seasonal_rates" id="seasonal_rates" data-error="#err_seasonal_rates" class="form-control" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <input type="checkbox" class="form-control" name="benefits[]" value="{{ $Benefit->id }}" data-error="#err_benefits"/></div>
                    <div class="col-md-11">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <input type="checkbox" name="amenities[]" value="{{ $Amenitie->id }}" class="form-control" data-error="#err_amenities"/> </div>
                    <div class="col-md-11">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <input type="checkbox" name="business[]" value="{{ $Busines->id }}" class="form-control" data-error="#err_business"/> </div>
                    <div class="col-md-11">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <input type="checkbox" name="features[]" value="{{ $VenueFeature->id }}" class="form-control" data-error="#err_features"/> </div>
                    <div class="col-md-11">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <input type="checkbox" name="fooddrink[]" value="{{ $VenueFoodDrink->id }}" class="form-control" data-error="#err_fooddrink"/> </div>
                    <div class="col-md-11">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <input type="checkbox" name="licensing[]" value="{{ $VenueLicensing->id }}" class="form-control" data-error="#err_licensing"/> </div>
                    <div class="col-md-11">
        ...
        <table class="table ">
            ...
            <tbody>
                 <?php $i=0;?>
                    ...
                    <tr>
                        <td>
                            <input type="hidden" name="capacity[]" value="{{ $VenueCapacit->id }}" />
                            <input type="hidden" name="capacity_mid[]" value="" />
                            <input type="hidden" name="capacity_value[]" value="{{ $VenueCapacit->title }}" id="ca_<?php echo $i;?>" />
                            <label>{{ $VenueCapacit->title }}</label>
                        </td>
                        <td>
                            <input type="text" name="total_sq_fit[]" class="" id="tsf_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="room_size[]" class="" id="rs_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="celing_height[]" class="" id="ch_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="class_room[]" class="" id="cr_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="theater_1[]" class="" id="tr1_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="theater_2[]" class="" id="tr2_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="reception[]" class="" id="rep_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="conference[]" class="" id="conf_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="u_shape[]" class="" id="us_<?php echo $i;?>" value="">
                        </td>
                        <td>
                            <input type="text" name="h_shape[]" class="" id="hs_<?php echo $i;?>" value="">
                        </td>
                    </tr>
                    <?php  $i++?>
                    @endforeach
...
<div class="form-group">
    ...
    <input type="file" name="hotel_img_1" id="hotel_img_1" class="form-control">
    <!-- <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
        <span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
<div class="form-group">
    ...
    <input type="file" name="hotel_img_2" id="hotel_img_2" class="form-control">
   <!--  <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
        <span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
<div class="form-group">
    ...
    <input type="file" name="hotel_img_3" id="hotel_img_3" class="form-control">
    <!-- <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
        <span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
<div class="form-group">
    ...
    <input type="file" name="hotel_img_4" id="hotel_img_4" class="form-control">
 <!--    <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
        <span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
<div class="form-group">
    ...
    <input type="file" name="hotel_img_5" id="hotel_img_5" class="form-control">
    <!-- <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
        <span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info" type="button">Upload</button>
...
<div class="form-group">
    ...
    <input type="file" name="hotel_img_6" id="hotel_img_6" class="form-control">
    <!-- <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
        <span class="input-group-append">
<button class="file-upload-browse btn btn-outline-inverse-info " type="button">Upload</button>
...
<div class=" row">
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="chain_name" id="chain_name" type="text" class="form-control" data-error="#err_chain_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="chain_id" id="chain_id" type="text" class="form-control" data-error="#err_chain_id" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_property_name" id="syn_property_name" type="text" class="form-control" data-error="#err_syn_property_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_property_name_all" id="syn_property_name_all" type="text" class="form-control" data-error="#err_syn_property_name_all" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_property_code" id="syn_property_code" type="text" class="form-control" data-error="#err_syn_property_code" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_phy_address1" id="syn_phy_address1" type="text" class="form-control" data-error="#err_syn_phy_address1" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_phy_address2" id="syn_phy_address2" type="text" class="form-control" data-error="#err_syn_phy_address1" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_phy_postcode" id="syn_phy_postcode" type="text" class="form-control" data-error="#err_hotel_short_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_invertry_amt" id="syn_invertry_amt" type="text" class="form-control" data-error="#err_syn_invertry_amt" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Main Phone</label>
            <input name="syn_main_phone" id="syn_main_phone" type="text" class="form-control" data-error="#err_syn_main_phone" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_main_fax" id="syn_main_fax" type="text" class="form-control" data-error="#err_syn_main_fax" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Latitude</label>
            <input name="syn_latitude" id="syn_latitude" type="text" class="form-control" data-error="#err_syn_latitude" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Longitude</label>
            <input name="syn_longitude" id="syn_longitude" type="text" class="form-control" data-error="#err_syn_longitude" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_gen_enq_email" id="syn_gen_enq_email" type="text" class="form-control" data-error="#err_syn_gen_enq_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_web" id="syn_web" type="text" class="form-control" data-error="#err_syn_web" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Default </label>
            <input name="syn_default_lang" id="syn_default_lang" type="text" class="form-control" data-error="#err_syn_default_lang" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_op2_lang" id="syn_op2_lang" type="text" class="form-control" data-error="#err_syn_op2_lang" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_op3_lang" id="syn_op3_lang" type="text" class="form-control" data-error="#err_syn_op3_lang" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_op4_lang" id="syn_op4_lang" type="text" class="form-control" data-error="#err_syn_op4_lang" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_op5_lang" id="syn_op5_lang" type="text" class="form-control" data-error="#err_syn_op5_lang" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_op6_lang" id="syn_op6_lang" type="text" class="form-control" data-error="#err_syn_op6_lang" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_currency" id="syn_currency" type="text" class="form-control" data-error="#err_syn_currency" value="">
            <span id="err_hotel_short_name"></span>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_time_zone" id="syn_time_zone" type="text" class="form-control" data-error="#err_syn_time_zone" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_airport" id="syn_airport" type="text" class="form-control" data-error="#err_syn_airport" value="">
...
<div class=" row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Email address</label>
            <input name="syn_via_email_add" id="syn_via_email_add" type="text" class="form-control" data-error="#err_syn_via_email_add" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_via_fax_no" id="syn_via_fax_no" type="text" class="form-control" data-error="#err_syn_via_fax_no" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <textarea class="form-control" name="syn_channel_desc_1" id="syn_channel_desc_1"></textarea>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <textarea class="form-control" name="syn_channel_desc_2" id="syn_channel_desc_2"></textarea>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <textarea class="form-control" name="syn_channel_desc_3" id="syn_channel_desc_3"></textarea>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <textarea class="form-control" name="syn_channel_desc_4" id="syn_channel_desc_4"></textarea>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <textarea class="form-control" name="syn_channel_desc_5" id="syn_channel_desc_5"></textarea>
        </div>
    </div>
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <textarea class="form-control" name="syn_channel_desc_6" id="syn_channel_desc_6"></textarea>
        </div>
    </div>
</div>
</div>
...
<div class=" row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Name</label>
            <input name="syn_pri_name" id="syn_pri_name" type="text" class="form-control" data-error="#err_syn_pri_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Title</label>
            <input name="syn_pri_title" id="syn_pri_title" type="text" class="form-control" data-error="#err_syn_pri_title" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Phone </label>
            <input name="syn_pri_phone" id="syn_pri_phone" type="text" class="form-control" data-error="#err_syn_pri_phone" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Email </label>
            <input name="syn_pri_email" id="syn_pri_email" type="text" class="form-control" data-error="#err_syn_pri_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Name</label>
            <input name="syn_add1_name" id="syn_add1_name" type="text" class="form-control" data-error="#err_syn_add1_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Title</label>
            <input name="syn_add1_title" id="syn_add1_title" type="text" class="form-control" data-error="#err_syn_add1_title" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Phone </label>
            <input name="syn_add1_phone" id="syn_add1_phone" type="text" class="form-control" data-error="#err_syn_add1_phone" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Email </label>
            <input name="syn_add1_email" id="syn_add1_email" type="text" class="form-control" data-error="#err_syn_add1_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Name</label>
            <input name="syn_add2_name" id="syn_add2_name" type="text" class="form-control" data-error="#err_syn_add2_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Title</label>
            <input name="syn_add2_title" id="syn_add2_title" type="text" class="form-control" data-error="#err_syn_add2_title" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Phone </label>
            <input name="syn_add2_phone" id="syn_add2_phone" type="text" class="form-control" data-error="#err_syn_add2_phone" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Email </label>
            <input name="syn_add2_email" id="syn_add2_email" type="text" class="form-control" data-error="#err_syn_add2_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Name</label>
            <input name="syn_tec_name" id="syn_tec_name" type="text" class="form-control" data-error="#err_syn_tec_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Title</label>
            <input name="syn_tec_title" id="syn_tec_title" type="text" class="form-control" data-error="#err_syn_tec_title" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Phone </label>
            <input name="syn_tec_phone" id="syn_tec_phone" type="text" class="form-control" data-error="#err_syn_tec_phone" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Email </label>
            <input name="syn_tec_email" id="syn_tec_email" type="text" class="form-control" data-error="#err_syn_tec_email" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_gds_comp_name" id="syn_gds_comp_name" type="text" class="form-control" data-error="#err_syn_gds_comp_name" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_chain_code" id="syn_chain_code" type="text" class="form-control" data-error="#err_syn_chain_code" value="> (max 2 alpha characters. Example: UI)
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Sabre: </label>
            <input name="syn_property_code_sabre" id="syn_property_code_sabre" type="text" class="form-control" data-error="#err_syn_property_code_sabre" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="syn_property_code_apollo" id="syn_property_code_apollo" type="text" class="form-control" data-error="#err_syn_property_code_apollo" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Worldspan</label>
            <input name="syn_property_code_worldspan" id="syn_property_code_worldspan" type="text" class="form-control" data-error="#err_syn_property_code_worldspan" value="">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            <label>Amadeus </label>
            <input name="syn_property_code_amadeus" id="syn_property_code_amadeus" type="text" class="form-control" data-error="#err_syn_property_code_amadeus" value="">
...
<div class=" row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <input name="pms_version" id="pms_version" type="text" class="form-control" data-error="#err_pms_version" value="">
...
//alert(myFormData)
var host = "{{ url('hotelier/hotel/add-tax') }}";
$.ajax({
type: 'POST',
data: myFormData,
url: host,
...
$(".resturant-status").html('Hotel restaurant added successfully').removeClass('hidden');
}
...
<script type="text/javascript">
 $( document ).ready(function() {
    var dataSrc = [];
 <?php foreach($HotelGroup as $Hotel_Group) { ?>
 dataSrc.push(<?php //echo $Hotel_Group->title; ?>); 
<?php } ?>
 
 console.log('Dta'+JSON.stringify(dataSrc))
