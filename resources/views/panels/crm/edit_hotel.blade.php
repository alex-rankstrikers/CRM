							...
							@if($hotels)
							 @foreach ($hotels as $hotel)
								...
								<tr>
									...
									<td >
										<a href="{{url('crm/events')}}" data-toggle="tooltip" data-placement="top" title="Calendar"><i class="fa fa-calendar" aria-hidden="true" ></i></a>
										<a data-toggle="tooltip" data-placement="top" title="Add / View Notes" href="#notes_model{{$hotel->hl_id}}" class="" data-target="#notes_model{{$hotel->hl_id}}"  onclick="show_notes('{{$hotel->hl_id}}')"><i class="fa fa-sticky-note-o fa-lg"></i>
										</a>

										<a href="{{url('crm/edit-hotel')}}/{{$hotel->hl_id}}" data-toggle="tooltip" data-placement="top" title="Edit Hotel Leads"><i class="fa fa-edit fa-lg"></i>
										</a>
									</td>
...
<div id="notes_model{{$hotel1->hl_id}}" class="rcbScroll col-sm-3 col-md-3 col-lg-3" style="display: none;margin-top: 35px" role="dialog">
...
<div class="modal-body">
		...
		<div class="row">
			...
			<input type="hidden" id="hotel_id" name="hotel_id" value="{{$hotel1->hl_id}}">
