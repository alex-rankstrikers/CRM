						...
						<div class="panel-body">
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
							  ...
							  <div id="outcome_section" class="row" >
								...
								<div style=""><input type="checkbox" name="oc_recurr_status[]" id="oc_recurr_status_0" value="1" onClick="openwin(this.checked);" >&nbsp;&nbsp;Repeat Task
								...
								<textarea name="hle_next_step[]" id="hle_nextstep_0" class="form-control"></textarea>
					  ...
					  <label style="vertical-align:text-top;"> Applicable To:</label>
						...
						<optgroup label="North America">
							...
							@endif
								...
								<div style=""><input type="checkbox" name="oc_recurr_status[]" id="oc_recurr_status_{{$i}}" value="1" @if($outcomeV['oc_recurr_status']==1) checked @endif onClick="openwin(this.checked);" >&nbsp;&nbsp;Repeat Task
								...
								<select  style="  margin-top: 26px;" aria-label="Repeat frequency" name="oc_recurr_duration[]" id="oc_recurr_duration_{{$i}}" class="form-control required">
...
$('body').ready(function(){
	$("a#clone").click(function () {
			...
			$("#outcome_section"+divlength+" input#hle_nextstep_0").prop('id', 'hle_nextstep_'+divlength);
