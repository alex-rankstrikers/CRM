			 ...
			 <div class="col-lg-8 col-md-8 col-sm-12">
				 <div class="form-group">
				  <label> Select User:</label>
					  ...
					  <option selected value="{{ $users->user_id }}" >{{ $users->first_name }} {{ $users->last_name }}</option>
					  @else
			  ...
			  <div class="col-lg-4 col-md-4 col-sm-12 text-right"> 
			  	<a href="{{url('crm/create')}}" class="btn btn-primary btn-lg" id="addOffer">Add Task</a>
			  </div>
			  </div>
...
events : [
               ...
               //hle_allday_status : '{{ $task->hle_allday_status }}',
					id: '{{ $task->hle_id }}',
                    title : "{{ trim(preg_replace('/\s+/', ' ', $task->hle_title))}}",
                    ...
                    description : "{{ trim(preg_replace('/\s+/', ' ', $task->hle_description))}}",
