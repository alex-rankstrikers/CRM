...
<form accept-charset="UTF-8" action="{{ route('crm.store') }}"  method="post" id="create_task">
          ...
          <div class="card-body">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				 ...
				 @endforeach
				  ...
				  <span><input name="task_for[]" id="task_for_<?php echo $i;?>" type="checkbox" value="{{ $task_for->hl_ms_id }}" onclick="aplbc_contact('{{ $task_for->hl_ms_id }}','{{ $task_for->hl_type }}')" class="task_for">{{ $task_for->hl_service_name }}</input></span>		
				  <?php $i++; ?>
				  @endforeach
				  </div>
