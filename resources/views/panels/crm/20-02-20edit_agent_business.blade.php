                    ...
                    <div class="tab-content" id="tab-contents" style="margin-top:0px;">
                        <div class="tab-pane active" id="tab1">
                            <form id="addAgentForm" action="{{url('crm/agent-updated')}}/{{$Hotelagentcontactbasic->hl_agentcont_id}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
                                <input type="hidden" value="{{$Hotelagentcontactbasic->hl_agentcont_id}}" name="hl_ccb_id"> {{ csrf_field() }}
                                <div class="row">
...
<?php 
$business_type = $Hotelagentcontactbasic->hl_agent_type;
$busi_type = explode(',', $business_type); 
?>
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Agent Type {{$Hotelagentcontactbasic->hl_agent_type}}</label>
                                        <select name="business_type[]" multiple="multiple" id="" class="form-control js-example-basic-multiple w-100" data-error="#err_business_type" style="width: 100%">
                                            <option value="1" <?= (in_array(1, $busi_type))?'selected':'' ?> >Consortia/TMCs</option>
                                            <option value="2" <?= (in_array(2, $busi_type))?'selected':'' ?>>MICE</option>
                                            <option value="3" <?= (in_array(3, $busi_type))?'selected':'' ?>>Leisure</option>
                                            <option value="4" <?= (in_array(4, $busi_type))?'selected':'' ?>>Entertainment</option>
                                            <option value="5" <?= (in_array(5, $busi_type))?'selected':'' ?>>Tour Operators</option>
                                            <option value="6" <?= (in_array(6, $busi_type))?'selected':'' ?>>Wholesalers</option>
                                        </select>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <select name="m_con_contact_designation" id="m_con_contact_designation" type="text" class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_m_con_contact_designation">
                                            <option value="">Choose</option>
                                            @foreach($Contactdesignation as $ConDes)
                                            <option value="{{$ConDes->hl_cd_id}}" @if($Hotelagentcontactbasic->m_con_contact_designation==$ConDes->hl_cd_id) selected="selected" @endif>{{$ConDes->hl_title}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6  form-group">
                                        <label>Title </label>
                                        <select name="m_con_title" id="m_con_title" type="text" class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_m_con_title">
                                            <option value="">Choose Title</option>
                                            <option value="Mr" @if($Hotelagentcontactbasic->m_con_title=='Mr') selected="selected" @endif >Mr</option>
                                            <option value="Mrs" @if($Hotelagentcontactbasic->m_con_title=='Mrs') selected="selected" @endif>Mrs</option>
                                            <option value="Ms" @if($Hotelagentcontactbasic->m_con_title=='Ms') selected="selected" @endif>Ms</option>
                                        </select>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <input name="m_con_first_name" id="m_con_first_name" type="text" class="form-control " value="{{ $Hotelagentcontactbasic->m_con_first_name }}" data-error="#err_m_con_first_name">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <input name="m_con_last_name" id="m_con_last_name" type="text" class="form-control" data-error="#err_m_con_last_name" value="{{ $Hotelagentcontactbasic->m_con_last_name }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <input name="m_con_mobile_no" id="m_con_mobile_no" type="text" class="form-control " data-error="#err_m_con_mobile_no" value="{{ $Hotelagentcontactbasic->m_con_mobile_no }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <input name="m_con_landline_no" id="m_con_landline_no" type="text" class="form-control" data-error="#err_m_con_landline_no" value="{{ $Hotelagentcontactbasic->m_con_landline_no }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Email </label>
                                        <input name="m_con_email" id="m_con_email" type="text" class="form-control " data-error="#err_m_con_email" value="{{ $Hotelagentcontactbasic->m_con_email }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <input name="m_con_linkedin_contact" id="m_con_linkedin_contact" type="text" class="form-control " data-error="#err_m_con_linkedin_contact" value="{{ $Hotelagentcontactbasic->	m_con_linkedin_contact }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Skype </label>
                                        <input name="m_con_skype_contact" id="m_con_skype_contact" type="text" class="form-control " data-error="#err_m_con_skype_contact" value="{{ $Hotelagentcontactbasic->m_con_skype_contact }}">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        ...
                                        <input name="m_con_dob" id="m_con_dob" type="date" class="form-control " data-error="#m_con_dob" value="{{ $Hotelagentcontactbasic->m_con_dob }}">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="row"> 
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 ">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6" style="margin-top: 5px;"><input type="file" name="agent_off_location_file" class="form-control"></div>
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <div class="col-sm-6 col-md-6 col-lg-6 "><input type="submit" name="agent_Off" value="Import Agent Office Location" class="btn btn-outline-inverse-info"></div>
                                ...
                                <div id="contactnew_section">
                                    <div class="col-lg-12 cform row" id="corporate_contactnew_form0">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                            <div style="">
                                                <label>Title </label>
                                                <select name="title[]" id="title" type="text" class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_title">
                                                    <option value="">Choose Title</option>
                            ...
                            <table class="table table-bordered dataTable" id="agent_contact">
                                ...
                                <?php $k=1;?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" id="{{$hlagentscontact->hl_corcont_id}}" class="editAgentcont"><i class="fa fa-edit fa-lg"></i></a>
&nbsp;&nbsp;

@if($hlagentscontact->contacts_id !='')
<a href="#" data-id="{{$hlagentscontact->contacts_id}}" class="deleteAgentcont"><i class="fa fa-trash fa-lg" style="color: red;"></i></a>  
@else
<!-- <a href="#" data-id="{{$hlagentscontact->hl_regl_id}}" class="deleteAgentcont"><i class="fa fa-trash fa-lg" style="color: red;"></i></a> -->  
@endif
                         ...
                         <div class="cform row" id="contact_add_form0">                     
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                     ...
                                     <span id="err_cities1" style="position:relative;top: -2px;"></span>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Postcode </label><input type="text" class="form-control required" name="postcode1" id="edit_postcode1"  data-error="#err_postcode1" >
                                        <span id="err_postcode1" style="position:relative;top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('postcode1')) ? $errors->first('postcode1') : ''}}</span>
                                        </div>
                         ...
                         <div class="cform row" id="edit_contactnew_form0">
                            ...
                            <h3>Agent Contact</h3>
                             ...
                             <input type="hidden"  name="agtcont_cid[]" id="agtcont_cid" value="">
                                        ...
                                        <select name="contact_designation[]" id="edit_contact_designation" type="text" class="form-control js-example-basic-single w-100" style="width: 100%" data-error="#err_contact_designation">
                                        <option value="">Choose</option>
                                        @foreach($Contactdesignation as $ConDes)
                                        <option value="{{$ConDes->hl_cd_id}}">{{$ConDes->hl_title}}</option>
                                        @endforeach
...
<select name="title[]" id="edit_title" type="text" class="form-control js-example-basic-single w-100" style="width: 100%" data-error="#err_title"><option value="">Choose Title</option><option value="Mr">Mr</option><option value="Mrs">Mrs</option><option value="Mrs">Ms</option></select>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>First Name </label><input name="first_name[]" id="edit_first_name" type="text" class="form-control required" data-error="#err_first_name" >
                                        <span id="err_first_name" style="position: relative;top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('first_name')) ? $errors->first('first_name') : ''}}</span>
                                        </div>
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Last Name </label><input name="last_name[]" id="edit_last_name" type="text" class="form-control required" data-error="#err_last_name" >
                                        <span id="err_last_name" style="position: relative;    top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('last_name')) ? $errors->first('last_name') : ''}}</span>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="mobile_no[]" id="edit_mobile_no" type="text" class="form-control required" data-error="#err_mobile_no" >
                                        <span id="err_mobile_no" style="position: relative;
                                        top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('mobile_no')) ? $errors->first('mobile_no') : ''}}</span>
                                        </div>
                                        
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email </label><input name="email[]" id="edit_email" type="text" class="form-control required" data-error="#err_email" >
                                        <span id="err_email" style="position: relative;    top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('email')) ? $errors->first('email') : ''}}</span>
                                        </div>
                                        
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>LinkedIn Contact </label><input name="linkedin_contact[]" id="edit_linkedin_contact" type="text" class="form-control required" data-error="#err_linkedin_contact" >
                                        <span id="err_linkedin_contact" style="position: relative;top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('linkedin_contact')) ? $errors->first('linkedin_contact') : ''}}</span>
                                        </div>
                                        
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Skype Contact </label><input name="skype_contact[]" id="edit_skype_contact" type="text" class="form-control required" data-error="#err_skype_contact" >
                                        <span id="err_skype_contact" style="position: relative;top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('skype_contact')) ? $errors->first('skype_contact') : ''}}</span>
                                        </div>
                                        
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Date of Birth </label><input name="dob[]" id="edit_dob" type="date" class="form-control required" data-error="#dob" >
                                        <span id="err_dob" style="position: relative;top: -2px;"></span>
                                        <span class="error">{{ ($errors->has('dob')) ? $errors->first('dob') : ''}}</span>
                                        </div>
                                        <div class="col-sm-12 col-md-6 col-lg-6 form-group aligncheck"><span><input type="checkbox" id="edit_event_invite" name="invite[]" class="" value="Yes" >Not Eligible For Event Invite </input></span>
                            ...
                            <div align="right" class="col-sm-12 col-md-12 col-lg-12">
                            <button type="button" id="clone2" class="btn btn-inverse-info btn-icon">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                          </button>
                            </div>
...
<script>
    ...
    $("button#clone2").click(function() {
        ...
        $('#edit_contactnew_form' + divlength).prepend('<div class="col-sm-12 col-md-12 col-lg-12" align="right"><button id=rem' + divlength + ' onclick="removediv1(' + divlength + ')" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="mdi mdi-close text-info"></i>    </button></div>');
