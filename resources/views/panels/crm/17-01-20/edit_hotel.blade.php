							...
							@if($hotels)
							 @foreach ($hotels as $hotel)
								...
								<tr>
									...
									<td >
										<div class="row">								
										<div class="col-md-12 text-left"><a href="#notes_model{{$hotel->hl_id}}" class="" data-target="#notes_model{{$hotel->hl_id}}"  onclick="show_notes('{{$hotel->hl_id}}')"><i class="fa fa-sticky-note-o fa-lg"></i>
										</a></div>
