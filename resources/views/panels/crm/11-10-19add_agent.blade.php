...
@endif 							
    ...
    top: -2px;"></span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Agent Type </label><select name="business_type[]" multiple="multiple" id="business_type" class="form-control required" data-error="#err_business_type" >
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>City </label><select name="cities" id="cities"  class="form-control" >		
										<option value="">
										 ---Choose---
										 </option>
									 </select>									 
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                     ...
                                     <div class="col-sm-12 col-md-6 col-lg-6 form-group ">
                                    <label>Lead Type *</label><select name="lead_type" id="lead_type" class="form-control required" data-error="#err_type" >
									 <option value="">
										 ---Choose---
										 </option>
						...
						<div id="contact_section">
						 <div class="col-lg-12 cform row" id="contact_add_form0">
                                   ...
                                   <!-- 	<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Select Head Office *</label>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>City </label><select name="cities1[]" id="cities1"  class="form-control required" data-error="#err_cities1">		
										<option value="">
										 ---Choose---
										 </option>
									 </select>									 
...
<select multiple="multiple" tabindex="2" name="subsidy_m_off[]" id="subsidy_m_off" class="form-control required" data-error="#err_type" >
