	...
	<div class="row">
		<div class="col-sm-12 grid-margin d-flex stretch-card">
          ...
          <button class="tablinks" onclick="openCity(event, 'contact_designation')">Contact Designation</button>
				...
				<form id="automationForm" action="{{url('crm/automationupdate')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
				<div class="container">
                    ...
                    <table valign="center" id="task_automation" class="table table-striped">
                      ...
                      <tbody>
						...
						<tr>
						  ...
						  <td valign="center"><select multiple = "multiple"  onChange="postinput({{$i+1}}, this.value)" class="form-control" name="sa[]" id="sa{{ $i+1}}">
						 
						   @include('panels.crm.sa_regional')
						  </select></td>
						  
						  <td valign="center"><select class="form-control" multiple = "multiple" name="na[]" id="na{{ $i+1}}">
						  
						 @include('panels.crm.na_regional')
						  </select></td>
						  <td valign="center"><select class="form-control" multiple = "multiple" name="eur[]" id="eur{{ $i+1}}">
						  
						   @include('panels.crm.eur_regional')
						  </select></td>
						  <td valign="center"><select class="form-control" multiple = "multiple" name="mea[]" id="mea{{ $i+1}}">
						  
						   @include('panels.crm.mea_regional')
						  </select></td>
						  <td valign="center"><select class="form-control" multiple = "multiple" name="apac[]" id="apac{{ $i+1}}">
						  
						  @include('panels.crm.apac_regional')
						  </select></td>
						 <script>
						 $('select#sa'+{{$i+1}}).multiselect(  );
						 $('select#na'+{{$i+1}}).multiselect(  );
						 $('select#eur'+{{$i+1}}).multiselect(  );
						 $('select#mea'+{{$i+1}}).multiselect(  );
						 $('select#apac'+{{$i+1}}).multiselect(  );
						 </script>
                        </tr>
					  @endfor
				...
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				  ...
				  <table id="hoteltable" class="table table-striped" style="width:100%">
					...
					@foreach ($region as $region)
						<tr>
							<td style="text-align: center;"><a href="#edit_region_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_region_model{{$loop->iteration}}">{{$region->hl_regional_name }}</a>
							</td>
							<td style="text-align: center;">
							
							<a href="#edit_region_model{{$loop->iteration}}" class="btn btn-outline-inverse-info btn-xs"   data-toggle="modal" data-target="#edit_region_model{{$loop->iteration}}"><i class="fa fa-pencil"></i> </a>
                            <a href="#delete_region_model{{$loop->iteration}}" class="btn btn-danger btn-xs delete_blog"  data-toggle="modal" data-target="#delete_region_model{{$loop->iteration}}"><i class="fa fa-trash-o"></i>  </a>
							
							<form id="region_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							<div id="edit_region_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<div class="modal-dialog">
							...
							<div class="modal-body">
									<div class="row">
										...
										<input name="region_name" id="region_name_{{$region->hl_ms_r_id}}" value="{{$region->hl_regional_name }}" class="form-control" ></input>
										</div>
							...
							<button type="button" class="btn btn-primary btn-lg editRegion" id="{{$region->hl_ms_r_id}}"  style="width: auto;">Save</button>
							...
							<div id="delete_region_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<form id="region_cForm"accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<button type="button" class="btn btn-primary delregion btn-lg" id="{{$region->hl_ms_r_id}}" style="width: auto;">Delete</button>
...
<div id="contact_designation" class="settingstabcontent col-sm-10 col-md-10 col-lg-10">
				...
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				  ...
				  <table id="hoteltable" class="table table-striped" style="width:100%">
					...
					<tbody>
					@foreach ($Contact_Designation as $ContactDesignation)
						<tr>
							<td style="text-align: left;"><a href="#edit_cont_design_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_cont_design_model{{$loop->iteration}}">{{$ContactDesignation->hl_title }}</a>
							</td>
							<td style="text-align: center;">
							
							<a href="#edit_cont_design_model{{$loop->iteration}}" class="btn btn-outline-inverse-info btn-xs"   data-toggle="modal" data-target="#edit_cont_design_model{{$loop->iteration}}"><i class="fa fa-pencil"></i> </a>
                            <a href="#delete_cont_design_model{{$loop->iteration}}" class="btn btn-danger btn-xs delete_blog"  data-toggle="modal" data-target="#delete_hotel_model{{$loop->iteration}}"><i class="fa fa-trash-o"></i>  </a>
							
							<form id="groub_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							<div id="edit_cont_design_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<div class="modal-dialog">
							...
							<div class="modal-body">
									<div class="row">
										...
										<input name="group_name" id="group_name_{{$ContactDesignation->hl_cd_id}}" value="{{$ContactDesignation->hl_title }}" class="form-control" ></input>
										</div>
							...
							<button type="button" class="btn btn-primary btn-lg editgroupname" id="{{$ContactDesignation->hl_cd_id}}"  style="width: auto;">Save</button>
							<button type="button" class="btn btn-outline-inverse-info btn-lg close_reg" data-dismiss="modal" style="width: auto;">Close</button>
							</div>
							</div>
							...
							<div id="delete_hotel_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<form id="region_cForm"accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<button type="button" class="btn btn-primary delgroupname btn-lg" id="{{$ContactDesignation->hl_cd_id}}" style="width: auto;">Delete</button>
							<button type="button" class="btn btn-outline-inverse-info btn-lg close_del"  data-dismiss="modal" style="width: auto;">Close</button>
							</div>
							</div>
...
<div id="hotel_group" class="settingstabcontent col-sm-10 col-md-10 col-lg-10">
				...
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				  ...
				  <table id="hoteltable" class="table table-striped" style="width:100%">
					...
					<tbody>
					@foreach ($hotel_group as $hotelgroup)
						<tr>
							<td style="text-align: left;"><a href="#edit_hotel_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_region_model{{$loop->iteration}}">{{$hotelgroup->title }}</a>
							</td>
							<td style="text-align: center;">
							
							<a href="#edit_hotel_model{{$loop->iteration}}" class="btn btn-outline-inverse-info btn-xs"   data-toggle="modal" data-target="#edit_hotel_model{{$loop->iteration}}"><i class="fa fa-pencil"></i> </a>
                            <a href="#delete_hotel_model{{$loop->iteration}}" class="btn btn-danger btn-xs delete_blog"  data-toggle="modal" data-target="#delete_hotel_model{{$loop->iteration}}"><i class="fa fa-trash-o"></i>  </a>
							
							<form id="groub_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							<div id="edit_hotel_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<div class="modal-dialog">
							...
							<div class="modal-body">
									<div class="row">
										...
										<input name="group_name" id="group_name_{{$hotelgroup->id}}" value="{{$hotelgroup->title }}" class="form-control" ></input>
										</div>
							...
							<button type="button" class="btn btn-primary btn-lg editgroupname" id="{{$hotelgroup->id}}"  style="width: auto;">Save</button>
							<button type="button" class="btn btn-outline-inverse-info btn-lg close_reg" data-dismiss="modal" style="width: auto;">Close</button>
							</div>
							</div>
							...
							<button type="button" class="btn btn-primary delgroupname btn-lg" id="{{$hotelgroup->id}}" style="width: auto;">Delete</button>
							<button type="button" class="btn btn-outline-inverse-info btn-lg close_del"  data-dismiss="modal" style="width: auto;">Close</button>
							</div>
							</div>
...
<!-- task types start-->
				...
				<tbody>
					@foreach ($master_tasks as $master_tasks)
						<tr>
							<td style="text-align: center;"><a href="#edit_task_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_task_model{{$loop->iteration}}">{{ $master_tasks->task_name }}</a>
							</td>
							<td style="text-align: center;"><a href="#edit_task_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_task_model{{$loop->iteration}}">{{ $master_tasks->task_description }}</a>
							<td style="text-align: center;">
							
							<a href="#edit_task_model{{$loop->iteration}}" class="btn btn-outline-inverse-info btn-lg btn-xs"   data-toggle="modal" data-target="#edit_task_model{{$loop->iteration}}"><i class="fa fa-pencil"></i> </a>
                            <a href="#delete_task_model{{$loop->iteration}}" class="btn btn-danger btn-xs delete_blog"  data-toggle="modal" data-target="#delete_task_model{{$loop->iteration}}"><i class="fa fa-trash-o"></i>  </a>
							
							<form id="task_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							<div id="edit_task_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<div class="modal-dialog">
							...
							<div class="modal-body">
									<div class="row">
										...
										<div class="col-lg-12">
										<input name="task_name" id="task_name_{{$master_tasks->hl_mt_id}}" value="{{$master_tasks->task_name }}" class="form-control" ></input>
										</div>
										<label>&nbsp;&nbsp;&nbsp;&nbsp;Description</label>
										<div class="col-lg-12">
											<textarea name="task_description" id="task_description_{{$master_tasks->hl_mt_id}}" value="" class="form-control"> {{$master_tasks->task_description }}</textarea>
										</div>
									</div>

							</div>
							<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-lg editTask" id="{{$master_tasks->hl_mt_id}}" value="Save" style="width: auto">Save</button>
							...
							<div id="delete_task_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<form id="task_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-lg deltask" style="width: auto;" id="{{$master_tasks->hl_mt_id}}" value="Delete" >Delete</button>
			...
			<div id="outcome" class="settingstabcontent col-sm-10 col-md-10 col-lg-10">
				...
				<tbody>
					@foreach ($master_outcomes as $master_outcomes)
						<tr>
							<td style="text-align: center;"><a href="#edit_oc_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_oc_model{{$loop->iteration}}">{{ $master_outcomes->hl_out_title }}</a>
							</td>
							<td style="text-align: center;"><a href="#edit_oc_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_oc_model{{$loop->iteration}}">{{ $master_outcomes->hl_out_description }}</a>
							</td>
							<td style="text-align: center;">
							
							<a href="#edit_oc_model{{$loop->iteration}}" class="btn btn-outline-inverse-info btn-lg btn-xs"   data-toggle="modal" data-target="#edit_oc_model{{$loop->iteration}}"><i class="fa fa-pencil"></i> </a>
                            <a href="#delete_oc_model{{$loop->iteration}}" class="btn btn-danger btn-xs delete_blog"  data-toggle="modal" data-target="#delete_oc_model{{$loop->iteration}}"><i class="fa fa-trash-o"></i>  </a>
							
							<form id="task_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							<div id="edit_oc_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<div class="modal-dialog">
							...
							<div class="modal-body">
									<div class="row">
										...
										<label>&nbsp;&nbsp;&nbsp;&nbsp;Title</label>
										<div class="col-lg-12">
										<input name="out_title" id="out_title_{{$master_outcomes->hl_out_id}}" value="{{$master_outcomes->hl_out_title }}" class="form-control" ></input>
										</div>
										<label>&nbsp;&nbsp;&nbsp;&nbsp;Description</label>
										<div class="col-lg-12">
											<textarea name="out_description" id="out_description_{{$master_outcomes->hl_out_id}}" value="" class="form-control"> {{$master_outcomes->hl_out_description }}</textarea>
										</div>
							...
							<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-lg editoutcome" style="width: auto;"  id="{{$master_outcomes->hl_out_id}}" value="Save">Save</button>
							...
							<div id="delete_oc_model{{$loop->iteration}}" class="modal fade" role="dialog">
							...
							<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-lg deloc" style="width: auto;"  id="{{$master_outcomes->hl_out_id}}" value="Delete">Delete</button>
	...
	<!--nextstep start-->
			<div id="next_step" class="settingstabcontent col-sm-10 col-md-10 col-lg-10">
				...
				<tbody>
					@foreach ($master_nextstep as $master_nextstep)
						<tr>
							<td style="text-align: center;"><a href="#edit_oc_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_oc_model{{$loop->iteration}}">{{ $master_nextstep->hl_ns_title }}</a>
							</td>
							<td style="text-align: center;"><a href="#edit_oc_model{{$loop->iteration}}" class="btn-model" data-toggle="modal" data-target="#edit_oc_model{{$loop->iteration}}">{{ $master_nextstep->hl_ns_description }}</a>
							</td>
							<td style="text-align: center;">
							
							<a href="#edit_ns_model{{$loop->iteration}}" class="btn btn-outline-inverse-info btn-xs"   data-toggle="modal" data-target="#edit_ns_model{{$loop->iteration}}"><i class="fa fa-pencil"></i> </a>
                            <a href="#delete_ns_model{{$loop->iteration}}" class="btn btn-danger btn-xs delete_blog"  data-toggle="modal" data-target="#delete_ns_model{{$loop->iteration}}"><i class="fa fa-trash-o"></i>  </a>
							
							<form id="task_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							<div id="edit_ns_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<div class="modal-dialog">
							...
							<div class="modal-body">
									<div class="row">
										...
										<label>&nbsp;&nbsp;&nbsp;&nbsp;Title</label>
										<div class="col-lg-12">
										<input name="ns_title" id="ns_title_{{$master_nextstep->hl_ns_id}}" value="{{$master_nextstep->hl_ns_title }}" class="form-control" ></input>
										</div>
										<label>&nbsp;&nbsp;&nbsp;&nbsp;Description</label>
										<div class="col-lg-12">
											<textarea name="ns_description" id="ns_description_{{$master_nextstep->hl_ns_id}}" value="" class="form-control"> {{$master_nextstep->hl_ns_description }}</textarea>
										</div>
							...
							<div class="modal-footer">
							<button type="button" id="{{$master_nextstep->hl_ns_id}}" class="btn btn-primary btn-lg editnextstep" style="width: auto;" value="Save">Save</button>
							...
							<div id="delete_ns_model{{$loop->iteration}}" class="modal fade" role="dialog">
							<form id="outcome_cForm" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
							<input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div class="modal-footer">
							<button type="button" class="btn btn-primary btn-lg delns" id="{{$master_nextstep->hl_ns_id}}" value="Delete" style="width: auto;">Delete</button>
			...
			<div id="email_setting" class="settingstabcontent col-sm-10 col-md-10 col-lg-10">
				...
				<div class="container">
				  ...
				  <p></p>
					...
					<div class="row mt-30 ">
					<div class="col-sm-12 col-md-5 col-lg-5"><div class="form-group"><label>Outlook Email</label><input type="text" class="form-control" name="outlook_email" id="outlook_email" @if($USetting) value="{{$USetting->email}}" @endif autocomplete="off"></div>
...
<span id="err_outlook_password" style="position: relative;
    top: -2px;"></span>
					...
					<div class="col-sm-12 col-md-2 col-lg-2"><div class="form-group"><div style="margin-top: 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><button class="btn btn-primary btn-lg save_email" id="@if($USetting){{ $USetting->id }}@endif">Save</button></div></div>
					</div>
...
<img src="{{ asset('admin-assets/images/outlook-365.webp') }}">
										<h3>Office 365</h3>
										<br />
...
You'll be able to make more sweeping changes to how your integration works (for instance, removing the integration or adding another email account) just by adjusting your settings. It's all up to you. Want to learn more? Visit www.ap-lbc.com/security for more information on our security policies and read the FAQ page about the APLBC Outlook 365 integration.
							...
							<div class="modal-footer">
								<a href="{{ url('crm/outlook-auth') }}" class="btn btn-primary btn-lg" style="width: auto;" > Continue</a>
							...
							<a href="#" class="btn btn-primary btn-lg" id="setting1" onclick="show_usersetting(1)">Add Users</a>	
								...
								<table id="hoteltable" class="table table-striped gap30" style="width:100%">
									...
									<tbody>
										...
										<tr>
										<td style="text-align: center;">{{$user_setting->first_name}} {{$user_setting->last_name}}</td>
										<td style="text-align: center;">{{$user_setting->timezone}}</td>
										<td style="text-align: center;">
										<a href="#" class="btn btn-outline-inverse-info btn-lg btn-xs" onclick="edit_user('{{$user_setting->id}}')"><i class="fa fa-pencil"></i> </a>
			                            <a href="#" class="btn btn-danger btn-xs delete_blog"  onclick="delete_user('{{$user_setting->id}}')"><i class="fa fa-trash-o"></i>  </a>
										</td>
										</tr>
										@endforeach
									</tbody>
...
return false
	...
	var host = "{{ url('crm/ajaxuseremailsettingadd/') }}";	
		$.ajax({
...
function edit_user(val){
			var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
			var uid = val;
			var host = "{{ url('crm/fetchuserdetail/') }}";	
				$.ajax({
...
function delete_user(val){
    ...
    if(confirm("Are you sure you want to delete this?")){
			var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
			var uid = val;
			var host = "{{ url('crm/deleteuserdetail/') }}";	
				$.ajax({
...
$( "#addnextstep" ).click(function() {
			...
			var host = "{{ url('crm/postaddnextstep_ajax/') }}";	
	...
	$( ".editnextstep" ).click(function() {
			...
			//alert(hl_ns_id);
			var host = "{{ url('crm/postupdatenextstep_ajax/') }}";	
			$.ajax({
	...
	$( ".delns" ).click(function() {
			...
			var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
			var hl_ns_id = $(this).attr('id');
			var host = "{{ url('crm/postdeletenextstep_ajax/') }}";	
			$.ajax({
	...
	$( "#addoutcome" ).click(function() {
			...
			var host = "{{ url('crm/postaddoutcome_ajax/') }}";	
			$.ajax({
	...
	$( ".editoutcome" ).click(function() {
			...
			var host = "{{ url('crm/postupdateoutcome_ajax/') }}";	
			$.ajax({
	...
	$( ".deloc" ).click(function() {
			...
			var hl_out_id = $(this).attr('id');
			var host = "{{ url('crm/postdeleteoutcome_ajax/') }}";	
			$.ajax({
	...
	$( "#addregion" ).click(function() {
			...
			var host = "{{ url('crm/postaddregion_ajax/') }}";	
			$.ajax({
	...
	$( ".editRegion" ).click(function() {
			...
			var host = "{{ url('crm/postupdateregion_ajax/') }}";	
			$.ajax({
	...
	$( ".delregion" ).click(function() {
			...
			var hl_ms_r_id = $(this).attr('id');
			var host = "{{ url('crm/postdeleteregion_ajax/') }}";	
			$.ajax({
	...
	$( "#addtask" ).click(function() {
			...
			var host = "{{ url('crm/postaddtask_ajax/') }}";	
			$.ajax({
	...
	$( ".editTask" ).click(function() {
			...
			var host = "{{ url('crm/postupdatetask_ajax/') }}";	
			$.ajax({
	...
	$( ".deltask" ).click(function() {
			...
			var hl_mt_id = $(this).attr('id');
			var host = "{{ url('crm/postdeletetask_ajax/') }}";	
			$.ajax({
