...
@endif 							
          ...
          <div class="card-body">
			...
			<div class="row mt-30 "></div>  
					...
					<div class="tab-content" id="tab-contents" style="margin-top:0px;">
						...
						<form id="commentForm" action="{{url('crm/corporate-updated')}}/{{$HotellMainccontact->hl_ccb_id}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
					    	{{ csrf_field() }}
					    	<input type="hidden" value="{{$HotellMainccontact->hl_ccb_id}}" name="hl_ccb_id" id="hl_ccb_id">
                                <div class="row">
                            
                                    
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
										<label>Business Name </label><input name="business_name" id="business_name" type="text" tabindex="1" class="form-control required" value="{{$HotellMainccontact->hl_business_name}}" data-error="#err_title" >
    ...
    top: -2px;"></span>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
										...
										<option value="{{$master_business->hl_mt_bus_id}}" @if($HotellMainccontact->hl_business_type==$master_business->hl_mt_bus_id) selected="selected" @endif>{{$master_business->hl_business_name}}</option>
										@endforeach
									</select>
                                      ...
                                      <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Head Office Address </label><input tabindex="3" type="text" name="address1" id="address1"  class="form-control required" data-error="#err_address1" value="{{$HotellMainccontact->hl_head_office_address}}"><span id="err_address1" style="position:relative;top: -2px;"></span>
									...
									<option value="{{$coun->id}}" @if($HotellMainccontact->hl_country==$coun->id) selected="selected" @endif >{{$coun->name}}</option>
									...
									@endforeach
									 ...
									 <span class="error">{{ ($errors->has('h_country')) ? $errors->first('h_country') : ''}}</span>
										...
										<option value="">
										 ...
										 @if($HotellMainccontact)
										 @foreach ($editstates as $states)
											@if($HotellMainccontact->hl_country==$states->country_id)
											<option value="{{$states->id}}" @if($HotellMainccontact->	hl_state==$states->id) selected="selected" @endif >{{$states->name}}</option>
											@endif
											@endforeach
											@endif
									 </select>									 
									 ...
									 <div class="col-sm-12 col-md-6 col-lg-6 form-group">
										...
										@if($HotellMainccontact)
										 @foreach ($editcities as $cities)
											@if($HotellMainccontact->hl_state==$cities->state_id)
											<option value="{{$states->id}}"  @if($HotellMainccontact->	hl_city==$cities->id) selected="selected" @endif>{{$cities->name}}</option>
											@endif
											@endforeach
											@endif
									 </select>									 
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Postcode </label><input type="text" tabindex="8" class="form-control required" name="postcode" id="postcode"  data-error="#err_postcode" value="{{$HotellMainccontact->hl_pincode}}">
										...
										<span class="error">{{ ($errors->has('postcode')) ? $errors->first('postcode') : ''}}</span>
										 ...
										 <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                       <label>Landline No </label><input tabindex="4" type="text" name="landline" id="landline1"  class="form-control required mobile" data-error="#err_landline1" value="{{$HotellMainccontact->hl_landline}}"><span id="err_landline1" style="position:relative;top: -2px;"></span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
										<label>Website </label><input type="text" tabindex="9" class="form-control required" name="website" id="website"  data-error="#website" value="{{$HotellMainccontact->hl_website}}">
									...
									@foreach($master_lead_type as $master_l_type)
											<option value="{{$master_l_type->hl_mt_lt_id}}" @if($master_l_type->hl_mt_lt_id==$HotellMainccontact->hl_lead_type) selected="selected" @endif >{{$master_l_type->hl_lead_type_name}}</option>
											@endforeach
									 </select>
										<span id="err_type" style="position: relative;top: -2px;"></span>
                                  ...
                                  <div class="col-sm-12 col-md-6 col-lg-6 form-group">
										...
										<option value="{{$hl_corporate->hl_ccb_id}}_1" @if($editsubsidyType1)
											@foreach($editsubsidyType1 as $subsidy)@if($subsidy->h_subsidy_id==$hl_corporate->hl_ccb_id)  selected="selected" @endif @endforeach @endif>{{$hl_corporate->hl_business_name}}</option>
										@endforeach

									@foreach($hl_agents_contacts_basic as $hl_agents)
									<option value="{{$hl_agents->hl_agentcont_id}}_2" @if($editsubsidyType2)
									@foreach($editsubsidyType2 as $subsidy2)@if($subsidy2->h_subsidy_id==$hl_agents->hl_agentcont_id)  selected="selected"
									@endif @endforeach @endif>{{$hl_agents->hl_business_name}}</option>
									@endforeach
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation </label>
											...
											<option value="{{$ConDes->hl_cd_id}}" @if($HotellMainccontact->m_con_contact_designation==$ConDes->hl_cd_id) selected="selected" @endif>{{$ConDes->hl_title}}</option>
											@endforeach
											</select>
...
<select name="m_con_title" id="m_con_title" type="text" class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_title" ><option value="">Choose Title</option><option value="Mr" @if($HotellMainccontact->m_con_title=="Mr") selected="selected" @endif>Mr</option><option value="Mrs" @if($HotellMainccontact->m_con_title=="Mrs") selected="selected" @endif>Mrs</option><option value="Ms" @if($HotellMainccontact->m_con_title=="Ms") selected="selected" @endif>Ms</option></select>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>First Name </label><input name="m_con_first_name" id="m_con_first_name" type="text" class="form-control " data-error="#err_m_con_first_name" value="{{$HotellMainccontact->m_con_first_name}}">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Last Name </label><input name="m_con_last_name" id="m_con_last_name" type="text" class="form-control" data-error="#err_m_con_last_name" value="{{$HotellMainccontact->m_con_last_name}}">
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="m_con_mobile_no" id="m_con_mobile_no" type="text" class="form-control " data-error="#err_m_con_mobile_no"  value="{{$HotellMainccontact->m_con_mobile_no}}">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Landline Number</label><input name="m_con_landline_no" id="m_con_landline_no" type="text" class="form-control" data-error="#err_m_con_landline_no" value="{{$HotellMainccontact->m_con_landline_no}}">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email </label><input name="m_con_email" id="m_con_email" type="text" class="form-control " data-error="#err_m_con_email" value="{{$HotellMainccontact->m_con_email}}">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>LinkedIn  </label><input name="m_con_linkedin_contact" id="m_con_linkedin_contact" type="text" class="form-control " data-error="#err_m_con_linkedin_contact" value="{{$HotellMainccontact->	m_con_linkedin_contact}}">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Skype </label><input name="m_con_skype_contact" id="m_con_skype_contact" type="text" class="form-control " data-error="#err_m_con_skype_contact" value="{{$HotellMainccontact->m_con_skype_contact}}">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Date of Birth</label><input name="m_con_dob" id="m_con_dob" type="date" class="form-control " data-error="#m_con_dob" value="{{$HotellMainccontact->m_con_dob}}">
					...
					<?php $associ = $HotellMainccontact['associate_with'];$associate = explode(',', $associ);?>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
										...
										<option value="{{$associateC->hl_ccb_id}}_1" @foreach ($associate as $key => $value)
										...
										<option value="{{$associateA->hl_agentcont_id}}_2" @foreach ($associate as $key => $value)
					  ...
					  <div align="right" class="form-group col-sm-6 col-md-6 col-lg-6">
						...
						<div class="tab-pane" id="tab01">
						  <form id="commentForm1" action="{{url('crm/corregional_updated')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
						 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						 <input type="hidden" value="{{$HotellMainccontact->hl_ccb_id}}" name="hl_ccb_id">
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="ic_mobile_no" id="ic_mobile_no" type="text" class="form-control required" data-error="#err_ic_mobile_no" >
							...
							<div class="col-sm-12 col-md-12 col-lg-12 form-group">
								<div style="">
								<label id="off_loc"><b>Select Office Location </b></label>

								<table class="table table-bordered"  width="100%" id="officetable" cellspacing="0">
							...
							<span class="error">{{ ($errors->has('subsidy_ofz2')) ? $errors->first('subsidy_ofz2') : ''}}</span>
								</div>
							</div>
							</div></div>
</div>
...
<div class="col-lg-12 col-md-12 col-sm-12" id="corp_contact_address_form0">
  <div class="row">        
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation </label>
											...
											<select name="contact_designation[]" id="contact_designation" type="text" class="form-control js-example-basic-multiple w-100 contact_designation" style="width: 100%" data-error="#err_contact_designation">
											<option value="">Choose</option>
											@foreach($Contactdesignation as $ConDes)
											<option value="{{$ConDes->hl_cd_id}}">{{$ConDes->hl_title}}</option>
											@endforeach
                                        	...
                                        	<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Title </label>
<select name="title[]" id="title" type="text" class="form-control js-example-basic-multiple w-100 title" style="width: 100%" data-error="#err_title" ><option value="">Choose Title</option><option value="Mr">Mr</option><option value="Mrs">Mrs</option><option value="Ms">Ms</option></select>
                                        		<!-- <input name="title[]" id="title" type="text" class="form-control required" data-error="#err_title" > -->
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="mobile_no[]" id="mobile_no" type="text" class="form-control required" data-error="#err_mobile_no" >
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group aligncheck" style="    margin-top: 22px;">
											<span>
											<input type="checkbox" name="invite[]" id="event_invite" class="" >Not Eligible for event invite </input></span>
...
<!-- table-expandable -->
						...
						<td>{{$Subsidy->fname}}</td>
						<td><a href="#" id="{{$Subsidy->hl_cons_cont_id}}" class="editImplantcont"><i class="fa fa-edit fa-lg"></i></a>										</td>
...
<form id="updateImplantContactForm" action="{{url('crm/update-implant-contact')}}/{{$HotellMainccontact->hl_ccb_id}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
{{ csrf_field() }}
<input type="hidden"  name="implcont_mid" id="implcont_mid" value="">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 row"  id="edit_direct2_implant">
							<div class="row">
								<div class="col-sm-6  col-md-6 col-lg-6">
									...
									<span id="err_subsidy1"  class="jerror"></span>
									<span class="error">{{ ($errors->has('impledit_subsidy1')) ? $errors->first('impledit_subsidy1') : ''}}</span>
									</div>
								</div>
								<div class="col-sm-6  col-md-6 col-lg-6 ">
	...
	<input name="impledit_ic_off_address1" tabindex="1" id="impledit_ic_off_address1" type="text" class="form-control required" data-error="#err_off_address1" >
										<span id="err_ic_off_address1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('impledit_ic_off_address1')) ? $errors->first('impledit_ic_off_address1') : ''}}</span>
									...
									<option value="">Choose Country</option>									
									 ...
									 <span id="err_ic_country1" class="jerror">&nbsp;</span>
									 <span class="error">{{ ($errors->has('impledit_ic_country1')) ? $errors->first('impledit_ic_country1') : ''}}</span>
										</div>
                                     ...
                                     <span id="err_ic_cities1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('impledit_ic_cities1')) ? $errors->first('impledit_ic_cities1') : ''}}</span>
										</div>
                    <div class="col-sm-12 col-md-6 col-lg-6">
					<label>Postcode </label><input type="text" tabindex="5"  class="form-control required" name="impledit_ic_postcode1" id="impledit_ic_postcode1"  data-error="#err_ic_postcode1">
										<span id="err_ic_postcode1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('impledit_ic_postcode1')) ? $errors->first('impledit_ic_postcode1') : ''}}</span>   
                                    </div>
										...
										<span id="err_ic_landline_no1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('impledit_ic_landline_no1')) ? $errors->first('impledit_ic_landline_no1') : ''}}</span>
										</div>
										...
										<span id="err_email1"  class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('impledit_ic_email1')) ? $errors->first('impledit_ic_email1') : ''}}</span>
										</div>
										<input type="hidden" name="implsubsidy_of_hid" id="implsubsidy_of_hid" value="">

										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Subsidy of  </label><select multiple="multiple" tabindex="2" name="implsubsidy_of_edit[]" id="implsubsidy_of_edit" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
...
<input type="hidden"  name="implcont_cid" id="implcont_cid" value="">
	<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation </label>
										...
										<span class="error">{{ ($errors->has('impledit_ic_contact_designation')) ? $errors->first('impledit_ic_contact_designation') : ''}}</span>
										</div>
...
<select name="impledit_ic_title" id="impledit_ic_title" type="text" class="form-control js-example-basic-multiple w-100" style="width: 100%" data-error="#err_ic_title" ><option value="">Choose Title</option><option value="Mr">Mr</option><option value="Mrs">Mrs</option><option value="Ms">Ms</option></select>
										...
										<span class="error">{{ ($errors->has('impledit_ic_first_name')) ? $errors->first('impledit_ic_first_name') : ''}}</span>
										</div>
										...
										<span id="err_ic_last_name" class="jerror"></span>
										<span class="error">{{ ($errors->has('impledit_ic_last_name')) ? $errors->first('impledit_ic_last_name') : ''}}</span>
										</div>
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="impledit_ic_mobile_no" id="impledit_ic_mobile_no" type="text" class="form-control required" data-error="#err_ic_mobile_no" >
										<span id="err_ic_mobile_no" class="jerror"></span>
										<span class="error">{{ ($errors->has('impledit_ic_mobile_no')) ? $errors->first('impledit_ic_mobile_no') : ''}}</span>
										</div>
										...
										<span id="err_ic_clandline_no" class="jerror"></span>
										<span class="error">{{ ($errors->has('impledit_ic_clandline_no')) ? $errors->first('impledit_ic_clandline_no') : ''}}</span>
										</div>
										...
										<span id="err_ic_linkedin_contact" class="jerror"></span>
										<span class="error">{{ ($errors->has('impledit_ic_linkedin_contact')) ? $errors->first('impledit_ic_linkedin_contact') : ''}}</span>
										</div>
										...
										<span id="err_ic_skype_contact" class="jerror"></span>
										<span class="error">{{ ($errors->has('impledit_ic_skype_contact')) ? $errors->first('impledit_ic_skype_contact') : ''}}</span>
										</div>
										...
										<span id="err_ic_dob" class="jerror"></span>
										<span class="error">{{ ($errors->has('impledit_ic_dob')) ? $errors->first('impledit_ic_dob') : ''}}</span>
										</div>
										<input type="hidden" name="implassociate_hid" id="implassociate_hid" value="">
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Associate with <!-- consortia --></label><select multiple="multiple" tabindex="2" name="implassociate_withEdit[]" id="implassociate_withEdit" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
							...
							<div align="right" style="margin-bottom:20px;" class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div align="right" class="col-12">
                                    ...
                                    <input style="width:100px;" type="submit" id="saveform" value="Save" class="btn btn-primary  next-btn" style="">
                                </div>
</form>
</div>
...
<td><a href="#" id="{{$CorporateContacts->hl_regl_id}}" class="editCorpcont"><i class="fa fa-edit fa-lg"></i></a>										</td>
						</tr>						
						<?php $k++;?>
						@endforeach
						@endif
...
<form id="updateCorpContactForm" action="{{url('crm/update-corp-contact')}}/{{$HotellMainccontact->hl_ccb_id}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" method="POST">
{{ csrf_field() }}
<input type="hidden"  name="corpcont_mid" id="corpcont_mid" value="">
    ...
    <div class="row"  id="edti_direct1">
								<div class="col-sm-12 col-md-12 col-lg-12 "><label><strong>Address Details:</strong></label></div>
										...
										<span class="error">{{ ($errors->has('ecorp_address1')) ? $errors->first('ecorp_address1') : ''}}</span>									
										</div>
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Country </label>
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
									<label>Postcode </label>
									<input type="text" tabindex="5"  class="form-control required" name="ecorp_postcode1" id="ecorp_postcode1" value="{{ old('postcode') }}" data-error="#err_ecorp_postcode1">
									<span id="err_postcode1" class="jerror">&nbsp;</span>
									<span class="error">{{ ($errors->has('postcode1')) ? $errors->first('postcode1') : ''}}</span>
								</div>
										...
										<input type="hidden" name="corpsubsidy_hid" id="corpsubsidy_hid">
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Subsidy of </label><select multiple="multiple" tabindex="2" name="corpsubsidy_of[]" id="corpsubsidy_of" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
...
<input type="hidden"  name="corpcont_cid[]" id="corpcont_cid" value="">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation </label>
											...
											<select name="ecorp_contact_designation[]" id="ecorp_contact_designation" type="text" class="form-control js-example-basic-multiple w-100 ecorp_contact_designation" style="width: 100%" data-error="#err_ecorp_contact_designation">
											<option value="">Choose</option>
											@foreach($Contactdesignation as $ConDes)
											<option value="{{$ConDes->hl_cd_id}}">{{$ConDes->hl_title}}</option>
											@endforeach
                                        	...
                                        	<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Title </label>
											<select name="ecorp_title[]" id="ecorp_title" type="text" class="form-control js-example-basic-multiple w-100 ecorp_title" style="width: 100%" data-error="#err_title" >
										...
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('ecorp_landline_no')) ? $errors->first('mobile_no') : ''}}</span>
										</div>
										...
										<span class="error">{{ ($errors->has('ecorp_linkedin_contact')) ? $errors->first('ecorp_linkedin_contact') : ''}}</span>
										</div>
										...
										<span class="error">{{ ($errors->has('ecorp_skype_contact')) ? $errors->first('ecorp_skype_contact') : ''}}</span>
										</div>
										...
										<span class="error">{{ ($errors->has('ecorp_dob')) ? $errors->first('ecorp_dob') : ''}}</span>
										</div>
										<input type="hidden" name="corpassociate_hid" id="corpassociate_hid">

										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Associate with  <!-- new ofz --></label><select multiple="multiple" tabindex="2" name="associate_withE0[]" id="associate_withE0" class="js-example-basic-multiple w-100 associate_withE" data-error="#err_type" style="width: 100%">
                                        @foreach($associate_c as $associateE)
										<option value="{{$associateE->hl_ccb_id}}_1" >{{$associateE->business_name}}</option>
										@endforeach
										@foreach($associate_a as $associateA)
...
$('html, body').animate({
       ...
       $('#impledit_subsidy1').val(hlagentscontacts.hl_agent_m_id).trigger("change");
        ...
        $('#implassociate_hid').val(hlagentscontacts.associate_with);
        $('#implsubsidy_of_hid').val(hlagentscontacts.subsidy_of);

		setTimeout(function () {
			var hlid=$("#implassociate_hid").val();
			var element = document.getElementById('implassociate_withEdit');
			...
			$('select#implassociate_withEdit').val(hlidValue).trigger('change');

			var hls=$("#implsubsidy_of_hid").val();
			var element1 = document.getElementById('implsubsidy_of_edit');
			...
			$('select#implsubsidy_of_edit').val(hlsValue).trigger('change');
...
$('body').animate({
       ...
       // console.log('Data:'+JSON.stringify(res.view_details));
        ...
        $('#ecorp_country1').val(hlagentscontacts.hl_country).trigger("change");
        ...
        $('#ecorp_lead_type1').val(hlagentscontacts.hl_lead_type).trigger("change");
        $('#ecorp_location_type1').val(hlagentscontacts.hl_loc_type).trigger("change");
        $('#ecorp_contact_designation').val(hlagentscontacts.hl_cont_design).trigger("change");
        ...
        $('#corpsubsidy_hid').val(hlagentscontacts.subsidy_of);       
        $('#corpassociate_hid').val(hlagentscontacts.associate_withM);       

	    setTimeout(function () {
		var hlC=$("#corpsubsidy_hid").val();
		var elementC = document.getElementById('corpsubsidy_of');

		for (var i = 0; i < elementC.options.length; i++) {

		    elementC.options[i].selected = hlC.indexOf(elementC.options[i].value) >= 0;
		}
		var hlCValue = hlC.split(',');
		$('select#corpsubsidy_of').val(hlCValue).trigger('change');

		var hlCE=$("#corpassociate_hid").val();
		var elementCE = document.getElementById('associate_withE0');

		for (var i = 0; i < elementCE.options.length; i++) {

		    elementCE.options[i].selected = hlCE.indexOf(elementCE.options[i].value) >= 0;
		}
		var hlCEValue = hlCE.split(',');
		$('select#associate_withE0').val(hlCEValue).trigger('change');
		} , 1000);
...
//alert(id)
	...
	$('#officetable').DataTable().clear().destroy();
	return false;
}
...
$('#officeadd').html('')
       $.each(res.view_details, function(index, data) {
          ...
          if (index==0) {
            $('#officeadd').append('<tr><td width="20px"><input type="checkbox" style="width:20px;" name="subsidy_ofz2[]" class="checkbox" value="'+data.hl_corcont_id+'_'+data.hl_regl_id+'" ></input></td><td >'+data.hl_regional_name+'</td><td >'+data.countries+'</td><td >'+data.hl_loc_type+'</td><td >'+data.hl_ofz_address+'</td><td >'+data.hl_first_name+'</td><td >'+data.hl_last_name+'</td><td >'+data.hl_email+'</td><td>'+data.hl_mob_no+'</td></tr>');
          }else {

            $('#officeadd').append('<tr><td width="20px"><input type="checkbox" style="width:20px;" name="subsidy_ofz2[]" class="checkbox"  value="'+data.hl_corcont_id+'_'+data.hl_regl_id+'" ></input></td><td >'+data.hl_regional_name+'</td><td >'+data.countries+'</td><td >'+data.hl_loc_type+'</td><td >'+data.hl_ofz_address+'</td><td >'+data.hl_first_name+'</td><td >'+data.hl_last_name+'</td><td >'+data.hl_email+'</td><td>'+data.hl_mob_no+'</td></tr>');
          };
        }); 
       $("#off_loc").css("margin-bottom","-20px");
         setTimeout(function(){
...
$("#saveform1").click(function() {
	...
	$("button#clone_corp_edit").click(function () {
			...
			//alert(divlength);
			$(".ecorp_contact_designation").select2("destroy");
			 $(".ecorp_title").select2("destroy");
			 $(".associate_withE").select2("destroy");
			// Clone it and assign the new ID (i.e: from num 4 to ID "klon4")
			var $klon = $div.clone(true);
			$klon.find('input,textarea').val('');
			...
			$('#editcorpcontactaddressform'+divlength ).prepend('<div class="col-sm-12 col-md-12 col-lg-12" align="right"><button id=rem'+divlength+' onclick="removedivE('+divlength+')" type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i class="mdi mdi-close text-info"></i>    </button></div>');
			$("#editcorpcontactaddressform"+divlength+" select#associate_withE0").prop({id:"associate_withE"+divlength, name:"associate_withE"+divlength+'[]'}).append();

			$(".ecorp_contact_designation").select2();
			$(".ecorp_title").select2();
			$(".associate_withE").select2();
			window.intlTelInput(input, {
			allowExtensions: true,
			autoFormat: false,
			autoHideDialCode: false,
