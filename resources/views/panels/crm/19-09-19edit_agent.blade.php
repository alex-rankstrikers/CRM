							...
							@if($cor_view)
							 @foreach ($cor_view as $cor_view)
								...
								<tr>
									...
									<td ><div align="center"><a href="#notes_model{{$cor_view['hl_agentcont_id']}}" class="" data-toggle="modal" data-target="#notes_model{{$cor_view['hl_agentcont_id']}}"><i class="fa fa-edit fa-lg"></i></i>

</a></div>
									<div id="notes_model{{$cor_view['hl_agentcont_id']}}" class="modal fade" role="dialog">
