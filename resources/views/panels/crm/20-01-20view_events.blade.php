...
<a href="#notes_model{{ $reglist->hl_reg_id }}" class="" data-toggle="modal" data-target="#notes_model{{ $reglist->hl_reg_id }}"><i class="fa fa-edit fa-lg"></i></a>
</div>

</div>
<div id="notes_model{{ $reglist->hl_reg_id }}" class="modal right fade" role="dialog">
...
<input type="hidden" id="event_id" name="event_id" value="{{ $reglist->hl_reg_id }}">
