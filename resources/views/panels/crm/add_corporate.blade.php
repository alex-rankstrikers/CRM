...
@endif 							
    ...
    top: -2px;"></span>
									 ...
									 <span class="error">{{ ($errors->has('h_country')) ? $errors->first('h_country') : ''}}</span>
										...
										<option value="">
										 ...
										 @foreach ($editstates as $states)
											@if($Hotellccontact->hl_country==$states->country_id)
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Postcode </label><input type="text" tabindex="8" class="form-control " name="postcode" id="postcode"  data-error="#err_postcode">
									 ...
									 @foreach($master_lead_type as $master_l_type)
											<option value="{{$master_l_type->hl_mt_lt_id}}" >{{$master_l_type->hl_lead_type_name}}</option>
											@endforeach
									 </select>
										<span id="err_type" style="position: relative;top: -2px;"></span>
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="m_con_mobile_no" id="m_con_mobile_no" type="text" class="form-control " data-error="#err_m_con_mobile_no" >
                                        ...
                                        <select multiple="multiple" tabindex="2" name="associate_with[]" id="associate_with" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
	...
	<input name="ic_off_address1" tabindex="1" id="ic_off_address1" type="text" class="form-control required" data-error="#err_off_address1" >
					...
					<label>Postcode </label><input type="text" tabindex="5"  class="form-control " name="ic_postcode1" id="ic_postcode1" value="{{ old('ic_postcode') }}" data-error="#err_ic_postcode1">
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Subsidy of </label><select multiple="multiple" tabindex="2" name="subsidy_of[]" id="" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
										

										@foreach($hl_corporate_contact_basic as $hl_corporate2)
										<option value="{{$hl_corporate2->hl_ccb_id}}_1" >{{$hl_corporate2->hl_business_name}}</option>
										@endforeach

										@foreach($hl_agents_contacts_basic as $hl_agents2)
										<option value="{{$hl_agents2->hl_agentcont_id}}_2">{{$hl_agents2->hl_business_name}}</option>
										@endforeach
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="ic_mobile_no" id="ic_mobile_no" type="text" class="form-control required" data-error="#err_ic_mobile_no" >
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Associate with <!-- consortia --></label><select multiple="multiple" tabindex="2" name="associate_withC[]" id="associate_withC" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
                                        @foreach($associate_c as $associateC)
										<option value="{{$associateC->hl_ccb_id}}_1" >{{$associateC->business_name}}</option>
										@endforeach
										@foreach($associate_a as $associateA)
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Country </label>
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
									...
									<input type="text" tabindex="5"  class="form-control " name="postcode1" id="postcode1" value="{{ old('postcode') }}" data-error="#err_postcode1">
                      ...
                      <div class="col-sm-12"><label>Head Office Location</label>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Subsidy of  </label><select multiple="multiple" tabindex="2" name="subsidy_new_ofz[]" id="" class="js-example-basic-multiple w-100" data-error="#err_type" style="width: 100%">
										

										@foreach($hl_corporate_contact_basic as $hl_corporate1)
										<option value="{{$hl_corporate1->hl_ccb_id}}_1" >{{$hl_corporate1->hl_business_name}}</option>
										@endforeach

										@foreach($hl_agents_contacts_basic as $hl_agents1)
										<option value="{{$hl_agents1->hl_agentcont_id}}_2">{{$hl_agents1->hl_business_name}}</option>
										@endforeach
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="mobile_no[]" id="mobile_no" type="text" class="form-control required" data-error="#err_mobile_no" >
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group aligncheck" style="    margin-top: 22px;"><span>
											<input type="checkbox" name="invite[]" id="event_invite" class="" >Not Eligible for Event Invite </input></span>
					  ...
					  <div align="right" class="col-12">
									...
									<button type="button" id="clone_corp_add" class="btn btn-inverse-info btn-icon" style="display:none;margin-top: -10px;"> 
...
<h3 style="margin-bottom: -30px;">Implant Contact:</h3>
...
<br/>
					...
					<div class="col-sm-12 col-md-12 col-lg-12 "  >
							<div class="row">
								<div class="col-lg-12"><div class="alert alert-success hidden" id="status_{{$i}}"></div></div>
								<div class="col-sm-6  col-md-6 col-lg-6">
									<input type="hidden" name="hl_con_off_add_id_{{$i}}" id="hl_con_off_add_id_{{$i}}" value="{{$Subsidy->hl_con_off_add_id}}">
									<input type="hidden" name="hl_cons_m_id_{{$i}}" id="hl_cons_m_id_{{$i}}" value="{{$Subsidy->hl_cons_m_id}}">
									
									<div style=""><label>Select Agent </label>									
									<select name="subsidy1_{{$i}}" id="subsidy1_{{$i}}" class="form-control required">
									<option value="">Select Agent</option>
											@if($Hotelagentcontactbasic)
											@foreach ($Hotelagentcontactbasic as $Hotelagentcontactbasics)
											<option value="{{$Hotelagentcontactbasics->hl_agentcont_id }}" @if($Hotelagentcontactbasics->hl_agentcont_id == $Subsidy->hl_agent_m_id) selected="selected" @endif>{{$Hotelagentcontactbasics->hl_business_name }}</option>
											@endforeach
											@endif
									</select>
									<span id="err_subsidy1"  class="jerror"></span>
	...
	<label>Office Address *</label>
	<input name="ic_off_address1_{{$i}}" value="{{$Subsidy->hl_ofz_address}}" tabindex="1" id="ic_off_address1_{{$i}}" type="text" class="form-control required" data-error="#err_off_address1" >
										<span id="err_ic_off_address1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('ic_address1')) ? $errors->first('ic_address1') : ''}}</span>
									...
									<div class="col-sm-12 col-md-6 col-lg-6" ><label>Location Type </label>
										<select tabindex="6" name="ic_location_type1_{{$i}}" id="ic_location_type1_{{$i}}"  class="form-control states required" data-error="#err_ic_states">
										<option value="">
										 ---Choose---
										 </option>
										 
										 <option value="Regional Office" @if($Subsidy->hl_loc_type=="Regional Office") selected="selected" @endif>Regional Office</option>
										 <option value="Country Office" @if($Subsidy->hl_loc_type=="Country Office") selected="selected" @endif>Country Office</option>
										 <option value="State Office" @if($Subsidy->hl_loc_type=="State Office") selected="selected" @endif>State Office</option>
										</select>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Country *</label>
										<select tabindex="2" name="ic_country1_{{$i}}" id="ic_country1_{{$i}}"  class="form-control country required" data-error="#err_ic_country1" >		
									<option value="">Choose Country</option>
									 @foreach ($country as $coun)
									<option value="{{$coun->id}}" @if($Subsidy->hl_country==$coun->id) selected="selected" @endif>{{$coun->name}}</option>
									@endforeach
									 ...
									 <span class="error">{{ ($errors->has('ic_country1')) ? $errors->first('ic_country1') : ''}}</span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>States *</label>
										<select tabindex="3" name="ic_states1_{{$i}}" id="ic_states1_{{$i}}" class="form-control states required" data-error="#err_ic_states">
										<option value="">
										 ---Choose---
										 </option>
											@foreach ($editstates as $states)
											@if($Subsidy->hl_country==$states->country_id)
											<option value="{{$states->id}}" @if($Subsidy->hl_state==$states->id) selected="selected" @endif>{{$states->name}}</option>
											@endif
											@endforeach
									 ...
									 <span id="err_ic_states1" class="jerror">&nbsp;</span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6"><label>City *</label><select name="ic_cities1_{{$i}}" tabindex="4" id="ic_cities1_{{$i}}"  class="form-control required" data-error="#err_ic_cities">		
										<option value="">
										 ---Choose---
										 </option>
											@foreach ($editcities as $cities)
											@if($Subsidy->hl_state==$cities->state_id)
											<option value="{{$cities->id}}" @if($Subsidy->hl_city==$cities->id) selected="selected" @endif>{{$cities->name}}</option>
											@endif
											@endforeach
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
					<label>Postcode *</label><input type="text" tabindex="5"  class="form-control required" name="ic_postcode1_{{$i}}" id="ic_postcode1_{{$i}}" value="{{$Subsidy->hl_postcode}}" data-error="#err_ic_postcode1">
										<span id="err_ic_postcode1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('ic_postcode1')) ? $errors->first('ic_postcode1') : ''}}</span>   
                                    </div>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Landline Number</label><input tabindex="10" name="ic_landline_no1_{{$i}}" id="ic_landline_no1_{{$i}}" type="text" class="form-control required" value="{{$Subsidy->hl_ofz_no}}" data-error="#err_ic_landline_no" >
										<span id="err_ic_landline_no1" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('ic_landline_no1')) ? $errors->first('ic_landline_no1') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email </label><input name="ic_email1_{{$i}}" value="{{$Subsidy->hl_email}}" tabindex="8" id="ic_email1_{{$i}}" type="text" class="form-control required" data-error="#err_email1" >
										<span id="err_email1"  class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('ic_email1')) ? $errors->first('ic_email1') : ''}}</span>
										</div>
...
<div class="col-sm-12 col-md-12 col-lg-12 form-group"><label><strong>Contact Details *</strong></label></div>
							...
							<div class="col-sm-12 col-md-6 col-lg-6  form-group">
											...
											<label>Title *</label>
<select name="ic_title_{{$i}}" id="ic_title_{{$i}}" type="text" class="form-control required" data-error="#err_ic_title_{{$i}}"   ><option value="">Choose Title</option><option value="Mr" @if($Subsidy->hl_title=="Mr") selected="selected" @endif>Mr</option><option value="Mrs"  @if($Subsidy->hl_title=="Mrs") selected="selected" @endif>Mrs</option></select>

											
											<span id="err_ic_title_{{$i}}"  style="position: relative; top: -2px;"></span>
											<span class="error">{{ ($errors->has('ic_title')) ? $errors->first('ic_title') : ''}}</span>
											
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation *</label>
										<select name="ic_contact_designation_{{$i}}" id="ic_contact_designation_{{$i}}" class="form-control required" data-error="#err_ic_contact_designation_{{$i}}">
										<option value="">Choose</option>
										@foreach($Contactdesignation as $ConDes)
										<option value="{{$ConDes->hl_cd_id}}" @if($ConDes->hl_cd_id==$Subsidy->hl_cont_design) selected="selected" @endif>{{$ConDes->hl_title}}</option>
										@endforeach
										</select>

										
										<span id="err_ic_contact_designation_{{$i}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_contact_designation')) ? $errors->first('ic_contact_designation') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>First Name *</label><input name="ic_first_name_{{$i}}" id="ic_first_name_{{$i}}" type="text" class="form-control required" data-error="#err_ic_first_name_{{$i}}" value="{{$Subsidy->hl_first_name}}" >
										<span id="err_ic_first_name_{{$i}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_first_name')) ? $errors->first('ic_first_name') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Last Name *</label><input name="ic_last_name_{{$i}}" id="ic_last_name_{{$i}}" value="{{$Subsidy->hl_last_name}}" type="text" class="form-control required" data-error="#err_ic_last_name_{{$i}}" >
										<span id="err_ic_last_name_{{$i}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_last_name')) ? $errors->first('ic_last_name') : ''}}</span>
										</div>
										
										
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number*</label><input name="ic_mobile_no_{{$i}}" id="ic_mobile_no_{{$i}}" type="text" class="form-control required" value="{{$Subsidy->hl_mob_no}}" data-error="#err_ic_mobile_no_{{$i}}" >
										<span id="err_ic_mobile_no_{{$i}}" style="position: relative;
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_mobile_no')) ? $errors->first('ic_mobile_no') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Landline Number*</label><input value="{{$Subsidy->hl_clandline_no}}" name="ic_clandline_no_{{$i}}" id="ic_clandline_no_{{$i}}" type="text" class="form-control required" data-error="#err_ic_clandline_no_{{$i}}" >
										<span id="err_ic_clandline_no_{{$i}}" style="position: relative;
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_clandline_no')) ? $errors->first('mobile_no') : ''}}</span>
										</div>
										
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email *</label><input value="{{$Subsidy->hl_email}}" name="ic_cemail_{{$i}}" id="ic_cemail_{{$i}}" type="text" class="form-control required" data-error="#err_ic_cemail_{{$i}}" >
										<span id="err_ic_cemail_{{$i}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_cemail')) ? $errors->first('ic_cemail') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>LinkedIn  *</label><input value="{{$Subsidy->hl_linked_in}}" name="ic_linkedin_contact_{{$i}}" id="ic_linkedin_contact_{{$i}}" type="text" class="form-control required" data-error="#err_ic_linkedin_contact_{{$i}}" >
										<span id="err_ic_linkedin_contact_{{$i}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_linkedin_contact')) ? $errors->first('ic_linkedin_contact') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Skype *</label><input value="{{$Subsidy->hl_skype}}" name="ic_skype_contact_{{$i}}" id="ic_skype_contact_{{$i}}" type="text" class="form-control required" data-error="#err_ic_skype_contact_{{$i}}" >
										<span id="err_ic_skype_contact_{{$i}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_skype_contact')) ? $errors->first('ic_skype_contact') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Date of Birth</label><input value="{{$Subsidy->hl_dob}}" name="ic_dob_{{$i}}" id="ic_dob_{{$i}}" type="date" class="form-control required" data-error="#ic_dob_{{$i}}" >
										<span id="err_ic_dob_{{$i}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('ic_dob')) ? $errors->first('ic_dob') : ''}}</span>
										</div>
...
<input style="width:auto;" id="{{$i}}" type="submit"  value="Update" class="btn btn-primary UpdateConsortia  next-btn" style="">
</div>
...
<div class="col-md-12 col-lg-12 mt-30">&nbsp;</div>

						<h3 style="margin-bottom: -30px;">Outplant Contact:</h3>
...
<input type="hidden" name="headOffce_id_{{$j}}" id="headOffce_id_{{$j}}" value="{{$Outp->hl_regl_id}}">
<input type="hidden" name="agent_id_{{$j}}" id="agent_id_{{$j}}" value="{{$Outp->hl_corcont_id}}">

	<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Select Head Office *</label>
                                   		<select name="head_off1_{{$j}}_[]" id="head_off1_{{$j}}" class="form-control">
                                   			<option value="">Select Heade office</option>
                                   			@if($Hotelagentcontactbasic)
                                   			@foreach($Hotelagentcontactbasic as $Hotelagentcontactbasics)
                                   			<option value="{{$Hotelagentcontactbasics->hl_agentcont_id}}" @if($Outp->hl_cor_basic_id==$Hotelagentcontactbasics->hl_agentcont_id) selected="selected" @endif>{{$Hotelagentcontactbasics->hl_business_name}}</option>
                                   			@endforeach
                                   			@endif
                                   		</select>
                                   		
										<span id="err_address1_{{$j}}" style="position: relative; top: -2px;"></span>
										<span class="error">{{ ($errors->has('address1')) ? $errors->first('address1') : ''}}</span>
										...
										<input name="iata_number_{{$j}}_[]" id="iata_number1_{{$j}}" type="text" class="form-control required" value="{{$Outp->iata_number}}" data-error="#err_iata_number1" >
										
										<span id="err_iata_number_{{$j}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('location_type')) ? $errors->first('location_type') : ''}}</span>
										</div>
										
                                  
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Office Address *</label><input name="off_address1_{{$j}}_[]" id="off_address1_{{$j}}" type="text" class="form-control required" data-error="#err_address1_{{$j}}"  value="{{$Outp->hl_ofz_address}}">
										<span id="err_address1_{{$j}}" style="position: relative; top: -2px;"></span>
										<span class="error">{{ ($errors->has('address1')) ? $errors->first('address1') : ''}}</span>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Country *</label>
										<select name="country1_{{$j}}_[]" id="country1_{{$j}}"  class="form-control country required" data-error="#err_country1_{{$j}}" >		
									<option value="">Choose Country</option>									
										@foreach ($country as $coun)
									<option value="{{$coun->id}}" @if($Outp->hl_country==$coun->id) selected="selected" @endif>{{$coun->name}}</option>
									@endforeach
									 </select>
									 <span id="err_country1_{{$j}}" style="position:relative;top: -2px;"></span>
									 <span class="error">{{ ($errors->has('country1')) ? $errors->first('country1') : ''}}</span>
										</div>

										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>States *</label><select name="states1_{{$j}}_[]" id="states1_{{$j}}" class="form-control states required" data-error="#err_states">
										<option value="">
										 ---Choose---
										 </option>
										 @foreach ($editstates as $states)
											@if($Outp->hl_country==$states->country_id)
											<option value="{{$states->id}}" @if($Outp->hl_state==$states->id) selected="selected" @endif>{{$states->name}}</option>
											@endif
											@endforeach
									 </select>									 
									 <span id="err_states" style="position:relative;top: -2px;"></span>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>City *</label><select name="cities1_{{$j}}_[]" id="cities1_{{$j}}"  class="form-control required" data-error="#err_cities1_{{$j}}">		
										<option value="">
										 ---Choose---
										 </option>
										 @foreach ($editcities as $cities)
											@if($Outp->hl_state==$cities->state_id)
											<option value="{{$cities->id}}" @if($Outp->hl_city==$cities->id) selected="selected" @endif>{{$cities->name}}</option>
											@endif
											@endforeach
									 </select>									 
                                     <span id="err_cities1_{{$j}}" style="position:relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('cities1')) ? $errors->first('cities1') : ''}}</span>
                                       
                                    </div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                        <label>Postcode *</label><input type="text" class="form-control required" name="postcode1_{{$j}}_[]" id="postcode1_{{$j}}" value="{{ old('postcode') }}" data-error="#err_postcode1_{{$j}}" value="{{$Outp->hl_postcode}}">
										<span id="err_postcode1_{{$j}}" style="position:relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('postcode1')) ? $errors->first('postcode1') : ''}}</span>
										</div>
										...
										<label>Location Type *</label>
										<select name="location_type_{{$j}}_[]" id="location_type_{{$j}}"  class="form-control states required" data-error="#err_states">
										<option value="">
										 ---Choose---
										 </option>
										 
										 <option value="Regional Office" @if($Outp->hl_loc_type == "Regional Office") selected="selected" @endif>Regional Office</option>
										 <option value="Country Office" @if($Outp->hl_loc_type == "Country Office") selected="selected" @endif>Country Office</option>
										</select>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Office Number*</label><input name="contact_number1_{{$j}}_[]" id="contact_number1_{{$j}}" type="text" class="form-control required" data-error="#err_contact_number1_{{$j}}" value="{{$Outp->hl_ofz_no}}" >
										<span id="err_contact_number1_{{$j}}" style="position: relative;
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('contact_number')) ? $errors->first('contact_number') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email *</label><input name="email1_{{$j}}_[]" id="email1_{{$j}}" type="text" class="form-control required" data-error="#err_email1_{{$j}}" value="{{$Outp->hl_email}}">
										<span id="err_email1_{{$j}}" style="position: relative;
    top: -2px;"></span>
										<span class="error">{{ ($errors->has('contact_email')) ? $errors->first('contact_email') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Lead Type *</label><select name="lead_type1_{{$j}}" id="lead_type1_{{$j}}" class="form-control required" data-error="#err_type1_{{$j}}" >
										<option value="">
										 ---Choose---
										 </option>
											@foreach($master_lead_type as $master_l_type)
											<option value="{{ $master_l_type->hl_mt_lt_id }}"  
												@if($Outp->hl_lead_type == $master_l_type->hl_mt_lt_id) selected="selected" @endif>{{$master_l_type->hl_lead_type_name}}</option>
											@endforeach
										 </select>
										<span id="err_type1_{{$j}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('lead_type1')) ? $errors->first('lead_type1') : ''}}</span>
										</div>
...
<h5>Agent Contact </h5>
	...
	<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Select Office  *</label>
                                   		<select name="head_off2_{{$j}}_[]" id="head_off2_{{$j}}" class="form-control">
                                   			<option value="">Select Office Location</option>
                                   			@if($regionalLocations)
                                   			@foreach($regionalLocations as $regionalLocation)
                                   			<option value="{{ $regionalLocation->hl_regl_id}}" @if($Outp->hl_agentcont_id==$regionalLocation->hl_regl_id) selected="selected" @endif>{{$regionalLocation->hl_ofz_address}} -- {{ $regionalLocation->name}}</option>
                                   			@endforeach
                                   			@endif
                                   		</select>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation *</label>
										<select name="contact_designation_{{$j}}_[]" id="contact_designation_{{$j}}" type="text" class="form-control required" data-error="#err_contact_designation">
										<option value="">Choose</option>
										@foreach($Contactdesignation as $ConDes)
										<option value="{{$ConDes->hl_cd_id}}" @if($ConDes->hl_cd_id==$Outp->hl_cont_design) selected="selected" @endif>{{$ConDes->hl_title}}</option>
										@endforeach
										</select>
										<span id="err_contact_designation_{{$j}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('contact_designation')) ? $errors->first('contact_designation') : ''}}</span>
										</div>
                                     
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><div style=""><label>Title *</label>
<select name="title_{{$j}}_[]" id="title_{{$j}}" type="text" class="form-control required" data-error="#err_title"><option value="">Choose Title</option><option value="Mr" @if($Outp->hl_title=='Mr') selected="selected" @endif>Mr</option><option value="Mrs" @if($Outp->hl_title=='Mrs') selected="selected" @endif>Mrs</option><option value="Ms" @if($Outp->hl_title=='Ms') selected="selected" @endif>Mr</option></select>
											
										<span id="err_title_{{$j}}" style="position: relative; top: -2px;"></span>
										<span class="error">{{ ($errors->has('title')) ? $errors->first('title') : ''}}</span>
										</div>
										</div>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>First Name *</label><input name="first_name_{{$j}}_[]" id="first_name_{{$j}}" type="text" class="form-control required" data-error="#err_first_name_{{$j}}" value="{{$Outp->hl_first_name}}">
										<span id="err_first_name_{{$j}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('first_name')) ? $errors->first('first_name') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Last Name *</label><input name="last_name_{{$j}}_[]" id="last_name_{{$j}}" type="text" class="form-control required" data-error="#err_last_name" value="{{$Outp->hl_last_name}}">
										<span id="err_last_name_{{$j}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('last_name')) ? $errors->first('last_name') : ''}}</span>
										</div>
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="mobile_no_{{$j}}_[]" id="mobile_no_{{$j}}" type="text" class="form-control required" data-error="#err_mobile_no_{{$j}}" value="{{$Outp->hl_mob_no}}">
										<span id="err_mobile_no_{{$j}}" style="position: relative;
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('mobile_no')) ? $errors->first('mobile_no') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email *</label><input name="email_{{$j}}_[]" id="email_{{$j}}" type="text" class="form-control required" data-error="#err_email_{{$j}}" value="{{$Outp->hl_email}}">
										<span id="err_email_{{$j}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('email')) ? $errors->first('email') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>LinkedIn Contact </label><input name="linkedin_contact_{{$j}}_[]" id="linkedin_contact_{{$j}}" type="text" class="form-control required" data-error="#err_linkedin_contact_{{$j}}" value="{{$Outp->hl_linked_in}}">
										<span id="err_linkedin_contact_{{$j}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('linkedin_contact')) ? $errors->first('linkedin_contact') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Skype Contact </label><input name="skype_contact_{{$j}}_[]" id="skype_contact_{{$j}}" type="text" class="form-control required" data-error="#err_skype_contact" value="{{$Outp->hl_skype}}">
										<span id="err_skype_contact" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('skype_contact')) ? $errors->first('skype_contact') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Date of Birth </label><input name="dob_{{$j}}_[]" id="dob_{{$j}}" type="date" class="form-control required" data-error="#dob_{{$j}}" value="{{$Outp->hl_dob}}">
										<span id="err_dob_{{$j}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('dob')) ? $errors->first('dob') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group aligncheck"><span><input type="checkbox" id="event_invite_{{$j}}" name="event_invite_{{$j}}" class="" @if($Outp->hl_event_invite=='Yes') checked="checked" @endif>Not Eligible for event invite </input></span>
										
										</div>
										
	
	<div align="right" class="col-md-12 col-lg-12">
									<input style="width:auto;" type="submit"  id="{{$j}}" value="Update" class="btn btn-primary outplant  next-btn" style="">
								</div>
</div>
...
<!-- table-expandable -->
						...
						<td>{{$CorporateContacts->hl_regional_name}}</td>						
						...
						<td>{{$CorporateContacts->hl_title}}</td>
						<td>{{$CorporateContacts->cemail}}</td>
						<td>{{$CorporateContacts->fname}}</td>
						...
						<!--<tr><td colspan="9">
							...
							<div class="row"  id="direct1">
								<div class="col-sm-12 col-md-12 col-lg-12 " style="margin-top: 20px"><label><strong>Address Details:</strong></label></div>
                                   ...
                                   <input type="hidden" name="cc_off_main_id" id="cc_off_main_id_cc{{$k}}" value="{{$CorporateContacts->hl_regl_id}}">
                                   <input type="hidden" name="cc_c_main_id" value="{{$CorporateContacts->hl_corcont_id}}" id="cc_c_main_id_cc{{$k}}">
                                    
										
										<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Office Address *</label>
										<input name="off_address1_cc{{$k}}" tabindex="1" id="off_address1_cc{{$k}}" type="text" class="form-control required" data-error="#err_off_address1_cc{{$k}}" value="{{$CorporateContacts->hl_ofz_address}}" >
										<span id="err_off_address1_cc{{$k}}" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('address1')) ? $errors->first('address1') : ''}}</span>									
										</div>
										...
										<label>Location Type </label>
										<select tabindex="6" name="location_type1_cc{{$k}}" id="location_type1_cc{{$k}}"  class="form-control states required" data-error="#location_type1_cc{{$k}}">
										<option value="">
										 ---Choose---
										 </option>
										 
										 <option value="Regional Office" @if($CorporateContacts->hl_loc_type=='Regional Office') selected="selected" @endif>Regional Office</option>
										 <option value="Country Office" @if($CorporateContacts->hl_loc_type=='Country Office') selected="selected" @endif>Country Office</option>
										 <option value="State Office" @if($CorporateContacts->hl_loc_type=='State Office') selected="selected" @endif>State Office</option>
										</select>
										
										
										<span id="err_location_type1_cc{{$k}}" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('location_type1')) ? $errors->first('location_type1') : ''}}</span>
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Country *</label>
										<select tabindex="2" name="country1_cc{{$k}}" id="country1_cc{{$k}}"  class="form-control country required" data-error="#err_country1_cc{{$k}}" >		
									<option value="">Choose Country</option>									
										@foreach ($country as $coun)
									<option value="{{$coun->id}}" @if($CorporateContacts->hl_country==$coun->id) selected="selected" @endif>{{$coun->name}}</option>
									@endforeach

									 </select>
									 <span id="err_country1_cc{{$k}}" class="jerror">&nbsp;</span>
									 <span class="error">{{ ($errors->has('country1')) ? $errors->first('country1') : ''}}</span>
										</div>							
										...
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>States *</label>
										<select tabindex="3" name="states1_cc{{$k}}" id="states1_cc{{$k}}" class="form-control states required" data-error="#err_states1_cc{{$k}}">
										@foreach ($editstates as $states)
											@if($CorporateContacts->hl_country==$states->country_id)
											<option value="{{$states->id}}" @if($CorporateContacts->hl_state==$states->id) selected="selected" @endif>{{$states->name}}</option>
											@endif
											@endforeach

									 </select>									 
									 <span id="err_states1_cc{{$k}}" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('states1')) ? $errors->first('states1') : ''}}</span>
									</div>
									<div class="col-sm-12 col-md-6 col-lg-6 form-group">
                                      <label>City *</label><select name="cities1_cc{{$k}}" tabindex="4" id="cities1_cc{{$k}}"  class="form-control required" data-error="#err_cities1_cc{{$k}}">		
										@foreach ($editcities as $cities)
											@if($CorporateContacts->hl_state==$cities->state_id)
											<option value="{{$cities->id}}" @if($CorporateContacts->hl_city==$cities->id) selected="selected" @endif>{{$cities->name}}</option>
											@endif
											@endforeach
									 </select>									 
                                     <span id="err_cities1_cc{{$k}}" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('cities1')) ? $errors->first('cities1') : ''}}</span>                                     
                                    </div>
								...
								<div class="col-sm-12 col-md-6 col-lg-6 form-group">
									<label>Postcode *</label>
									<input type="text" tabindex="5"  class="form-control required" name="postcode1_cc{{$k}}" id="postcode1_cc{{$k}}" value="{{ old('postcode') }}" data-error="#err_postcode1" value="{{$CorporateContacts->hl_ofz_no}}">
									<span id="err_postcode1_cc{{$k}}" class="jerror">&nbsp;</span>
									<span class="error">{{ ($errors->has('postcode1')) ? $errors->first('postcode1') : ''}}</span>
								</div>
									
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Landline Number</label>
										<input tabindex="10" name="landline_no1_cc{{$k}}" id="landline_no1_cc{{$k}}" type="text" class="form-control required" data-error="#err_landline_no1_cc{{$k}}" value="{{$CorporateContacts->hl_ofz_no}}">
										<span id="err_landline_no1_cc{{$k}}" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('landline_no1')) ? $errors->first('landline_no1') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email </label><input name="email1_cc{{$k}}" tabindex="8" id="email1_cc{{$k}}" type="text" class="form-control required" data-error="#err_email1_cc{{$k}}" value="{{$CorporateContacts->remail}}">
										<span id="err_email1_cc{{$k}}"  class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('email1')) ? $errors->first('email1') : ''}}</span>
										</div>
										 <div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Lead Type *</label>
										<select  tabindex="9" name="lead_type1_cc{{$k}}" id="lead_type1_cc{{$k}}" class="form-control required" data-error="#err_lead_type1_cc{{$k}}" >
										<option value="">
										 ---Choose---
										 </option>
										@foreach($master_lead_type as $master_l_type)
											<option value="{{$master_l_type->hl_mt_lt_id}}" @if($CorporateContacts->hl_lead_type==$master_l_type->hl_mt_lt_id) selected="selected" @endif>{{$master_l_type->hl_lead_type_name}}</option>
											@endforeach
										 </select>
										<span id="err_lead_type1_cc{{$k}}" class="jerror">&nbsp;</span>
										<span class="error">{{ ($errors->has('lead_type1')) ? $errors->first('lead_type1') : ''}}</span>
										</div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12"> <label><strong>Contact Details:</strong></label></div>
                                        	...
                                        	<div class="col-sm-12 col-md-6 col-lg-6  form-group"><label>Title *</label>
<select name="title_cc{{$k}}_[]" id="title_cc{{$k}}" type="text" class="form-control required" data-error="#err_title_cc{{$k}}" ><option value="">Choose Title</option><option value="Mr" @if($CorporateContacts->hl_title=='Mr') selected="selected" @endif>Mr</option><option value="Mrs" @if($CorporateContacts->hl_title=='Mrs') selected="selected" @endif>Mrs</option><option value="Ms" @if($CorporateContacts->hl_title=='Ms') selected="selected" @endif>Ms</option></select>
										<span id="err_title_cc{{$k}}" style="position: relative; top: -2px;"></span>
										<span class="error">{{ ($errors->has('title')) ? $errors->first('title') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Contact Designation *</label>

											<select name="contact_designation_cc{{$k}}_[]" id="contact_designation_cc{{$k}}" type="text" class="form-control required" data-error="#err_contact_designation_cc{{$k}}">
												<option value="">Choose</option>
												@foreach($Contactdesignation as $ConDes)
												<option value="{{$ConDes->hl_cd_id}}" @if($CorporateContacts->hl_cont_design==$ConDes->hl_cd_id) selected="selected" @endif >{{$ConDes->hl_title}}</option>
												@endforeach
											</select>
											
										<span id="err_contact_designation_cc{{$k}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('contact_designation')) ? $errors->first('contact_designation') : ''}}</span>
										</div>										
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>First Name *</label><input name="first_name_cc{{$k}}_[]" id="first_name_cc{{$k}}" type="text" class="form-control required" data-error="#err_first_name_cc{{$k}}" value="{{$CorporateContacts->hl_first_name}}">
										<span id="err_first_name_cc{{$k}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('first_name')) ? $errors->first('first_name') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Last Name *</label><input name="last_name_cc{{$k}}_[]" id="last_name_cc{{$k}}" type="text" class="form-control required" data-error="#err_last_name_cc{{$k}}" value="{{$CorporateContacts->hl_last_name}}">
										<span id="err_last_name_cc{{$k}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('last_name')) ? $errors->first('last_name') : ''}}</span>
										</div>
...
<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Mobile Number</label><input name="mobile_no_cc{{$k}}_[]" id="mobile_no_cc{{$k}}" type="text" class="form-control required" data-error="#err_mobile_no_cc{{$k}}" value="{{$CorporateContacts->hl_mob_no}}">
										<span id="err_mobile_no_cc{{$k}}" style="position: relative;
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('mobile_no')) ? $errors->first('mobile_no') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Landline Number</label><input name="landline_no_cc{{$k}}_[]" id="landline_no_cc{{$k}}" type="text" class="form-control required" data-error="#err_landline_no_cc{{$k}}" value="{{$CorporateContacts->hl_clandline_no}}">
										<span id="err_landline_no_cc{{$k}}" style="position: relative;
										top: -2px;"></span>
										<span class="error">{{ ($errors->has('landline_no')) ? $errors->first('mobile_no') : ''}}</span>
										</div>
										
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Email *</label><input name="cemail_cc{{$k}}_[]" id="cemail_cc{{$k}}" type="text" class="form-control required" data-error="#err_cemail_cc{{$k}}" value="{{$CorporateContacts->cemail}}">
										<span id="err_cemail_cc{{$k}}" style="position: relative;    top: -2px;"></span>
										<span class="error">{{ ($errors->has('email')) ? $errors->first('email') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>LinkedIn  </label><input name="linkedin_contact_cc{{$k}}_[]" id="linkedin_contact_cc{{$k}}" type="text" class="form-control required" data-error="#err_linkedin_contact_cc{{$k}}" value="{{$CorporateContacts->hl_linked_in}}">
										<span id="err_linkedin_contact_cc{{$k}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('linkedin_contact')) ? $errors->first('linkedin_contact') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Skype </label><input name="skype_contact_cc{{$k}}_[]" id="skype_contact_cc{{$k}}" type="text" class="form-control required" data-error="#err_skype_contact_cc{{$k}}" value="{{$CorporateContacts->hl_skype}}">
										<span id="err_skype_contact_cc{{$k}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('skype_contact')) ? $errors->first('skype_contact') : ''}}</span>
										</div>
										
										<div class="col-sm-12 col-md-6 col-lg-6 form-group"><label>Date of Birth</label><input name="dob_cc{{$k}}_[]" id="dob_cc{{$k}}" type="date" class="form-control required" data-error="#dob_cc{{$k}}" value="{{$CorporateContacts->hl_dob}}">
										<span id="err_dob_cc{{$k}}" style="position: relative;top: -2px;"></span>
										<span class="error">{{ ($errors->has('dob')) ? $errors->first('dob') : ''}}</span>
										</div>
										<div class="col-sm-12 col-md-6 col-lg-6 form-group aligncheck"><span>
											<input type="checkbox" name="invite_cc{{$k}}_[]" id="event_invite_cc{{$k}}" class="" value="Yes" @if($CorporateContacts->hl_event_invite=='Yes') selected="selected" @endif >Not Eligible for event invite </input></span>
...
var hl_dob=$('#ic_dob_'+idvalue).val();
	...
	var host="{{ url('crm/updateConsordiaImplant/') }}";	
	$.ajax({
		type: 'POST',
		data:params,
		url: host,
...
function chk_businame(){
   ...
   var b_id= ""; 
	var host="{{ url('crm/getCorpBusiname/') }}";	
	$.ajax({
		type: 'POST',
...
$("#saveform1").click(function() {
	...
	$("button#clone_corp_add").click(function () {
			...
			$('#corp_contact_address_form'+divlength ).prepend('<div class="col-sm-12 col-md-12 col-lg-12" align="right"><button id=rem'+divlength+' onclick="removediv('+divlength+')" type="button" class="btn btn-outline-secondary btn-rounded btn-icon" style="margin-right: -15px;"><i class="mdi mdi-close text-info"></i>    </button></div>');
			$("#corp_contact_address_form"+divlength+" select#associate_withM0").prop({id:"associate_withM"+divlength, name:"associate_withM"+divlength+'[]'}).append();
 ...
 $(document).ready( function () {
  ...
  //    {
      ...
      //{
		...
		// 				text: '',
		// 				action: function ( e, dt, node, config ) {
		// 					 window.location.href = '{{url("crm/add-agent")}}'; 
