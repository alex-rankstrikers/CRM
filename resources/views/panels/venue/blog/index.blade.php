                            ...
                            <div id="reportArea">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">										  
										 ...
										 <input type="checkbox" name="category[]" value="{{ $category->c_id }}">{{ $category->c_title }}&nbsp;&nbsp;                                          @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="b_tags" id="b_tags">{{ old('b_tags') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                       ...
                       <input type="hidden" value="" name="id" id="edit_id" />
                            <div id="reportArea">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									<span id="cnt">
									@foreach ($editcategory as $edit_category)
									<input type="checkbox" name="category[]" value="{{ $edit_category->c_id }}">{{ $edit_category->c_title }} 
									@endforeach	
									</span> 									
									<span class="error">{{ ($errors->has('category')) ? $errors->first('category') : ''}}</span>
                                    </div>
                               ...
                               <?php /* <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Tags</label>
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="b_tags" id="edit_b_tags">{{ old('b_tags') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" style="text-align:left">Blog Description</label>
...
function renderListform(res){ 
 $('#cnt input').filter(':checkbox').removeAttr('checked');
var url="{{ url('') }}";
var image_path=res.view_details.b_image;
	...
	$('#edit_b_tags').val(res.view_details.b_tags);
	//$('#edit_category').val(res.view_details.c_id);
	...
	var myArray=[];
	if(res.view_details.c_id)
		myArray = res.view_details.c_id.split(',');	
