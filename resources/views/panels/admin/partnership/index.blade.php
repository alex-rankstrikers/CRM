            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								<div class="x_panel">
								<form name="actionForm" action="{{url('admin/partnership/destroy')}}" method="post" onsubmit="return deleteConfirm();"/> 
									<h2>All Partnership <span class="pull-right"><a href="#" class="btn btn-success btn-xs add_blog"><i class="fa fa-plus"></i> Add </a>  
					...
					<div class="x_panel" id="add_div" style="">
						...
						<div class="alert alert-success hidden"></div>
								  <!-- Add Form Start-->
						 <form method="POST" action="{{url('admin/partnership/added')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="x_panel" id="edit_div" style=" display:none">
						...
						<div class="x_title">
								  ...
								  <!-- Edit Form Start-->
						 <form method="POST" action="{{url('admin/partnership/updated')}}"  enctype="multipart/form-data" class="form-horizontal">
...
// Add Blog
	...
	function add_news(){  
	var host="{{ url('admin/partnership/get_users') }}";
	var id= $(this).attr('id');  
	$('#edit_div').hide();
	$('#add_div').fadeIn("slow");	
 ...
 $(document).on("click", ".edit_blog", edit_news);
  ...
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
   var id= $(this).attr('id'); 
	...
	var host="{{ url('admin/partnership/getnews/') }}";
	$('#add_div').hide();
...
var image_path=res.view_details.n_image;
 ...
 $(document).on("click", ".delete_blog", deletenews);
  ...
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
   var id= $(this).attr('id'); 
	var host="{{ url('admin/partnership/deleted/') }}";
	$.ajax({
		type: 'POST',
		data:{'id': id,'_token':CSRF_TOKEN},
		url: host,
