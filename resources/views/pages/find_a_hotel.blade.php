 ...
 @foreach ($Hotels as $hotel)
						...
						<div class="row " >
							<div class="col-lg-5 col-md-5 col-sm-5 hotel-img-sec">
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="heart">&nbsp;</div>
							 		...
							 		?>
							<a href="{{url('hotel')}}/{{$hotel->slug}}"><img class="img-responsive" src="{{ url('') }}/uploads/venue/thumbnail/{{ $hotel->image_1 }}" alt=""></a>

							<?php }else{
								if($hotel->image_2 !=''){									?>
								
								<a href="{{url('hotel')}}/{{$hotel->slug}}"><img class="img-responsive 2" src="{{ url('') }}/uploads/venue/thumbnail/{{ $hotel->image_2 }}" alt=""></a>
								<?php 
									}else{
									if($hotel->image_3 !=''){ 
									?>
									<a href="{{url('hotel')}}/{{$hotel->slug}}"><img class="img-responsive 3" src="{{ url('') }}/uploads/venue/thumbnail/{{ $hotel->image_3 }}" alt="">	</a>				
								<?php 
									}
							...
							<div class="col-lg-7 col-md-7 col-sm-7 hotel-desc-sec">
								...
								<p>Wi-Fi included:</p>
								<p class="mt-7">{!! str_limit($hotel->description, 50) !!}<a href="{{url('hotel')}}/{{$hotel->slug}}" style="float: right;" class="link">View Hotel</a></p>
