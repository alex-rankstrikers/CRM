...
<div class="row">
  ...
  @if(!empty($venue->floor_plan_pdf)) 
		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p class="text-right"><a target="_blank" href="{{url('')}}/public/uploads/pdf/{{ $venue->floor_plan_pdf }}">Floor Plan Download</a> </p></div> 
		...
		@endforeach 
			...
			<div class="row">
					...
					@if(!empty($venue->menu_name_1))
						...
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p class="text-right"><a target="_blank" href="{{url('')}}/public/uploads/pdf/{{$venue->fd_menu_pdf_1}}">Download</a> </p></div> 
					@endif 
					
					@if(!empty($venue->menu_name_2))
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p>{{$venue->menu_name_2}}</p></div>				
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p class="text-right"><a target="_blank" href="{{url('')}}/public/uploads/pdf/{{$venue->fd_menu_pdf_2}}">Download</a> </p></div>
					@endif 
					
					@if(!empty($venue->menu_name_3))					
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p>{{$venue->menu_name_3}}</p></div>				
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p class="text-right"><a target="_blank" href="{{url('')}}/public/uploads/pdf/{{$venue->fd_menu_pdf_3}}">Download</a> </p></div>
					@endif 
					
					@if(!empty($venue->menu_name_4))					
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p>{{$venue->menu_name_4}}</p></div>
				
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><p class="text-right"><a target="_blank" href="{{url('')}}/public/uploads/pdf/{{$venue->fd_menu_pdf_4}}">Download</a> </p></div>
					@endif
			  </div> 
  ...
  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
   ...
   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
	  ...
	  <p><span class="glyphicon glyphicon-ok"></span> Price per hour </p>
	   ...
	   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
	   <p class="text-right">@if($venue->per_hour_pdf) <a target="_blank" href="{{url('')}}/public/uploads/pdf/{{ $venue->per_hour_pdf }}">PDF Download</a> @endif</p>
	   </div>
	  ...
	  <p><span class="glyphicon glyphicon-ok"></span> Price per person </p>
	   ...
	   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
	   <p class="text-right">@if($venue->per_person_pdf) <a target="_blank" href="{{url('')}}/public/uploads/pdf/{{ $venue->per_person_pdf }}">PDF Download</a> @endif</p>
	   </div>
	  ...
	  <p><span class="glyphicon glyphicon-ok"></span> Price per day </p>
	   ...
	   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
	   <p class="text-right">@if($venue->per_day_pdf) <a target="_blank" href="{{url('')}}/public/uploads/pdf/{{ $venue->per_day_pdf }}">PDF Download</a> @endif</p>
	   </div>
...
<h3 class="text-center">{{$contact_no}}</h3>
@endif
@endif
 </div>  
<div class="mt-15">
