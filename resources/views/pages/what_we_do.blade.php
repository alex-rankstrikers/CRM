...
<div class="container">
		...
		<div class="container">
			<div class="col-lg-12 about-text text-center text-pink">
				<h4>Our Partner Hotels</h4>
			</div>
			<div class="clients-slider partner-slider owl-carousel about-text">

				
				 @foreach ($Partners as $Partner)
				<a href="#">
					<img src="{{ asset('uploads/thumbnail/'.$Partner->n_image) }}" alt="">
				</a>
				@endforeach
...
<div class="col-lg-4 col-md-4 col-xs-4  about-text offset-4 offset-4">
